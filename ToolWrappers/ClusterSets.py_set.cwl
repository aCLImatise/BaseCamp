...
- id: in_annotation_field_containing
  doc: "The annotation field containing annotations, such as\nUMI barcode, for sequence\
    \ grouping. (default: BARCODE)"
  type: string
  inputBinding:
    prefix: -f
- id: in_start
  doc: "The start of the region to be used for clustering.\nTogether with --end, this\
  ...
  inputBinding:
    prefix: --start
- id: in_end
  doc: "The end of the region to be used for clustering.\n(default: None)\n"
  type: string
  inputBinding:
    prefix: --end
outputs:
