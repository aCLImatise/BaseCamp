...
id: ScanIndel.py.cwl
inputs:
- id: in_setting_output_directory
...
- id: out_stdout
  ...
  type: stdout
- id: out_setting_output_directory
  doc: :setting the output directory (default current working directory)
  type: Directory?
  outputBinding:
    glob: $(inputs.in_setting_output_directory)
hints: []
cwlVersion: v1.1
baseCommand:
- ScanIndel.py
