...
- id: in_window
  ...
  inputBinding:
    prefix: -window
- id: in_no_balance
  doc: '(balance contact maps, default: -nobalance)'
  type: boolean?
  inputBinding:
    prefix: -nobalance
- id: in_mind_ist
...
- id: in_file_genome_duplicationsbadblacklisted
...
- id: out_stdout
  ...
  type: stdout
- id: out_default_place_files
  doc: (by default will place output files within the Tag Directory)
  type: Directory?
  outputBinding:
    glob: $(inputs.in_default_place_files)
hints: []
cwlVersion: v1.1
baseCommand:
- findTADsAndLoops.pl
