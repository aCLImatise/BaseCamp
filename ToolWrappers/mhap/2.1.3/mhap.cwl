...
- id: out_default_kmer_filter
  doc: ", default = \"\"\nk-mer filter file used for filtering out highly repetative\
    \ k-mers. Must be sorted in descending order of frequency (second column)."
  type: File
  outputBinding:
    glob: $(inputs.in_default_kmer_filter)
