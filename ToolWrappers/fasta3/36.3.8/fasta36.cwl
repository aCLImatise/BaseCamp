...
- id: in_high_scores_reported
  ...
  inputBinding:
    prefix: -b
- id: in_expected_fraction_bandoptimization
...
- id: in_length_querysbjct_name
  ...
  inputBinding:
    prefix: -C
- id: in_number_alignments_limited
...
- id: in_width_alignment_display
  ...
  inputBinding:
    prefix: -w
- id: in_alignment_context_length
