...
- id: in_no_install_tool_dependencies
  doc: "Turn on installation of tool dependencies\nusing classic toolshed packages."
  type: boolean?
  inputBinding:
    prefix: --no_install_tool_dependencies
- id: in_no_install_resolver_dependencies
  doc: "Skip installing tool dependencies through\nresolver (e.g. conda)."
  type: boolean?
  inputBinding:
    prefix: --no_install_resolver_dependencies
- id: in_no_install_repository_dependencies
  doc: Skip installing the repository dependencies.
  type: boolean?
  inputBinding:
    prefix: --no_install_repository_dependencies
- id: in_galaxy_url
...
- id: in_history_name
  doc: Name to give a Galaxy history, if one is
  type: string?
  inputBinding:
    prefix: --history_name
