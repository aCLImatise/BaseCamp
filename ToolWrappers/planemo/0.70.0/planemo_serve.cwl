...
- id: in_shed_tool_conf
  doc: "Location of shed tools conf file for Galaxy.\n--shed_tool_path TEXT      \
    ...
    \ option is experimental and will be\nreplaced when and if CWL support is merged\n\
    into Galaxy).\n--cwl_galaxy_root DIRECTORY     Root of development galaxy directory\
    \ to\nexecute command with (must be branch of\nGalaxy with CWL support, this option\
    \ is\nexperimental and will be replaced with\n--galaxy_root when and if CWL support\
