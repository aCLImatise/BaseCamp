...
task ShedtoolsInstall {
  ...
  command <<<
    shed_tools install \
      ...
      ~{if defined(section_label) then ("--section_label " +  '"' + section_label + '"') else ""} \
