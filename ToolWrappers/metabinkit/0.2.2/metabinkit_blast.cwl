...
- id: in_output_format_default
  doc: '- output format (default: 6 qseqid evalue pident qcovs saccver staxid ssciname
    sseqid)'
  type: long?
  inputBinding:
    prefix: -o
...
- id: in_blasts_task_parameter
  ...
  inputBinding:
    prefix: -X
- id: in__blasts_reward_parameter_default
  doc: '- BLAST´s reward parameter (default:1)'
  type: long?
  inputBinding:
    prefix: -r
- id: in_blasts_reward_parameter_default_
  doc: '- BLAST´s reward parameter (default:-1)'
  type: long?
  inputBinding:
    prefix: -p
- id: in_blasts_maxtargetseqs_parameter
