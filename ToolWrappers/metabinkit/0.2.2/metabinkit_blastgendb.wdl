...
task MetabinkitBlastgendb {
  ...
  parameter_meta {
    mapping_sequence_d: "- mapping between the sequence id and the taxid (tab separated). if none is found it will look for taxid=xxxx; in the fasta header after the first space and consider the word up to the first space or | as the sequence id."
