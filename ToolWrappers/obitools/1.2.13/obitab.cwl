...
- id: in_na_string
  doc: String write in the table for not available value
  type: string?
  inputBinding:
    prefix: --na-string
- id: in_output_field_separator
  doc: Field separator for CSV file
  type: File?
  inputBinding:
    prefix: --output-field-separator
- id: in_output_seq
  doc: Add an extra column for sequence
  type: boolean?
  inputBinding:
    prefix: --output-seq
- id: in_no_definition
  doc: Remove column for sequence definition
  type: boolean?
  inputBinding:
    prefix: --no-definition
- id: in_omit_attribute
  doc: Add attribute name to omit in the output tab
  type: string?
  inputBinding:
    prefix: --omit-attribute
- id: in_skip
