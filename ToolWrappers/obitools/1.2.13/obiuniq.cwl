...
- id: in_category_attribute
  doc: "Add one attribute to the list of attributes used to\ngroup sequences before\
    \ dereplication (option can be\nused several times)"
  type: string?
  inputBinding:
    prefix: --category-attribute
- id: in_prefix
  doc: "Dereplication is done based on prefix matching: (i)\nThe shortest sequence\
    \ of each group is a prefix of any\nsequence of its group (ii) Two shortest sequences\
