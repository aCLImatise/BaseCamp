...
- id: in_min
  doc: "Computes the minimum value of attribute for each\ncategory."
  type: long?
  inputBinding:
    prefix: --min
- id: in_max
  doc: "Computes the maximum value of attribute for each\ncategory."
  type: long?
  inputBinding:
    prefix: --max
- id: in_mean
  doc: "Computes the mean value of attribute for each\ncategory."
  type: string?
  inputBinding:
    prefix: --mean
- id: in_variance
  ...
  inputBinding:
    prefix: --variance
- id: in_std_dev
  doc: "Computes the standard deviation of attribute for each\ncategory."
  type: string?
  inputBinding:
    prefix: --std-dev
- id: in_skip
