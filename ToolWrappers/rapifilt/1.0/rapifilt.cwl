...
- id: out_stdout
  ...
  type: stdout
- id: out_fastqfile_desired_file
  doc: <fastq_file>          Desired fastq output file. If not specified to stdout
  type: File?
  outputBinding:
    glob: $(inputs.in_fastqfile_desired_file)
hints: []
cwlVersion: v1.1
baseCommand:
- rapifilt
