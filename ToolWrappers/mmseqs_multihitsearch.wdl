...
task MmseqsMultihitsearch {
  ...
  parameter_meta {
    ...
    sensitivity_faster_fast: "7.000           sensitivity: 1.0 faster; 4.0 fast default; 7.5 sensitive [1.0,7.5]"
    ...
    list_matches_evalue: "100.000         list matches below this E-value [0.0, inf]"
    ...
    score_bias: "0.300           Score bias when computing the SW alignment (in bits)"
