...
task Roc {
  ...
  parameter_meta {
    ...
    arg_output_name: "[ --output-file ] arg  Output file name, defaults to - / write to stdout"
    ...
    arg_value_name: "[ --value ] arg        value column name"
  ...
  output {
    ...
    File out_arg_output_name = "${in_arg_output_name}"
  }
}