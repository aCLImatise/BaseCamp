...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_keys
  doc: 'The set of keys of interest. (default: *)'
  type: boolean
  inputBinding:
    prefix: --keys
- id: in_additional_text
  doc: 'A facultative text to be printed in the third column (e.g species name). (default:
    None)'
  type: boolean
  inputBinding:
    prefix: --additional-text
- id: in_uniq
  doc: 'Ask for the count of non redondant values. (default: False)'
  type: boolean
  inputBinding:
    prefix: --uniq
- id: in_verbosity
