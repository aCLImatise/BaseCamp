...
- id: in_acc
  ...
  inputBinding:
    prefix: --acc
- id: in_int_len_max
  doc: "(=60)         interaction site : maximal window size to be\nconsidered for\
  ...
  inputBinding:
    prefix: --intLenMax
- id: in_int_loop_max
  doc: "(=8)         interaction site : maximal number of unpaired\nbases between\
...
- id: in_arg_number_suboptimal
  ...
  inputBinding:
    prefix: -n
- id: in_out_overlap
  doc: "(=Q)         suboptimal output : interactions can overlap\n'N' in none of\
