...
task Blastall {
  input {
    ...
    Boolean? number_concatenated_tblastn
  ...
  command <<<
    blastall \
      ...
      ~{if (number_concatenated_tblastn) then "-B" else ""} \
  ...
  parameter_meta {
    ...
    number_concatenated_tblastn: "Number of concatenated queries, for blastn and tblastn [Integer]  Optional\\ndefault = 0"
