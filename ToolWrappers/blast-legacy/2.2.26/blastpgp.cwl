...
- id: in_produce_html_output
  ...
  inputBinding:
    prefix: -T
- id: in_output_file_psiblast_matrix_optional
...
- id: out_output_file_psiblast_checkpointing_optional
  doc: Output File for PSI-BLAST Checkpointing [File Out]  Optional
  type: File?
  outputBinding:
    glob: $(inputs.in_output_file_psiblast_checkpointing_optional)
- id: out_output_file_psiblast_matrix_optional
  doc: Output File for PSI-BLAST Matrix in ASCII [File Out]  Optional
  type: File?
  outputBinding:
    glob: $(inputs.in_output_file_psiblast_matrix_optional)
hints: []
cwlVersion: v1.1
baseCommand:
- blastpgp
