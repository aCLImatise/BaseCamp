...
- id: in_score_coverage_threshold
  ...
  inputBinding:
    prefix: -S
- id: in_require_coverage_default
...
- id: in_complete_unfinished_clustering
  ...
  inputBinding:
    prefix: -C
- id: in_restrict_reclustering_optional
...
- id: in_enable_i_d
  ...
  inputBinding:
    prefix: -e
- id: in_configuration_file_advanced
...
- id: out_print_progress_default
  doc: "Print progress messages (verbose mode) [File Out]\ndefault = stdout"
  type: File
  outputBinding:
    glob: $(inputs.in_print_progress_default)
cwlVersion: v1.1
baseCommand:
- blastclust
