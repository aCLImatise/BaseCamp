...
- id: in_online
  ...
  inputBinding:
    prefix: --online
- id: in_ref_fast_a
  doc: Reference FASTA file [~/.vep/homo_sapiens/101_GRCh37/Homo_sapiens.GRCh37.dna.toplevel.fa.gz]
  type: boolean?
  inputBinding:
    prefix: --ref-fasta
- id: in_filter_vcf
  doc: A VCF for FILTER tag common_variant; Disabled by default []
  type: boolean?
  inputBinding:
    prefix: --filter-vcf
- id: in_max_filter_ac
...
- id: in_ncbi_build
  ...
  inputBinding:
    prefix: --ncbi-build
- id: in_cache_version
  doc: 'Version of offline cache to use with VEP (e.g. 75, 91, 101) [Default: Installed
    version]'
  type: boolean?
  inputBinding:
