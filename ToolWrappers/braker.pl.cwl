...
- id: in_to_slash_augustus_slash
  doc: Has higher priority than environment variable.
  type: string
  inputBinding:
    position: 0
- id: in_bam_tools_slash
...
- id: in_computation
  ...
  inputBinding:
    position: 2
- id: in_gmes_pet_apdo_tpl_slash
  doc: variable). Has higher priority than environment variable.
  type: string
  inputBinding:
    position: 0
- id: in_sam_tools_slash
  doc: "variable) to fix BAM files automatically, if necessary. Has higher     \n\
