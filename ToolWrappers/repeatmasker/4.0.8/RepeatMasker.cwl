...
- id: in_dir
  ...
  inputBinding:
    prefix: -dir
- id: in_lignmentswrites_alignments_align
...
- id: in_xsmall
  ...
  inputBinding:
    prefix: -xsmall
- id: in_returns_repetitive_regions
...
- id: out_dir
  ...
  outputBinding:
    glob: $(inputs.in_dir)
- id: out_lignmentswrites_alignments_align
  doc: "(lignments)\nWrites alignments in .align output file"
  type: File
  outputBinding:
    glob: $(inputs.in_lignmentswrites_alignments_align)
- id: out_html
  doc: Creates an additional output file in xhtml format.
  type: File
  outputBinding:
