...
- id: in_number_when_reads
  ...
  inputBinding:
    prefix: -g
- id: in_number_nucleotides_upstream_consider_default
  doc: '[int]     number of nucleotides upstream of the mature sequence to consider,
    default 2'
  type: boolean
  inputBinding:
    prefix: -e
- id: in_number_nucleotides_downstream_consider_default
...
- id: in_create_outputmrd_file
  ...
  inputBinding:
    prefix: -j
- id: in_considers_whole_precursor
