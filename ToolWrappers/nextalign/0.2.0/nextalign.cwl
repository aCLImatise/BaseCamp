...
- id: in_include_reference
  doc: "(optional, boolean) Whether to include\naligned reference nucleotide sequence\
    \ into output\nnucleotide sequence fasta file and reference\npeptides into output\
    \ peptide files."
  type: boolean?
  inputBinding:
    prefix: --include-reference
- id: in_output_fast_a
  doc: "(optional, string) Path to output aligned\nsequences in FASTA format (overrides\
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/nextalign:0.2.0--0
cwlVersion: v1.1
baseCommand:
- nextalign
