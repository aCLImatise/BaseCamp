...
task TaxonkitReformat {
  ...
  parameter_meta {
    ...
    pseudo_strain: "use the node with lowest rank as strain name, only if which rank is lower than \\\"species\\\" and not \\\"subpecies\\\" nor \\\"strain\\\". This flag affects {t}, {S}, {T}"
