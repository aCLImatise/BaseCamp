...
- id: in_load_factor
  ...
  inputBinding:
    prefix: --load-factor
- id: in_fast_build
  doc: "Do not require database to be deterministically\nbuilt when using multiple\
    \ threads.  This is faster,\nbut does introduce variability in minimizer/LCA\n\
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/kraken2:2.1.1--pl526hc9558a2_0
cwlVersion: v1.1
baseCommand:
- kraken2-build
