...
task SuppapyGenerateEvents {
  ...
  command <<<
    suppa_py generateEvents \
      ...
      ~{if defined(list_events_analyze) then ("-e " +  '"' + list_events_analyze + '"') else ""} \
