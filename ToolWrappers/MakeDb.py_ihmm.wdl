...
task MakeDbpyIhmm {
  input {
    ...
    Array[String] list_andor_fasta
    Array[String] list_input_fasta
  ...
  command <<<
    MakeDb_py ihmm \
      ...
      ~{if defined(list_andor_fasta) then ("-r " +  '"' + list_andor_fasta + '"') else ""} \
      ~{if defined(list_input_fasta) then ("-s " +  '"' + list_input_fasta + '"') else ""} \
