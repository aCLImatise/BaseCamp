...
- id: in_maximum_pvalue_report
  doc: Maximum p-value to report in edge list. Implies -E. (0-1) [1.0]
  type: long
  inputBinding:
    prefix: -v
- id: in_maximum_distance_report
  doc: Maximum distance to report in edge list. Implies -E. (0-1) [1.0]
  type: long
  inputBinding:
    prefix: -d
