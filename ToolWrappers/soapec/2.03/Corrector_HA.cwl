...
- id: in_set_kmer_size
  ...
  inputBinding:
    prefix: -k
- id: in_set_frequency_cutoff
  doc: "Set the low frequency cutoff, default=3.\nNote: the Kmers with frequency lower\
    \ than(<=) this cutoff will be taken as\nsuspicious Kmers, while the others as\
    \ credible Kmers."
  type: long
  inputBinding:
    prefix: -l
...
- id: in_set_trimmed_length
  ...
  inputBinding:
    prefix: -x
- id: in_set_minimum_length_trimmed
