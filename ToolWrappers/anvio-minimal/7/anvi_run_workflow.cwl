...
- id: in_config_file
  doc: 'A JSON-formatted configuration file. (default: None)'
  type: File?
  inputBinding:
    prefix: --config-file
- id: in_dry_run
  ...
  inputBinding:
    prefix: --dry-run
- id: in_skip_dry_run
  doc: "Don't do a dry run. Just start the workflow! Useful\nwhen your job is so big\
    \ it takes hours to do a dry\nrun. (default: False)"
  type: boolean?
  inputBinding:
    prefix: --skip-dry-run
