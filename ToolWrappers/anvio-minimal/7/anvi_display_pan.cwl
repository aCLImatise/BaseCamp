...
- id: in_view_data
  doc: 'A TAB-delimited file for view data (default: None)'
  type: File?
  inputBinding:
    prefix: --view-data
- id: in_tree
  doc: 'NEWICK formatted tree structure (default: None)'
  type: string?
  inputBinding:
    prefix: --tree
...
- id: in_export_svg
  doc: 'The SVG output file path. (default: None)'
  type: File?
  inputBinding:
    prefix: --export-svg
...
- id: in_skip_auto_ordering
  doc: "When declared, the attempt to include automatically\ngenerated orders of items\
    ...
    \ maybe later. (default: False)"
  type: boolean?
  inputBinding:
    prefix: --skip-auto-ordering
- id: in_skip_news
  doc: "Don't try to read news content from upstream.\n(default: False)"
  type: boolean?
  inputBinding:
    prefix: --skip-news
- id: in_ip_address
