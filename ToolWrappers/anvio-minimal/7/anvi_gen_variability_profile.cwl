...
- id: in_include_additional_data
  doc: "Use this flag if you would like to append data stored\nin the `amino_acid_additional_data`\
    \ table as\nadditional columns to your output. NOTE: This is not\nyet implemented\
    \ for the `nucleotide_additional_data`\ntable. (default: False)"
  type: boolean?
  inputBinding:
    prefix: --include-additional-data
...
- id: in_variability_profile_txt
  doc: '🍺 More on `anvi-gen-variability-profile`:'
  type: string
  inputBinding:
    position: 1
outputs:
