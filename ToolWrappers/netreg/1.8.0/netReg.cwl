...
- id: in_arg_filename_design
  ...
  inputBinding:
    prefix: -d
- id: in_affinity_matrix_gx
  doc: '[ --gx ] arg                      Filename of the affinity matrix GX for'
  type: boolean
  inputBinding:
    prefix: -u
- id: in_affinity_matrix_gy
  doc: '[ --gy ] arg                      Filename of the affinity matrix GY for'
  type: boolean
  inputBinding:
    prefix: -v
- id: in_arg_penalization_parameter_affinitymatrix_gx
  doc: "[ --psi ] arg (=0)                Penalization parameter for affinity\nmatrix\
    \ GX."
  type: boolean
  inputBinding:
    prefix: -s
- id: in_arg_penalization_parameter_affinitymatrix_gy
...
- id: in_arg_number_crossvalidation
