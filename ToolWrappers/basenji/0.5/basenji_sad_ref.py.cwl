...
id: basenji_sad_ref.py.cwl
inputs:
- id: in_require_clustered_snps
  doc: "Require clustered SNPs lie in center region [Default:\n0.25]"
  type: double?
  inputBinding:
    prefix: -c
- id: in_genome_fasta_sequences
  ...
  inputBinding:
    prefix: -f
- id: in_flip
  doc: "Flip reference/alternate alleles when simple [Default:\nFalse]"
  type: boolean?
  inputBinding:
    prefix: --flip
