...
- id: in_no_hits
  doc: "Provide treatment for non-hitting contigs.\n------------------------------------------------------\n\
    ex_no_con keep those connect with hitting-include\ncontigs. (Default)\n------------------------------------------------------\n\
...
- id: in_threads
  ...
  inputBinding:
    prefix: --threads
- id: in_assemblies
  doc: "Input assembly (graph) files (.fasta or .gfa or\n.fastg). Please split the\
    \ files by spaces."
  type: string
  inputBinding:
    position: 0
