...
- id: in_use_multiple_references
  ...
  inputBinding:
    prefix: -M
- id: in_generate_md_tags
  doc: '[Cram] Generate MD and NM tags.'
  type: boolean
  inputBinding:
    prefix: -m
- id: in_also_compress_using_v
...
- id: in_also_compress_using_lzma
  ...
  inputBinding:
    prefix: -Z
- id: in_also_compression_using_fqzcomp_v
  doc: '[Cram] Also compression using fqzcomp (V3.1+)'
  type: boolean
  inputBinding:
    prefix: -f
- id: in_also_compression_using_tokeniser_v
