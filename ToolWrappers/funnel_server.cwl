...
- id: in_grid_engine_dot_template
  doc: Path to submit template file
  type: File
  inputBinding:
    prefix: --GridEngine.Template
- id: in_ht_condor_dot_template
  doc: Path to submit template file
  type: File
  inputBinding:
...
- id: in_scheduler_dot_node_dead_timeout
  doc: How long to wait before deleting a dead node from the DB (default 0s)
  type: long
  inputBinding:
    prefix: --Scheduler.NodeDeadTimeout
- id: in_scheduler_dot_node_in_it_timeout
  doc: How long to wait for node initialization before marking it dead (default 0s)
  type: long
  inputBinding:
    prefix: --Scheduler.NodeInitTimeout
- id: in_scheduler_dot_node_ping_timeout
  doc: How long to wait for a node ping before marking it as dead (default 0s)
  type: long
  inputBinding:
    prefix: --Scheduler.NodePingTimeout
- id: in_scheduler_dot_schedule_chunk
  doc: How many tasks to schedule in one iteration
  type: long
  inputBinding:
    prefix: --Scheduler.ScheduleChunk
- id: in_scheduler_dot_schedule_rate
  doc: How often to run a scheduler iteration (default 0s)
  type: long
  inputBinding:
