...
task IsONcorrect {
  input {
    ...
    Boolean? verbose
    Boolean? rand_strobes
    Int? layers
    Boolean? set_layers_manually
    Boolean? compression
