...
- id: in_croucher_n_j
  doc: Croucher N. J., Page A. J., Connor T. R., Delaney A. J., Keane J. A., Bentley
  type: string
  inputBinding:
    position: 0
- id: in_one_zero_dot_one_zero_nine_three_slash_narslashgkuoneoneninesix_dot
  doc: 'positional arguments:'
  type: double
  inputBinding:
    position: 0
- id: in_multifasta_alignment_file
