...
task BiscuitVcf2bed {
  ...
  command <<<
    biscuit vcf2bed \
      ...
      ~{if (show_base_group) then "-e" else ""}
  >>>
  runtime {
    docker: "None"
  }
  parameter_meta {
    ...
    show_base_group: "show context (reference base, context group {CG,CHG,CHH}, 2-base {CA,CC,CG,CT} and 5-base context) before beta value and coverage column"
    vcf: ""
  }
  output {
