...
- id: in_input_bam_reads
  ...
  inputBinding:
    prefix: -i
- id: in_input_fasta_reference
  doc: input fasta input reference (required).
  type: boolean
  inputBinding:
    prefix: -f
- id: in_region_strings_providing
...
- id: in_medaka_model_final
  doc: "medaka model for final variant calling from phased reads,\n(default: r941_prom_variant_g360).\n\
    ...
    \ r941_prom_high_g330, r941_prom_high_g344, r941_prom_high_g360, r941_prom_snp_g303,\
...
- id: in_threshold_filtering_snps
  ...
  inputBinding:
    prefix: -P
- id: in_avoid_filtering_filter
  doc: 'Avoid filtering of final VCF (default: do filter)'
  type: boolean
  inputBinding:
    prefix: -U
- id: in_stop_initial_prior
