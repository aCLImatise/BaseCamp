...
- id: in_specify_file_format
  ...
  inputBinding:
    prefix: -j
- id: in_write_report_output
  doc: Write report to OUTPUT (stdout).
  type: string?
  inputBinding:
    prefix: -o
- id: in_file_bed_format_listing_processed
...
- id: in_file_listing_regions
  ...
  inputBinding:
    prefix: -t
- id: in_file_bed_format_listing_regions
...
- id: in_only_process_records_minimum
  ...
  inputBinding:
    prefix: -q
- id: in_only_process_records_bits
