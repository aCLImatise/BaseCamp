...
- id: in_print_genomic_coordinates
  ...
  inputBinding:
    prefix: -a
- id: in_stringent_when_assigning
  doc: be stringent when assigning miRNA-precursor connections like mmu-mir only is
    assigned to mmu-precursor
  type: boolean
  inputBinding:
    prefix: -l
outputs:
