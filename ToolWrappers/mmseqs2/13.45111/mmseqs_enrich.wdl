...
task MmseqsEnrich {
  ...
  parameter_meta {
    ...
    num_iterations: "Number of iterative profile search iterations [3]"
    ...
    expansion_mode: "Update score, E-value, and sequence identity by 0: input alignment 1: rescoring the inferred backtrace [1]"
