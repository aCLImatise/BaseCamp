...
- id: in_sensitivity_faster_fast
  doc: '7.000           sensitivity: 1.0 faster; 4.0 fast default; 7.5 sensitive [1.0,7.5]'
  type: boolean
  inputBinding:
    prefix: -s
...
- id: in_list_matches_evalue
  doc: 100.000         list matches below this E-value [0.0, inf]
  type: boolean
  inputBinding:
    prefix: -e
- id: in_min_seq_id
...
- id: in_max_accept
  ...
  inputBinding:
    prefix: --max-accept
- id: in_score_bias
  doc: 0.300           Score bias when computing the SW alignment (in bits)
  type: boolean
  inputBinding:
    prefix: --score-bias
- id: in_pc_a
...
- id: in_qsc
  ...
  inputBinding:
    prefix: --qsc
- id: in_cov
  doc: 0.700           filter output MSAs using min. fraction of query residues covered
