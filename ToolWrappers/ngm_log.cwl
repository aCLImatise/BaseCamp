...
- id: in_q_slash_qry
  ...
  inputBinding:
    prefix: -q/--qry
- id: in_one_slash_qry_one
  doc: Path to the read file containing mates 1.
  type: File
  inputBinding:
    prefix: -1/--qry1
- id: in_two_slash_qry_two
...
- id: in_p_slash_paired
  ...
  inputBinding:
    prefix: -p/--paired
- id: in_i_slash_min_insert_size
  doc: "The min insert size for paired end alignments\n(default: 0)"
  type: boolean
  inputBinding:
    prefix: -I/--min-insert-size
- id: in_x_slash_max_insert_size
  doc: "The max insert size for paired end alignments\n(default: 1000)"
  type: boolean
  inputBinding:
    prefix: -X/--max-insert-size
...
- id: in_bs_cut_off
  ...
  inputBinding:
    prefix: --bs-cutoff
- id: in_h_slash_help
  doc: Prints help and aborts program
  type: boolean
  inputBinding:
    prefix: -h/--help
- id: in_k_slash_km_er
