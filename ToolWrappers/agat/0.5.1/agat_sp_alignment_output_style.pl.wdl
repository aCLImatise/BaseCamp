...
task AgatSpAlignmentOutputStylepl {
  input {
    File? gff
    File? ct
    Boolean? verbose_option_see
    String agat_sp_alignment_output_style_do_tpl
    File file_dot
  }
  command <<<
    agat_sp_alignment_output_style_pl \
      ~{agat_sp_alignment_output_style_do_tpl} \
      ~{file_dot} \
  ...
  parameter_meta {
    ...
    agat_sp_alignment_output_style_do_tpl: "Description:"
