...
inputs:
- id: in_ranges
  doc: "Scaffold extraction ranges. If a range is specified,\nonly features within\
    \ the range will be extracted from\nthe scaffold. Ranges should be formatted like:\n\
...
- id: in_no_align
  ...
  inputBinding:
    prefix: --no_align
- id: in_identity
  doc: 'Minimum alignment sequence identity [default: 0.3]'
  type: double?
  inputBinding:
    prefix: --identity
- id: in_jobs
...
- id: in_session
  ...
  inputBinding:
    prefix: --session
- id: in_json_indent
  doc: 'Number of spaces to indent JSON [default: none]'
  type: long?
  inputBinding:
    prefix: --json_indent
- id: in_force
...
- id: in_plot_cluster_alignments
  ...
  inputBinding:
    prefix: -p
- id: in_delimiter
  doc: "Character to delimit output by [default: human\nreadable]"
  type: string?
  inputBinding:
    prefix: --delimiter
- id: in_decimals
  doc: 'Number of decimal places in output [default: 2]'
  type: double?
  inputBinding:
    prefix: --decimals
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/clinker-py:0.0.20--pyh3252c3a_0
cwlVersion: v1.1
baseCommand:
- clinker
