...
task Treebender {
  ...
  parameter_meta {
    ...
    ladder_ize: "/ -l                  laddrize the tree. If followed by l - left\\nladderize, if followed by r - right ladderize\\n(default), e.g. -l r."
    ...
    number_of_tax_a: "/ -n             get the number of tips/taxa in the tree."
    out_group_root: "/ -o [taxa]         root using most recent common ancestor of given\\ntaxa, e.g. -o taxa1,taxa2."
