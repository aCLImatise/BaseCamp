...
task Pilon {
  ...
  parameter_meta {
    ...
    nano_pore: "A bam file containing Oxford Nanopore read alignments. Experimental."
    pac_bio: "A bam file containing Pacific Biosciences read alignments. Experimental."
