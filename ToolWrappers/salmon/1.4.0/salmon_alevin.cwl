...
- id: in_arg_output_quantification
  ...
  inputBinding:
    prefix: -o
- id: in_just_selectively_align
  doc: "[ --rad ]                          just selectively align the data and\nwrite\
    \ the results to a RAD file.  Do\nnot perform the rest of the\nquantification\
    \ procedure."
  type: boolean?
  inputBinding:
    prefix: -j
- id: in_sketch
  doc: "perform sketching rather than selective\nalignment and write the results to\
...
- id: in_read_geometry
  doc: "format string describing the geometry\nof the read"
  type: string?
  inputBinding:
...
- id: in_bc_geometry
  ...
  inputBinding:
    prefix: --bc-geometry
- id: in_umi_geometry
  doc: "format string describing the genometry\nof the umi"
  type: string?
  inputBinding:
    prefix: --umi-geometry
- id: in_end
