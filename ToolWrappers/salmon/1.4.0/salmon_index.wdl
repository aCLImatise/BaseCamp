...
task SalmonIndex {
  ...
  parameter_meta {
    ...
    arg_size_used: "[ --kmerLen ] arg (=31)    The size of k-mers that should be used for the\\nquasi index."
    ...
    arg_number_threads: "[ --threads ] arg (=2)     Number of threads to use during indexing."
