...
- id: in_w_options_write
  doc: "for -w and -x options, write in the FASTA defline the exon\ncoordinates projected\
    \ onto the spliced sequence;\nfor -y option, write transcript attributes in the\
    \ FASTA defline"
  type: boolean
  inputBinding:
    prefix: -W
