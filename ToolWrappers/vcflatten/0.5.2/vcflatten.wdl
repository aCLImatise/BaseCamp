...
task Vcflatten {
  ...
  parameter_meta {
    info: "Specify a semicolon-separated list of INFO IDs to output for each variant from the VCF file."
    genotype: "Specify a colon-separated list of FORMAT IDs to output for each sample from the VCF file."
