...
task CooltoolsComputeexpected {
  ...
  parameter_meta {
    ...
    contact_type: "[cis|trans]  compute expected for cis or trans region of\\na Hi-C map.trans-expected is calculated for\\npairwise combinations of specified regions.\\n[default: cis]"
    regions: "Path to a BED file containing genomic\\nregions for which expected will be\\ncalculated. Region names canbe provided in a\\n4th column, otherwise UCSC notaion is\\nused.When not specified, expected is\\ncalculated for all chromosomes"
