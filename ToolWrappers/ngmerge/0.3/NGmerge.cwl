...
- id: in_file_output_fastq
  ...
  inputBinding:
    prefix: -o
- id: in_int_minimum_overlap_pairedend
...
- id: in_use_mode_also
  ...
  inputBinding:
    prefix: -a
- id: in_option_check_dovetailing
  doc: Option to check for dovetailing (with 3' overhangs)
  type: boolean
  inputBinding:
    prefix: -d
- id: in_int_minimum_overlap_def
...
- id: in_file_fastq_files
  ...
  inputBinding:
    prefix: -f
- id: in_file_log_file_dovetailed
...
- id: in_z_slash_y
  ...
  inputBinding:
    prefix: -z/-y
- id: in_option_produce_interleaved
