...
- id: in_stdout_dot
  ...
  inputBinding:
    position: 0
- id: in__confpercentcutoff_confpercentcutoff
  doc: --conf_percent_cutoff conf_percent_cutoff
  type: string
  inputBinding:
    position: 1
outputs:
