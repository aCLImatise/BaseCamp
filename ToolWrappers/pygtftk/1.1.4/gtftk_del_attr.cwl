...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_key
  doc: 'comma-separated list of attribute names or a regular expression (see -r).
    (default: None)'
  type: boolean
  inputBinding:
    prefix: --key
- id: in_reg_exp
  doc: 'The key name is a regular expression. (default: False)'
  type: boolean
  inputBinding:
    prefix: --reg-exp
- id: in_invert_match
  doc: 'Delected keys are those not matching any of the specified key. (default: False)'
  type: boolean
  inputBinding:
    prefix: --invert-match
- id: in_verbosity
