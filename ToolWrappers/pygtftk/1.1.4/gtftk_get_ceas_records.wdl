...
task GtftkGetCeasRecords {
  ...
  parameter_meta {
    input_file: "Path to the CEAS file. (default: None)"
    output_file: "Output file. (default: <stdout>)"
    target_table: "The target table. (default: GeneTable)"
    show_tables: "Only list tables and exit. (default: False)"
