...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_src_key
  doc: 'The name of the source key (default: None)'
  type: boolean?
  inputBinding:
    prefix: --src-key
- id: in_dest_key
  doc: 'The name of the target key. (default: None)'
  type: boolean?
  inputBinding:
    prefix: --dest-key
- id: in_nb_levels
  doc: 'The number of levels/classes to create. (default: 2)'
  type: boolean?
  inputBinding:
    prefix: --nb-levels
- id: in_labels
  doc: 'A comma-separated list of labels of size --nb-levels. (default: None)'
  type: boolean?
  inputBinding:
    prefix: --labels
- id: in_percentiles
  doc: 'Compute --nb-levels classes using percentiles. (default: False)'
  type: boolean?
  inputBinding:
    prefix: --percentiles
- id: in_log
  doc: 'Compute breaks based on log-scale. (default: False)'
  type: boolean?
  inputBinding:
    prefix: --log
- id: in_percentiles_of_uniq
  doc: 'Compute percentiles based on non-redondant values. (default: False)'
  type: boolean?
  inputBinding:
    prefix: --percentiles-of-uniq
- id: in_precision
  doc: 'The precision used in naming intervals. (default: 2)'
  type: boolean?
  inputBinding:
    prefix: --precision
- id: in_verbosity
