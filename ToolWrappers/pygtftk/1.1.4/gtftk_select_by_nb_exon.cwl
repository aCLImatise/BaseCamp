...
id: gtftk_select_by_nb_exon.cwl
inputs:
- id: in_input_file
...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_min_exon_number
  doc: 'Minimum number of exons. (default: 0)'
  type: boolean
  inputBinding:
    prefix: --min-exon-number
- id: in_max_exon_number
  doc: 'Maximum number of exons. (default: None)'
  type: boolean
  inputBinding:
    prefix: --max-exon-number
- id: in_verbosity
