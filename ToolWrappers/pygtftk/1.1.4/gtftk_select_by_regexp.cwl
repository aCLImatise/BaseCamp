...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_key
  doc: 'The key name (default: chrom)'
  type: boolean
  inputBinding:
    prefix: --key
- id: in_regexp
  doc: 'The regular expression. (default: ^chr[0-9XY]+$)'
  type: boolean
  inputBinding:
    prefix: --regexp
- id: in_invert_match
  doc: 'Not/invert match. Selected lines whose requested key do not match the regexp.
    (default: False)'
  type: boolean
  inputBinding:
    prefix: --invert-match
