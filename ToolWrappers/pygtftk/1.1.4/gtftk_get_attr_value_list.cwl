...
id: gtftk_get_attr_value_list.cwl
inputs:
- id: in_input_file
...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_key_name
  doc: 'The comma separated list of key name. (default: None)'
  type: boolean?
  inputBinding:
    prefix: --key-name
- id: in_separator
  doc: 'The separator used if -c or -p are true. (default: )'
  type: boolean?
  inputBinding:
    prefix: --separator
- id: in_count
  doc: "Add the counts for each key (separator will be set to ' ' by default). (default:\
    \ False)"
  type: boolean?
  inputBinding:
    prefix: --count
- id: in_print_key_name
  doc: 'Also print the key name in the first column. (default: False)'
  type: boolean?
  inputBinding:
    prefix: --print-key-name
- id: in_verbosity
