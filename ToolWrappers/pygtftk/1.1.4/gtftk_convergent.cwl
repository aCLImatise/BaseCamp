...
- id: in_chrom_info
  ...
  inputBinding:
    prefix: --chrom-info
- id: in_upstream
  doc: "Extends the tts in 5' by a given value (int). Defines the region around the\
    \ tts. (default: 1500)"
  type: boolean?
  inputBinding:
    prefix: --upstream
- id: in_downstream
  doc: "Extends the region in 3' by a given value (int). Defines the region around\
