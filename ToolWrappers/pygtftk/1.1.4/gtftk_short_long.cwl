...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_longs
  doc: 'Take the longest transcript of each gene (default: False)'
  type: boolean
  inputBinding:
    prefix: --longs
- id: in_keep_gene_lines
  doc: 'Add gene lines to the output (default: False)'
  type: boolean
  inputBinding:
    prefix: --keep-gene-lines
- id: in_verbosity
