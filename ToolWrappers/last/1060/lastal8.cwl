...
- id: in_unaligned_residue_pair
  ...
  inputBinding:
    prefix: -c
- id: in__frameshift_cost
  doc: ': frameshift cost (off)'
  type: boolean
  inputBinding:
    prefix: -F
- id: in_maximum_score_drop_z
...
- id: in_stop_first_n
  ...
  inputBinding:
    prefix: -N
- id: in_repeatmarking_options_same
