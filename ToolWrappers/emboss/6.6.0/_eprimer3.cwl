...
- id: in_first_base_index
  doc: "integer    [1] This parameter is the index of the first\nbase in the input\
    \ sequence. For input and\noutput using 1-based indexing (such as that\nused in\
    \ GenBank and to which many users are\naccustomed) set this parameter to 1. For\n\
...
- id: in_max_end_stability
  doc: "float      [9.0] The maximum stability for the five 3'\nbases of a forward\
    ...
    \ and Marky, Proc. Natl. Acad. Sci.\nUSA, vol 83, pp 3746-3750. EPrimer3 uses\
