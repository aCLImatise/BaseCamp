...
task RaxmlHPCPTHREADS {
  ...
  parameter_meta {
    ...
    binary_binary_model: "Specify the file name of a binary model parameter file that has previously been generated\\nwith RAxML using the -f e tree evaluation option. The file name should be:\\nRAxML_binaryModelParameters.runID"
    ...
    use_median_discrete: "use the median for the discrete approximation of the GAMMA model of rate heterogeneity\\nDEFAULT: OFF"
