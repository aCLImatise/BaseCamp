...
- id: in_minimum_length_final
  doc: "[FINAL_MIN_LENGTH], --final_min_length [FINAL_MIN_LENGTH]\nminimum length\
    \ of the final outputted reads"
  type: boolean?
  inputBinding:
    prefix: -l
- id: in_q_five
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/ultraplex:1.1.4--py38h0213d0e_0
cwlVersion: v1.1
baseCommand:
- ultraplex
