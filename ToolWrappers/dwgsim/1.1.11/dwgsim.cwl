...
- id: in_rate_of_mutations
  ...
  inputBinding:
    prefix: -r
- id: in_frequency_simulate_mutations
...
- id: in_probability_random_dna
  ...
  inputBinding:
    prefix: -y
- id: in_maximum_number_allowed
  doc: maximum number of Ns allowed in a given read [0]
  type: long?
  inputBinding:
    prefix: -n
- id: in_generate_reads_torrent
