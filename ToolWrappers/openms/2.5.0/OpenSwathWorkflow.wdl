...
task OpenSwathWorkflow {
  ...
  parameter_meta {
    ...
    mz_extraction_window: "Extraction window in Thomson or ppm (see mz_extraction_window_unit) (default: '0.05' min: '0.0')"
    mz_extraction_window_ms_one: "Extraction window used in MS1 in Thomson or ppm (see mz_extraction_window_ms1_unit) (default: '0.05' min: '0.0')"
