...
task ConsensusMapNormalizer {
  ...
  parameter_meta {
    ...
    ratio_threshold: "Only for 'robust_regression': the parameter is used to distinguish between non-outliers (ratio_threshold < intensity ratio < 1/ratio_threshold) and outliers. (default: '0.67' min: '1.0e-03' max: '1.0')"
