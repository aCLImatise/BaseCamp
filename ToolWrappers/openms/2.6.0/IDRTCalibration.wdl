...
task IDRTCalibration {
  ...
  parameter_meta {
    ...
    calibra_nt_one_input: "The RT of the first calibrant in the input file. Please note that this value needs to be set. The default value -1.0 is not allowed. (default: '-1.0')"
    calibra_nt_two_input: "The RT of the second calibrant in the input file. Please note that this value needs to be set. The default value -1.0 is not allowed. (default: '-1.0')"
