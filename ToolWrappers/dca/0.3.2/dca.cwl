...
- id: in_tensor_board
  ...
  inputBinding:
    prefix: --tensorboard
- id: in_check_counts
  doc: "Check if the expression matrix has raw (unnormalized)\ncounts (default: True)"
  type: boolean?
  inputBinding:
    prefix: --checkcounts
- id: in_no_check_counts
  doc: "Do not check if the expression matrix has raw\n(unnormalized) counts"
  type: boolean?
  inputBinding:
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/dca:0.3.2--py_0
cwlVersion: v1.1
baseCommand:
- dca
