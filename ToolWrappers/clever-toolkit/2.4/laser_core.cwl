...
- id: in_arg_minimal_number
  ...
  inputBinding:
    prefix: -a
- id: in_arg_maximal_allowed_length
...
- id: in_max_anchors
  ...
  inputBinding:
    prefix: --max_anchors
- id: in_max_anchor_pairs
  doc: (=500)         Maximal allowed number of anchor
  type: long?
  inputBinding:
    prefix: --max_anchor_pairs
- id: in_arg_maximal_allowed_sizewhen
