...
inputs:
- id: in_hits
  doc: "Tabular file whose fields are [query, subject, score]. Subject\nmust be an\
    \ accession or contain one in the fourth field of pipe\nnotation (e.g. \"gi|12345|xx|ABC123.1|\"\
    . The subject and score\ncan be omitted to include a query that has no hits, which\
