...
- id: in_cds_flags_combine
  ...
  inputBinding:
    prefix: -k
- id: in_verification_combine_validate
...
- id: in_mrna_title_policys
  ...
  inputBinding:
    prefix: -Q
- id: in_remove_xref_optionaldefault
...
- id: in_force_local_proteinidtranscriptid
  ...
  inputBinding:
    prefix: -L
- id: in_remote_taxonomy_optionaldefault
