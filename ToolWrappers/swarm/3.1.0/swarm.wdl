...
task Swarm {
  ...
  command <<<
    swarm \
      ...
      ~{if (disable_sse_three) then "--disable-sse3" else ""} \
  ...
  parameter_meta {
    ...
    disable_sse_three: "disable SSE3 and later x86 instructions"
    ...
    network_file: "dump sequence network to file"
