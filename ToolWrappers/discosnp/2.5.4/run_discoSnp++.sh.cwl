...
- id: in_symmetrical
  ...
  inputBinding:
    prefix: --symmetrical
- id: in_graph
  doc: Reuse a previously created graph (.h5 file)
  type: File?
  inputBinding:
    prefix: --graph
...
- id: in_deletion_max_size
  doc: discoSnp++ will search for deletions of size from 0 to D included. -D 0 means
    no deletion detected. Default=100.
  type: long?
  inputBinding:
