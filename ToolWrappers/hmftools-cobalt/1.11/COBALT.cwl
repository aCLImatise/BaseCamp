...
inputs:
- id: in_input_dir
  doc: Input directory (used for migration only)
  type: Directory?
  inputBinding:
    prefix: -input_dir
- id: in_min_quality
...
- id: in_tumor_only
  ...
  inputBinding:
    prefix: -tumor_only
- id: in_tumor_only_diploid_bed
  doc: Diploid regions for tumor-only mode
  type: string?
  inputBinding:
    prefix: -tumor_only_diploid_bed
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/hmftools-cobalt:1.11--0
cwlVersion: v1.1
baseCommand:
- COBALT
