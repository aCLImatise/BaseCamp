...
- id: in_default_score_mismatching
  ...
  inputBinding:
    prefix: -n
- id: in_default_gap_opening_penalty_be
  doc: "default: -8\ngap opening penalty (must be non-positive)"
  type: long?
  inputBinding:
    prefix: -g
- id: in_default_gap_extension_penalty_be
...
- id: in_algorithm
  ...
  inputBinding:
    prefix: --algorithm
- id: in_result
  doc: "(option can be used multiple times)\ndefault: 0\nresult mode:\n0 - consensus\
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/spoa:4.0.7--he513fc3_0
cwlVersion: v1.1
baseCommand:
- spoa
