...
task MuSECall {
  ...
  command <<<
    MuSE call \
      ...
      ~{if defined(list_regions_chrpospos) then ("-l " +  '"' + list_regions_chrpospos + '"') else ""} \
  ...
  parameter_meta {
    ...
    list_regions_chrpospos: "list of regions (chr:pos-pos or BED), one\\nregion per line"
