...
- id: in_min_width
  ...
  inputBinding:
    prefix: --min-width
- id: in_write_n
  doc: The number of principal coordinates to calculate (default is 5).
  type: boolean?
  inputBinding:
    prefix: --write-n
- id: in_som
  doc: The number of dimensions to rotate for support overlap minimization(default
    is 0; options are 0, 2, 3).
  type: boolean?
  inputBinding:
    prefix: --som
- id: in_scale
...
- id: in_s_ymmv
  ...
  inputBinding:
    prefix: --symmv
- id: in_raw_eval
  doc: Output the raw eigenvalue rather than the fraction of variance.
  type: boolean?
  inputBinding:
    prefix: --raw-eval
- id: in_kappa
