...
- id: in_split_alignment_take
  doc: for split alignment, take the alignment with the smallest coordiate as primary
  type: boolean?
  inputBinding:
    prefix: '-5'
