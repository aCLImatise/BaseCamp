...
task Normalisationpy {
  ...
  parameter_meta {
    ...
    input_biom: "Abundances file to normalise (format: BIOM)."
    input_fast_a: "Sequences file to normalise (format: FASTA)."
    output_biom: "Normalised abundances (format: BIOM). [Default:\\nnormalisation_abundance.biom]"
    output_fast_a: "Normalised sequences (format: FASTA). [Default:\\nnormalisation.fasta]"
