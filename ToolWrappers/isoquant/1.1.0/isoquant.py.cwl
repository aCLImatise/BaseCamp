...
- id: in_stranded
  ...
  inputBinding:
    prefix: --stranded
- id: in_has_polya
  doc: "set if reads were not polyA trimmed; polyA tails will\nbe detected and further\
    \ required for transcript model\nconstruction"
  type: boolean?
  inputBinding:
    prefix: --has_polya
- id: in_fl_data
...
- id: in_model_construction_strategy
  doc: "transcritp model construnction strategy to use\n"
  type: string?
  inputBinding:
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/isoquant:1.1.0--0
cwlVersion: v1.1
baseCommand:
- isoquant.py
