...
- id: in_use_cigar_alignment
  ...
  inputBinding:
    prefix: -M
- id: in_output_aln_alignment_file
  doc: to output the ALN alignment file
  type: File?
  inputBinding:
    prefix: -a
- id: in_output_sam_alignment_file
...
- id: out_stdout
  ...
  type: stdout
- id: out_output_aln_alignment_file
  doc: to output the ALN alignment file
  type: File?
  outputBinding:
    glob: $(inputs.in_output_aln_alignment_file)
- id: out_output_sam_alignment_file
  doc: to output the SAM alignment file
  type: File?
  outputBinding:
    glob: $(inputs.in_output_sam_alignment_file)
hints: []
cwlVersion: v1.1
baseCommand:
- art_454
