...
- id: in_alignment_mode
  doc: 'How to compute the alignment: 0: automatic; 1: only score and end_pos; 2:
    also start_pos and cov; 3: also seq.id; 4: only ungapped alignment [0]'
  type: long
  inputBinding:
...
- id: in_lca_ranks
  ...
  inputBinding:
    prefix: --lca-ranks
- id: in_blacklist
  doc: Comma separated list of ignored taxa in LCA computation [12908,28384]
  type: long
  inputBinding:
    prefix: --blacklist
- id: in_tax_lineage
  doc: Add column with full taxonomy lineage [0]
  type: boolean
  inputBinding:
    prefix: --tax-lineage
- id: in_lca_mode
  doc: 'LCA Mode 1: Single Search LCA , 2: 2bLCA, 3: approx. 2bLCA, 4: top hit [4]'
  type: long
  inputBinding:
    prefix: --lca-mode
- id: in_tax_output_mode
  doc: '0: output LCA, 1: output alignment [0]'
  type: long
  inputBinding:
