...
task Wtmsa {
  ...
  parameter_meta {
    ...
    turn_homopolymer_merge: "turn on homopolymer merge penalty"
    ...
    maximum_bandwidth_ending: "Maximum bandwidth at graph alignment and ending extension, [800]"
