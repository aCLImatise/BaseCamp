...
task SeqtkTrimfq {
  ...
  command <<<
    seqtk trimfq \
      ...
      ~{if defined(trimming_bebe_shall) then ("-s " +  '"' + trimming_bebe_shall + '"') else ""} \
  ...
  parameter_meta {
    ...
    trimming_bebe_shall: "trimming by -b/-e/-B/-E shall not produce reads shorter then INT bp [1]"
