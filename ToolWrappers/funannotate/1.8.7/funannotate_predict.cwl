...
- id: in_p_two_g_p_ident
  doc: 'Exonerate percent identity. Default: 80'
  type: boolean?
  inputBinding:
    prefix: --p2g_pident
- id: in_p_two_g_diamond_db
  doc: Premade diamond genome database for protein2genome mapping
  type: boolean?
  inputBinding:
    prefix: --p2g_diamond_db
- id: in_p_two_g_prefilter
  doc: 'Pre-filter hits software selection. Default: diamond [tblastn]'
  type: boolean?
  inputBinding:
    prefix: --p2g_prefilter
...
- id: in_genemark_gtf
  ...
  inputBinding:
    prefix: --genemark_gtf
- id: in_trnascan
  doc: Pre-computed tRNAscanSE results
  type: boolean?
  inputBinding:
    prefix: --trnascan
...
- id: in_keep_evm
  ...
  inputBinding:
    prefix: --keep_evm
- id: in_evm_partition_interval
  doc: 'length between genes to make a partition: Default: 1500'
  type: long?
  inputBinding:
    prefix: --evm-partition-interval
- id: in_no_evm_partitions
  doc: Do not split contigs into partitions
  type: boolean?
  inputBinding:
    prefix: --no-evm-partitions
- id: in_repeat_filter
