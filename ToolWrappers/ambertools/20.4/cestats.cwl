...
- id: in_novice
  ...
  inputBinding:
    prefix: --novice
- id: in_ce_in
  doc: "Input cein or cpein file (from pmemd or sander) with titrating residue\ninformation."
  type: File?
  inputBinding:
    prefix: --cein
- id: in_time_step
  ...
  inputBinding:
    prefix: --time-step
- id: in_cal_ceo_output
  doc: "File to which the standard `calceo'-type statistics\nare written. Default\
    \ is stdout"
  type: File?
  inputBinding:
    prefix: --calceo-output
...
- id: in_population
  doc: "Output file where reduction state populations are\nprinted for every state\
    \ of every residue."
  type: File?
  inputBinding:
    prefix: --population
...
- id: in_interval
  ...
  inputBinding:
    prefix: --interval
- id: in_reduced
  doc: "Print out reduction fraction instead of oxidation\nfraction in time series\
    \ data (Default behavior)."
  type: boolean?
  inputBinding:
    prefix: --reduced
- id: in_oxidized
  doc: "Print out oxidation fraction instead of reduction\nfraction in time series\
    \ data."
  type: boolean?
  inputBinding:
    prefix: --oxidized
- id: in_eo
  doc: "Print predicted Eos (via Nernst equation) in place\nof fraction reduced or\
    \ oxidized. NOT default behavior."
  type: boolean?
  inputBinding:
    prefix: --Eo
- id: in_cal_ceo
  doc: Triggers the calceo-style output [On by default]
  type: boolean?
  inputBinding:
    prefix: --calceo
- id: in_no_cal_ceo
  doc: Turns off the calceo-style output
  type: boolean?
  inputBinding:
    prefix: --no-calceo
- id: in_running_avg
...
- id: in_cumulative
  ...
  inputBinding:
    prefix: --cumulative
- id: in_fix_re_md
  doc: "This option will trigger cestats to reassemble the\ntitration data into Redox\
    \ potential specific ensembles. This\nis an exclusive mode of the program---no\
