...
task Casmlayout {
  input {
    ...
    Int? set_maximum_length_default
    Float? set_minimum_identity_default
    ...
    Boolean? randomly_place_repetitive
    Int? set_random_seed
    Boolean? include_singleton_contigs
    Int? set_maximum_ignorable_default
    File? output_tigr_contig
    File? output_umd_contig
    Float? set_minimum_coverage_default
  ...
  command <<<
    casm_layout \
      ...
      ~{if defined(set_maximum_length_default) then ("-g " +  '"' + set_maximum_length_default + '"') else ""} \
      ~{if defined(set_minimum_identity_default) then ("-i " +  '"' + set_minimum_identity_default + '"') else ""} \
  ...
  parameter_meta {
    ...
    set_maximum_length_default: "Set maximum alignment gap length, default 10000"
    set_minimum_identity_default: "Set the minimum alignment identity, default 70"
    ...
    set_minimum_length: "Set minimum overlap length for assembly, default 10"
    only_place_reads: "Only place reads with happy mate-pairs"
    randomly_place_repetitive: "Randomly place repetitive reads into one of their copy\\nlocations if they cannot be placed via mate-pair info"
    ...
    set_maximum_ignorable_default: "Set maximum ignorable trim length, default 20"
    output_tigr_contig: "Output TIGR contig to file"
    output_umd_contig: "Output UMD contig to file"
    set_minimum_coverage_default: "Set the minimum alignment coverage, default 25"
