...
task Phd2afg {
  input {
    ...
    File? optional_file_containing_clipping
  ...
  command <<<
    phd2afg \
      ...
      ~{if defined(optional_file_containing_clipping) then ("-c " +  '"' + optional_file_containing_clipping + '"') else ""} \
  ...
  parameter_meta {
    ...
    optional_file_containing_clipping: "optional: file containing clipping coordinates"
