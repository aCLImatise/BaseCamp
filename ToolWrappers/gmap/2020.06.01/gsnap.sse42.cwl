...
- id: in_sampling
  ...
  inputBinding:
    prefix: --sampling
- id: in_part
  doc: "Process only the i-th out of every n sequences\ne.g., 0/100 or 99/100 (useful\
...
- id: in_min_coverage
  ...
  inputBinding:
    prefix: --min-coverage
- id: in_ignore_trim_in_filtering
  doc: Whether to ignore trimmed ends in applying the --max-mismatches
  type: long
  inputBinding:
