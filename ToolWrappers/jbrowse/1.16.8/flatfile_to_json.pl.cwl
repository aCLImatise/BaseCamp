...
- id: in_out
  ...
  inputBinding:
    prefix: --out
- id: in_track_type
  doc: "Optional JavaScript class to use to display this track. For backward\ncompatibility,\
    \ this defaults to \"HTMLFeatures\".\nUnless you have some reason to use HTMLFeatures\
    \ tracks, though, it's\nrecommended to set this to \"CanvasFeatures\" to use the\
