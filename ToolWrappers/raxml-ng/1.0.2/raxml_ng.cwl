...
- id: in_ancestral
  ...
  inputBinding:
    prefix: --ancestral
- id: in_site_lh
  doc: print per-site log-likelihood values
  type: boolean?
  inputBinding:
    prefix: --sitelh
- id: in_search_one
...
- id: in_out_group
  ...
  inputBinding:
    prefix: --outgroup
- id: in_site_weights
  doc: FILE                     file with MSA column weights (positive integers only!)
  type: boolean?
  inputBinding:
    prefix: --site-weights
- id: in_seed
...
- id: in_site_repeats
  ...
  inputBinding:
    prefix: --site-repeats
- id: in_threads
  doc: 'VALUE                       number of parallel threads to use (default: 2)'
  type: boolean?
  inputBinding:
    prefix: --threads
- id: in_workers
  doc: 'VALUE                       number of tree searches to run in parallel (default:
    1)'
  type: boolean?
  inputBinding:
    prefix: --workers
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/raxml-ng:1.0.2--h7447c1b_0
cwlVersion: v1.1
baseCommand:
- raxml-ng
