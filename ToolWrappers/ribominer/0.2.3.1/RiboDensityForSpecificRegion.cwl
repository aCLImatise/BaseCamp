...
id: RiboDensityForSpecificRegion.cwl
inputs:
- id: in_bam_list_file
...
- id: in_left_position
  doc: Left position of the interesting region
  type: string?
  inputBinding:
    prefix: --Left_position
- id: in_right_position
  doc: Right position of the interesting region
  type: string?
  inputBinding:
    prefix: --Right_position
- id: in_id_type
