...
- id: in_format
  ...
  inputBinding:
    prefix: --format
- id: in_left_position
  doc: "The left position of the region that you are\ninterested in. default=none"
  type: string?
  inputBinding:
    prefix: --left-position
- id: in_right_position
  doc: "The right position of the region that you are\ninterested in. default=none"
  type: string?
  inputBinding:
...
- id: in_a_xv_line
  ...
  inputBinding:
    prefix: --axvline
- id: in_ylab
  doc: "labels for y axis.'Average hydrophobicity' or 'Average\ncharges'"
  type: string?
  inputBinding:
    prefix: --ylab
- id: in_start
