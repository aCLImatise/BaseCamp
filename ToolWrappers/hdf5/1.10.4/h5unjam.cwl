...
- id: out_stdout
  ...
  type: stdout
- id: out_specifies_output_file_containing
  doc: "Specifies the output file containing the data from the\nuser block.\nCannot\
    \ be used with --delete option."
  type: File?
  outputBinding:
    glob: $(inputs.in_specifies_output_file_containing)
hints: []
cwlVersion: v1.1
baseCommand:
- h5unjam
