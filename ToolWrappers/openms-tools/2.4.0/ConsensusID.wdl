...
task ConsensusID {
  ...
  parameter_meta {
    ...
    rt_delta: "[idXML input only] Maximum allowed retention time deviation between identifications belonging to the same spectrum. (default: '0.1' min: '0')"
    mz_delta: "[idXML input only] Maximum allowed precursor m/z deviation between identifications belonging to the same spectrum. (default: '0.1' min: '0')"
