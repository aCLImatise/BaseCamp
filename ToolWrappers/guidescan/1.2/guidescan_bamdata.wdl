...
task GuidescanBamdata {
  ...
  command <<<
    guidescan_bamdata \
      ...
      ~{if defined(name_compute_bamdatabase) then ("-g " +  '"' + name_compute_bamdatabase + '"') else ""} \
