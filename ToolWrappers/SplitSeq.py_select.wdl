...
task SplitSeqpySelect {
  input {
    ...
    Array[String] list_select_exclusive
  ...
  command <<<
    SplitSeq_py select \
      ...
      ~{if defined(list_select_exclusive) then ("-u " +  '"' + list_select_exclusive + '"') else ""} \
  ...
  parameter_meta {
    ...
    list_select_exclusive: "A list of values to select for in the specified field.\\nMutually exclusive with -t. (default: None)"
