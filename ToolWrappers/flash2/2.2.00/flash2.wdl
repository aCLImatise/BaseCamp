...
task Flash2 {
  ...
  command <<<
    flash2 \
      ...
      ~{if defined(min_overlap_out_ie) then ("--min-overlap-outie " +  '"' + min_overlap_out_ie + '"') else ""} \
  ...
  parameter_meta {
    ...
    min_overlap_out_ie: "The minimum required overlap length between two\\nreads to provide a confident overlap in an outie scenario.\\nDefault: 35bp."
