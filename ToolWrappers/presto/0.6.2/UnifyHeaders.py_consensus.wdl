...
task UnifyHeaderspyConsensus {
  input {
    ...
    String? name_find_consensusfor
  }
  command <<<
    UnifyHeaders_py consensus \
  ...
  parameter_meta {
    ...
    annotation_field_containing: "The annotation field containing annotations, such as\\nthe UMI barcode, for sequence grouping. (default:\\nBARCODE)"
    name_find_consensusfor: "The name of the annotation field to find a consensus\\nfor per each sequence group. (default: SAMPLE)\\n"
  }
  output {
