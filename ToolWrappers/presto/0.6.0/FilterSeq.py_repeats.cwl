...
- id: in_nproc
  ...
  inputBinding:
    prefix: --nproc
- id: in_threshold_fraction_repeating
  doc: "Threshold for fraction of repeating nucleotides.\n(default: 15)"
  type: long
  inputBinding:
    prefix: -n
- id: in_missing
  doc: "If specified count consecutive gap and N characters '\nin addition to {A,C,G,T}.\
    \ (default: False)"
  type: boolean
  inputBinding:
    prefix: --missing
