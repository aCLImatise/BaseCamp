...
task ParseHeaderspyExpand {
  input {
    ...
    Boolean? fast_a
    String? delim
    Array[String] list_expand_default
    String? sep
  }
  command <<<
    ParseHeaders_py expand \
  ...
  parameter_meta {
    ...
    list_expand_default: "List of fields to expand. (default: None)"
    sep: "The character separating each value in the fields.\\n(default: ,)\\n"
  }
  output {
