...
- id: in_csv
  ...
  inputBinding:
    prefix: --csv
- id: in_transition_quantification
  doc: "/ --no-transition_quantification\n[format: legacy] Report aggregated\ntransition-level\
...
- id: in_peptide
  doc: / --no-peptide        Append peptide-level error-rate estimates if
  type: boolean
  inputBinding:
    prefix: --peptide
...
- id: in_protein
  doc: / --no-protein        Append protein-level error-rate estimates if
  type: boolean
  inputBinding:
    prefix: --protein
