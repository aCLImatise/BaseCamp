...
task HaystackTfActivityPlane {
  ...
  parameter_meta {
    ...
    var_7: "gene_expression_samples_filename"
    target_cell_type: "HAYSTACK Parameters"
    path_folder_created: "A path to a folder created by the haystack_motifs"
    utility: "gene_expression_samples_filename"
