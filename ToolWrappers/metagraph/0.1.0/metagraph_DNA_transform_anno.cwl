...
id: metagraph_DNA_transform_anno.cwl
inputs:
- id: in_rename_cols
...
- id: in_subsample
  ...
  inputBinding:
    prefix: --subsample
- id: in_fast
  doc: transform annotation in memory without streaming [off]
  type: boolean?
  inputBinding:
    prefix: --fast
...
- id: in_max_path_length
  doc: '[INT]      maximum path length in row_diff annotation [50]'
  type: boolean?
  inputBinding:
    prefix: --max-path-length
- id: in_optimize
  doc: optimize anchors in row_diff annotation [off]
  type: boolean?
  inputBinding:
    prefix: --optimize
- id: in_verbose
