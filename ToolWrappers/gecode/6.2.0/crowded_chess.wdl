...
task Crowdedchess {
  ...
  parameter_meta {
    propagation: "(extensional, decompose) default: extensional\\npropagation variants\\nextensional: Use extensional propagation for bishops-placement\\ndecompose: Use decomposed propagation for bishops-placement"
    ...
    disabled: "Options for CrowdedChess:"
  }
  output {
