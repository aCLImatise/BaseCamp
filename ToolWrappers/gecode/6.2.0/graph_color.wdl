...
task Graphcolor {
  ...
  parameter_meta {
    model: "(none, clique) default: none\\nmodel variants\\nnone: no lower bound\\nclique: use maximal clique size as lower bound"
    symmetry: "(none, ldsb) default: none\\nsymmetry variants\\nldsb: use value symmetry breaking"
    ipl: "(def,val,bnd,dom,basic,advanced)\\ndefault: dom\\ninteger propagation level (comma-separated list)"
    branching: "(degree, size, degree-size, afc-size, action-size) default: degree\\nbranching variants"
    ...
    disabled: "Options for GraphColor:"
  }
  output {
