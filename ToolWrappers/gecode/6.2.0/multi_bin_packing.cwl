...
inputs:
- id: in_model
  doc: "(single, multi) default: multi\nmodel variants\nsingle: use single-dimensional\
    \ bin-packing constraints\nmulti: use single-dimensional bin-packing constraints"
  type: boolean?
  inputBinding:
    prefix: -model
- id: in_symmetry
  doc: "(none, max-conflict) default: max-conflict\nsymmetry variants"
  type: boolean?
  inputBinding:
    prefix: -symmetry
- id: in_ipl
  ...
  inputBinding:
    prefix: -ipl
- id: in_branching
  doc: "(degree, afc) default: afc\nbranching variants"
  type: boolean?
  inputBinding:
    prefix: -branching
- id: in_decay
  doc: "(double) default: 0.99\ndecay factor"
  type: boolean?
  inputBinding:
    prefix: -decay
- id: in_seed
...
- id: in_trace
  ...
  inputBinding:
    prefix: -trace
- id: in_disabled
  doc: 'Options for MultiBinPacking:'
  type: string
  inputBinding:
    position: 0
outputs:
