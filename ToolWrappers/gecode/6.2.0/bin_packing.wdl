...
task Binpacking {
  ...
  parameter_meta {
    model: "(naive, packing) default: packing\\nmodel variants\\nnaive: use naive model (decomposition)\\npacking: use bin packing constraint"
    ipl: "(def,val,bnd,dom,basic,advanced)\\ndefault: def\\ninteger propagation level (comma-separated list)"
    branching: "(naive, cdbf) default: cdbf\\nbranching variants"
    ...
    disabled: "Options for BinPacking:"
  }
  output {
