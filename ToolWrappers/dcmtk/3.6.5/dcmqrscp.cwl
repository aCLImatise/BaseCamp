...
- id: in_assoc_config_file
  doc: "[f]ilename, [i]n-profile, [o]ut-profile: string\nuse profile i from f for\
    \ incoming associations\nuse profile o from f for outgoing associations"
  type: boolean?
  inputBinding:
    prefix: --assoc-config-file
...
- id: in_propose_mpeg_two
  doc: propose MPEG2 Main Profile @ Main Level TS
  type: boolean?
  inputBinding:
    prefix: --propose-mpeg2
- id: in_propose_mpeg_two_high
  doc: propose MPEG2 Main Profile @ High Level TS
  type: boolean?
  inputBinding:
    prefix: --propose-mpeg2-high
- id: in_propose_mpeg_four
  doc: propose MPEG4 AVC/H.264 HP / Level 4.1 TS
  type: boolean?
  inputBinding:
    prefix: --propose-mpeg4
- id: in_propose_mpeg_four_bd
  doc: propose MPEG4 AVC/H.264 BD-compatible TS
  type: boolean?
  inputBinding:
    prefix: --propose-mpeg4-bd
- id: in_propose_mpeg_four_two_two_d
  doc: propose MPEG4 AVC/H.264 HP / Level 4.2 TS (2D)
  type: boolean?
  inputBinding:
    prefix: --propose-mpeg4-2-2d
- id: in_propose_mpeg_four_two_three_d
  doc: propose MPEG4 AVC/H.264 HP / Level 4.2 TS (3D)
  type: boolean?
  inputBinding:
    prefix: --propose-mpeg4-2-3d
- id: in_propose_mpeg_four_two_st
  doc: propose MPEG4 AVC/H.264 Stereo / Level 4.2 TS
  type: boolean?
  inputBinding:
    prefix: --propose-mpeg4-2-st
- id: in_propose_he_vc
  doc: propose HEVC/H.265 Main Profile / Level 5.1 TS
  type: boolean?
  inputBinding:
    prefix: --propose-hevc
- id: in_propose_he_vc_one_zero
  doc: propose HEVC/H.265 Main 10 Profile / Level 5.1 TS
  type: boolean?
  inputBinding:
    prefix: --propose-hevc10
- id: in_propose_rle
...
- id: in_uid_padding
  ...
  inputBinding:
    prefix: --uid-padding
- id: in_convert_to_xxx
  doc: that is not possible
  type: string?
  inputBinding:
    prefix: --convert-to-xxx
- id: in_override_charset
  doc: "convert affected element values to the\ncharacter set specified via --convert-to-xxx,\n\
    ignoring the one specified in the request"
  type: boolean?
  inputBinding:
    prefix: --override-charset
- id: in_transliterate
