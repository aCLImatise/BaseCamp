...
task Storescu {
  ...
  parameter_meta {
    ...
    propose_mpeg_two: "propose MPEG2 Main Profile @ Main Level TS only"
    propose_mpeg_two_high: "propose MPEG2 Main Profile @ High Level TS only"
    propose_mpeg_four: "propose MPEG4 AVC/H.264 HP / Level 4.1 TS only"
    propose_mpeg_four_bd: "propose MPEG4 AVC/H.264 BD-compatible TS only"
