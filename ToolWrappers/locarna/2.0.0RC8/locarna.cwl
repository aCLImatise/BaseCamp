...
- id: in_free_end_gaps
  doc: "(----)\nControl where end gaps are allowed for free. String of four +/- symbols,\n\
    ...
    \ end of first sequence, right end of first sequence, left end of\nsecond sequence,\
    \ right end of second sequence. For example, \"+---\" allows\nfree end gaps at\
