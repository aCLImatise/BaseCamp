...
task MashScreen {
  input {
    ...
    Boolean? winnertakesall_strategy_identity
  ...
  command <<<
    mash screen \
      ...
      ~{if (winnertakesall_strategy_identity) then "-w" else ""} \
