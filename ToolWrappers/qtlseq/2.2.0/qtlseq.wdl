...
task Qtlseq {
  ...
  command <<<
    qtlseq \
      ...
      ~{if (bulk_one) then "--bulk1" else ""} \
      ~{if (bulk_two) then "--bulk2" else ""} \
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/qtlseq:2.2.0--py_0"
  }
  parameter_meta {
    ref: "Reference fasta."
    parent: "fastq or bam of parent. If you specify\\nfastq, please separate pairs by comma,\\ne.g. -p fastq1,fastq2. You can use this\\noptiion multiple times"
    bulk_one: "fastq or bam of bulk 1. If you specify\\nfastq, please separate pairs by comma,\\ne.g. -b1 fastq1,fastq2. You can use this\\noptiion multiple times"
    bulk_two: "fastq or bam of bulk 2. If you specify\\nfastq, please separate pairs by comma,\\ne.g. -b2 fastq1,fastq2. You can use this\\noptiion multiple times"
