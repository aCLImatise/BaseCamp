...
- id: in_adaptor
  ...
  inputBinding:
    prefix: -adaptor
- id: in_minimum_determine_default
...
- id: in_debug
  ...
  inputBinding:
    prefix: --debug
- id: in_delimiter_split_regioninfo
