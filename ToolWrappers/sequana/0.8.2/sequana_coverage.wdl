...
task SequanaCoverage {
  ...
  command <<<
    sequana_coverage \
      ...
      ~{if defined(download_genbank) then ("--download-genbank " +  '"' + download_genbank + '"') else ""} \
  ...
  parameter_meta {
    ...
    download_reference: ""
    download_genbank: ""
    database: "Download the reference from one of these database\\n(default ENA) (default: ENA)"
    welcome: ""
    to: ""
    se_quan_a: ""
  }
