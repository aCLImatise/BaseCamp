...
- id: in__performs_filebv_or_filebv
  ...
  inputBinding:
    prefix: -o
- id: in__performs_filebv_and_not_filebv
  doc: ': performs file1.bv AND (NOT file2.bv)'
  type: File?
  inputBinding:
    prefix: -d
- id: in_print_result_outputbv
...
- id: out_stdout
  ...
  type: stdout
- id: out_print_result_outputbv
  doc: ': print result in file output.bv [Default=stdout]'
  type: File?
  outputBinding:
    glob: $(inputs.in_print_result_outputbv)
hints: []
cwlVersion: v1.1
baseCommand:
- bvop
