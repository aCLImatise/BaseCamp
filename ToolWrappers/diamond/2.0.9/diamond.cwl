...
- id: in_out_fmt
  doc: "(-f)            output format\n0   = BLAST pairwise\n5   = BLAST XML\n6  \
    ...
    \ means Aligned part of query sequence (translated)\nfull_qseq means Query sequence\n\
    ...
    \ means unique Subject Taxonomy ID(s), separated by a ';' (in numerical order)\n\
    sscinames means unique Subject Scientific Name(s), separated by a ';'\nsskingdoms\
    \ means unique Subject Super Kingdom(s), separated by a ';'\nskingdoms means unique\
    \ Subject Kingdom(s), separated by a ';'\nsphylums means unique Subject Phylum(s),\
    \ separated by a ';'\nstitle means Subject Title\nsalltitles means All Subject\
    \ Title(s), separated by a '<>'\nqcovhsp means Query Coverage Per HSP\nscovhsp\
    \ means Subject Coverage Per HSP\nqtitle means Query title\nqqual means Query\
    \ quality values for the aligned part of the query\nfull_qqual means Query quality\
...
- id: in_top
  ...
  inputBinding:
    prefix: --top
- id: in_max_hsps
  doc: maximum number of HSPs per target sequence to report for each query (default=1)
  type: boolean?
  inputBinding:
    prefix: --max-hsps
- id: in_range_culling
...
- id: in_mid_sensitive
  doc: 'enable mid-sensitive mode (default: fast)'
  type: boolean?
  inputBinding:
...
- id: in_very_sensitive
  doc: 'enable very sensitive mode (default: fast)'
  type: boolean?
  inputBinding:
    prefix: --very-sensitive
- id: in_ultra_sensitive
  doc: 'enable ultra sensitive mode (default: fast)'
  type: boolean?
  inputBinding:
...
- id: in_masking
  doc: enable tantan masking of repeat regions (0/1=default)
  type: boolean?
  inputBinding:
    prefix: --masking
...
- id: in_band
  ...
  inputBinding:
    prefix: --band
- id: in_shapes
  doc: (-s)            number of seed shapes (default=all available)
  type: boolean?
  inputBinding:
    prefix: --shapes
- id: in_shape_mask
...
- id: in_memory_limit
  doc: (-M)      Memory limit for extension stage in GB
  type: boolean?
  inputBinding:
    prefix: --memory-limit
- id: in_no_unlink
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/diamond:2.0.9--hdcc8f71_0
cwlVersion: v1.1
baseCommand:
- diamond
