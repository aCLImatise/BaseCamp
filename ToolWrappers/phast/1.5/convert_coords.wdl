...
task ConvertCoords {
  input {
    ...
    Int? index_coordinates_asdefined
  ...
  command <<<
    convert_coords \
      ...
      ~{if defined(index_coordinates_asdefined) then ("-s " +  '"' + index_coordinates_asdefined + '"') else ""} \
