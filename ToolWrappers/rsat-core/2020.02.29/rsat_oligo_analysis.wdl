...
task RsatOligoanalysis {
  input {
    ...
    String i_publichtmldatasaccharomycescerevisiaegenomecontigstxt
  ...
  command <<<
    rsat oligo_analysis \
      ...
      ~{i_publichtmldatasaccharomycescerevisiaegenomecontigstxt} \
      ~{dyad_analysis} \
      ~{count_words} \
  ...
  parameter_meta {
    ...
    i_publichtmldatasaccharomycescerevisiaegenomecontigstxt: "-i /public_html/data/Saccharomyces_cerevisiae/genome/contigs.txt "
