...
id: perlbug.cwl
inputs:
- id: in_include_verbose_configuration
...
- id: in_address_send_report
  doc: Address to send the report to. Defaults to 'perlbug@perl.org'.
  type: boolean?
  inputBinding:
    prefix: -a
- id: in_address_send_copy
  doc: Address to send copy of report to. Defaults to 'conda@5b5b05c2e5c2.(none)'.
  type: boolean?
  inputBinding:
    prefix: -c
