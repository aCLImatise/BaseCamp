...
task Corelist {
  input {
    Boolean? lists_versions_incase
    Boolean? finds_first_version
    Boolean? diff
    Boolean? man
    Boolean? lists_perl_release
    Boolean? lists_when_were
    Boolean? feature
    Boolean? upstream
    String? feature_name
  }
  command <<<
    corelist \
      ~{feature_name} \
      ~{if (lists_versions_incase) then "-a" else ""} \
      ~{if (finds_first_version) then "-d" else ""} \
      ~{if (diff) then "--diff" else ""} \
      ~{if (man) then "-man" else ""} \
      ~{if (lists_perl_release) then "-v" else ""} \
      ~{if (lists_when_were) then "-r" else ""} \
  ...
  parameter_meta {
    lists_versions_incase: "lists all versions of the given module (or the matching modules, in\\ncase you used a module regexp) in the perls Module::CoreList knows\\nabout.\\ncorelist -a Unicode\\nUnicode was first released with perl v5.6.2\\nv5.6.2     3.0.1\\nv5.8.0     3.2.0\\nv5.8.1     4.0.0\\nv5.8.2     4.0.0\\nv5.8.3     4.0.0\\nv5.8.4     4.0.1\\nv5.8.5     4.0.1\\nv5.8.6     4.0.1\\nv5.8.7     4.1.0\\nv5.8.8     4.1.0\\nv5.8.9     5.1.0\\nv5.9.0     4.0.0\\nv5.9.1     4.0.0\\nv5.9.2     4.0.1\\nv5.9.3     4.1.0\\nv5.9.4     4.1.0\\nv5.9.5     5.0.0\\nv5.10.0    5.0.0\\nv5.10.1    5.1.0\\nv5.11.0    5.1.0\\nv5.11.1    5.1.0\\nv5.11.2    5.1.0\\nv5.11.3    5.2.0\\nv5.11.4    5.2.0\\nv5.11.5    5.2.0\\nv5.12.0    5.2.0\\nv5.12.1    5.2.0\\nv5.12.2    5.2.0\\nv5.12.3    5.2.0\\nv5.12.4    5.2.0\\nv5.13.0    5.2.0\\nv5.13.1    5.2.0\\nv5.13.2    5.2.0\\nv5.13.3    5.2.0\\nv5.13.4    5.2.0\\nv5.13.5    5.2.0\\nv5.13.6    5.2.0\\nv5.13.7    6.0.0\\nv5.13.8    6.0.0\\nv5.13.9    6.0.0\\nv5.13.10   6.0.0\\nv5.13.11   6.0.0\\nv5.14.0    6.0.0\\nv5.14.1    6.0.0\\nv5.15.0    6.0.0"
