...
task Encguess {
  input {
    ...
    Boolean? output_list_acceptable
  ...
  command <<<
    encguess \
      ...
      ~{if (output_list_acceptable) then "-S" else ""} \
  ...
  parameter_meta {
    ...
    output_list_acceptable: "output a list of all acceptable encoding types that can be used with\\nthe -s param"
