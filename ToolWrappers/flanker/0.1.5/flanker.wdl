...
task Flanker {
  ...
  command <<<
    flanker \
      ...
      ~{if (closest_match) then "--closest_match" else ""} \
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/flanker:0.1.5--py_0"
  }
  parameter_meta {
    ...
    closest_match: "Find closest match to query (default: False)"
    ...
    km_er_length: "kmer length for Mash (default: 21)"
    sketch_size: "sketch size for mash (default: 1000)\\n"
  }
  output {
