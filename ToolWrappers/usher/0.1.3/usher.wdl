...
task Usher {
  input {
    ...
    Boolean? collapse_internal_nodes
  ...
  command <<<
    usher \
      ...
      ~{if (collapse_internal_nodes) then "-c" else ""} \
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/usher:0.1.3--hfcd16c1_0"
  }
  parameter_meta {
