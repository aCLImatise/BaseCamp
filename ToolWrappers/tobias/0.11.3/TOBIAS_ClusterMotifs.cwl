...
- id: in_one_more_motif
  ...
  inputBinding:
    prefix: -m
- id: in_threshold
  doc: Clustering threshold (Default = 0.3)
  type: boolean?
  inputBinding:
    prefix: --threshold
- id: in_dist_method
...
- id: in_clust_method
  ...
  inputBinding:
    prefix: --clust_method
- id: in_cons_format
  doc: "Format of consensus motif file [‘transfac’,\n‘meme’, ‘pwm’, 'pfm', 'jaspar']\
    \ (Default: jaspar)"
  type: boolean?
  inputBinding:
    prefix: --cons_format
- id: in_prefix
  doc: "Output prefix (default: 'motif_comparison')"
  type: boolean?
  inputBinding:
    prefix: --prefix
- id: in_outdir
  doc: "Output directory (default: 'clustermotifs_output')"
  type: Directory?
  inputBinding:
    prefix: --outdir
- id: in_verbosity
