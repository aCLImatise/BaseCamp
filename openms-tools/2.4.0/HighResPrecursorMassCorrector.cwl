...
- id: out
  ...
  inputBinding:
    prefix: -out
- id: feature
  doc: ":in <file>                          Features used to correct precursor masses.\
    \ (valid formats: 'featureXML')"
  type: boolean
  inputBinding:
    prefix: -feature
- id: feature
  doc: ":mz_tolerance <num>                 The precursor mass tolerance. Used to\
    \ determine matching to feature mass traces. (default: '5')"
  type: boolean
  inputBinding:
    prefix: -feature
- id: feature
  ...
  inputBinding:
    prefix: -feature
- id: feature
  doc: ":rt_tolerance <num>                 Additional retention time tolerance added\
    \ to feature boundaries. (default: '0')"
  type: boolean
  inputBinding:
    prefix: -feature
- id: feature
  ...
  inputBinding:
    prefix: -feature
- id: feature
  doc: :keep_original                      Make a copy of the precursor and MS2 (true)
    or discard the original (false).
  type: boolean
  inputBinding:
    prefix: -feature
- id: feature
  ...
  inputBinding:
    prefix: -feature
- id: nearest_peak
  doc: ":mz_tolerance <num>            The precursor mass tolerance to find the closest\
    \ MS1 peak. (Disable method by setting value to 0.0) (default: '0')"
  type: boolean
  inputBinding:
    prefix: -nearest_peak
- id: nearest_peak
