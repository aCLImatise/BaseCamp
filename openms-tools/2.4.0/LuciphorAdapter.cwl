...
- doc: "List the amino acids to be searched for and their mass modifications, specified\
    ...
    \ (S) Phosp ho (T) Phospho (Y)]' valid: '15N-oxobutanoic (N-term C)', '2-dimethylsuccinyl\
    \ (C)', '2-monomethylsuccinyl (C)', '2-nitrobenzyl (Y)', '2-succinyl (C)', '2HPG\
    \ (R)', '3-deoxygl ucosone (R)', '3-phosphoglyceryl (K)', '3sulfo (N-term)', '4-ONE\
    ...
    \ (S)', 'Acetyl:2H(3) (T)', 'Acetyl:2H(3) (Y)', 'Acety ldeoxyhypusine (K)', 'Acetylhypusine\
    ...
    \ (T)', 'AEC-MAEC:2H(4) (S)', 'AEC-MAEC:2H(4) (T)', 'AHA-Alkyne (M)', 'AHA-A lkyne-KDDDD\
    \ (M)', 'AHA-SS (M)', 'AHA-SS_CAM (M)', 'Ahx2+Hsl (C-term)', 'Ala->Arg (A)', 'Ala->Asn\
    \ (A)', 'Ala->Asp (A)', 'Ala->Cys (A)', 'Ala->Gln (A)', 'Ala->Glu (A)', 'Ala->\
    \ ... DSS-NH2 (K)', 'Xlink:DST (K)', 'Xlink:DTSSP (K)', 'Xlink:EGS (K)', 'Xlink:EGScleaved\
    \ (K)', 'Xlink:SMCC (C)', 'Xlink:SSD (K)', 'ZGB (K)', 'ZGB (N-term)')"
