...
- doc: "*                    Output file  (valid formats: 'idXML')"
  ...
  inputBinding:
    prefix: -out
  type: File
- doc: '*     The "PepNovo" executable of the PepNovo installation'
...
- doc: "Fixed modifications, specified using Unimod (www.unimod.org) terms, e.g. 'Carbamidomethyl\
    ...
    \ (N-t erm C)', '2-dimethylsuccinyl (C)', '2-monomethylsuccinyl (C)', '2-nitrobenzyl\
    \ (Y)', '2-succinyl (C)', '2HPG (R)', '3-deoxyglucosone (R)', '3-phosphoglyceryl\
    \ (K)', '3sulfo (N-te rm)', '4-ONE (C)', '4-ONE (H)', '4-ONE (K)', '4-ONE+Delta:H(-2)O(-1)\
    ...
    \ (M)', 'AHA-Alkyne-KDDDD (M)', 'AHA-SS (M)', 'AHA-SS_CAM (M)', 'Ahx2+Hsl (C-t\
    \ erm)', 'Ala->Arg (A)', 'Ala->Asn (A)', 'Ala->Asp (A)', 'Ala->Cys (A)', 'Ala->Gln\
    \ (A)', 'Ala->Glu (A)', 'Ala->Gly (A)', 'Ala->His (A)', 'Ala->Lys (A)', 'Ala->Met\
    \ (A)', 'Ala->Phe ... 'Xlink:DSS-NH2 (K)', 'Xlink:DST (K)', 'Xlink:DTSSP (K)',\
    \ 'Xlink:EGS (K)', 'Xlink:EGScleaved (K)', 'Xlink:SMCC (C)', 'Xlink:SSD (K)',\
    \ 'ZGB (K)', 'ZGB (N-term)')"
...
- doc: "Variable modifications, specified using Unimod (www.unimod.org) terms, e.g.\
    ...
    \ 'Ahx2+Hsl (C-t erm)', 'Ala->Arg (A)', 'Ala->Asn (A)', 'Ala->Asp (A)', 'Ala->Cys\
    \ (A)', 'Ala->Gln (A)', 'Ala->Glu (A)', 'Ala->Gly (A)', 'Ala->His (A)', 'Ala->Lys\
    \ (A)', 'Ala->Met (A)', 'Ala->Phe ... 'Xlink:DSS-NH2 (K)', 'Xlink:DST (K)', 'Xlink:DTSSP\
