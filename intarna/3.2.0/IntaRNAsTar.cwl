...
id: ../../../../home/ubuntu/BiocondaCli/IntaRNAsTar.cwl
inputs:
- id: q
...
- id: arg_h_prediction
  ...
  inputBinding:
    prefix: -m
- id: model
  doc: "(=X)              interaction model :  'S' = single-site, minimum-free-energy\
...
- id: acc
  ...
  inputBinding:
    prefix: --acc
- id: int_len_max
  doc: '(=60)         interaction site : maximal window size to be  considered for
  ...
  inputBinding:
    prefix: --intLenMax
- id: int_loop_max
  doc: '(=8)         interaction site : maximal number of unpaired  bases between
...
- id: out_sep
  ...
  inputBinding:
    prefix: --outSep
- id: out_mode
  doc: "(=C)            output mode : 'N' normal output (ASCII char + energy), 'D'\
...
- id: n
  ...
  inputBinding:
    prefix: -n
- id: out_overlap
  doc: "(=Q)         suboptimal output : interactions can overlap  'N' in none of\
