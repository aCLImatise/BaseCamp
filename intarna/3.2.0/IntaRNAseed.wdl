...
task IntaRNAseed {
  ...
  parameter_meta {
    ...
    arg_s_prediction: "[ --mode ] arg (=S)        prediction mode :  'H' = heuristic (fast and low memory),  'M' = exact (slow),  'S' = seed-only"
