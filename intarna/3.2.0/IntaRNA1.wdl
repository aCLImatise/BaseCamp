...
task IntaRNA1 {
  ...
  parameter_meta {
    ...
    seed_bp: "(=6)             number of inter-molecular base pairs within the\\nseed region (arg in range [2,20])"
