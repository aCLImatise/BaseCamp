...
task Porechop {
  ...
  command <<<
    porechop \
      ...
      ~{true="--barcode_stats_csv" false="" barcodeBarcodeStatsCsv} \
      ...
      ~{true="--barcode_labels" false="" barcodeBarcodeLabels} \
      ~{true="--extended_labels" false="" extendedExtendedLabels} \
      ...
      ~{if defined(customCustomBarcodes) then ("--custom_barcodes " +  '"' + customCustomBarcodes + '"') else ""} \
