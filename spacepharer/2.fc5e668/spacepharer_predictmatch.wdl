...
task SpacepharerPredictmatch {
  ...
  parameter_meta {
    ...
    kmer_length_automatically: "k-mer length (0: automatically set to optimum) [6]"
    ...
    add_backtrace_string: "Add backtrace string (convert to alignments with mmseqs convertalis module) [1]"
    ...
    list_matches_evalue: "List matches below this E-value (range 0.0-inf) [200.000]"
    ...
    aggregation_mode: "Combined P-values computed from 0: multi-hit, 1: minimum of all P-values, 2: product-of-P-values, 3: truncated product [3]"
    ...
    report_pam: "Report protospacer adjacent motifs up and downstream of hits [0,1] [1]"
