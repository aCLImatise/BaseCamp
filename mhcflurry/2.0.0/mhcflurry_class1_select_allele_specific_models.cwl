...
- id: in_unselected_accuracy_scorer
  doc: ''
  type: string
  inputBinding:
    prefix: --unselected-accuracy-scorer
- id: in_unselected_accuracy_scorer_num_samples
  doc: ''
  type: long
  inputBinding:
    prefix: --unselected-accuracy-scorer-num-samples
- id: in_unselected_accuracy_percentile_threshold
  doc: ''
  type: string
  inputBinding:
    prefix: --unselected-accuracy-percentile-threshold
- id: in_alleles_select_models
