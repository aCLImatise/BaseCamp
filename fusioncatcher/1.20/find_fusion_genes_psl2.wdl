...
task FindFusionGenesPsl2.py {
  ...
  parameter_meta {
    ...
    threshold_matches: "The threshold for matches above which the contigs which align are taking into consideration. Default is '0.75'."
    mismatches: "All alignments having strictly more mismatches will be removed. Default is '1000'."
    threshold_overlap: "The threshold for the minimum length of the read overlap over the fusion point (i.e. overhang/anchor). Default is '30'."
