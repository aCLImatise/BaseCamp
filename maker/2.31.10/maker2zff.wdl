...
task Maker2zff {
  ...
  command <<<
    maker2zff \
      ...
      ~{if defined(fraction_overlap_any) then ("-o " +  '"' + fraction_overlap_any + '"') else ""} \
  ...
  parameter_meta {
    ...
    fraction_overlap_any: "The fraction of exons that overlap any evidence (EST or Protein), default 0.5"
