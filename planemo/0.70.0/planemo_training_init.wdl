...
task PlanemoTrainingInit {
  input {
    ...
    String topicTopicTitle
    String topicTopicSummary
    Boolean topicTopicTarget
    String tutorialTutorialName
    String tutorialTutorialTitle
    Boolean handsHandsOn
    Boolean slidesSlides
    File workflowWorkflow
    String galaxyGalaxyUrl
    String galaxyGalaxyApiKey
    String workflowWorkflowId
  ...
  command <<<
    planemo training_init \
      ...
      ~{if defined(topicTopicTitle) then ("--topic_title " +  '"' + topicTopicTitle + '"') else ""} \
      ~{if defined(topicTopicSummary) then ("--topic_summary " +  '"' + topicTopicSummary + '"') else ""} \
      ~{true="--topic_target" false="" topicTopicTarget} \
      ~{if defined(tutorialTutorialName) then ("--tutorial_name " +  '"' + tutorialTutorialName + '"') else ""} \
      ~{if defined(tutorialTutorialTitle) then ("--tutorial_title " +  '"' + tutorialTutorialTitle + '"') else ""} \
      ~{true="--hands_on" false="" handsHandsOn} \
      ~{true="--slides" false="" slidesSlides} \
      ...
      ~{if defined(galaxyGalaxyApiKey) then ("--galaxy_api_key " +  '"' + galaxyGalaxyApiKey + '"') else ""} \
      ~{if defined(workflowWorkflowId) then ("--workflow_id " +  '"' + workflowWorkflowId + '"') else ""} \
      ...
      ~{true="--daemon" false="" daemonDaemon} \
      ~{if defined(pidPidFile) then ("--pid_file " +  '"' + pidPidFile + '"') else ""} \
