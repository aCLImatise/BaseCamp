...
task HtsOverlapper {
  ...
  command <<<
    hts_Overlapper \
      ...
      ~{true="-X" false="" overlapping_end_read}
  >>>
  parameter_meta {
    ...
    overlapping_end_read: "[ --force-pairs ]                  after overlapping a paired end read,  split reads in half to output pairs."
  }
}