...
id: ../../../../home/ubuntu/BiocondaCli/RNAinverse.cwl
inputs:
- id: detailed_help
...
- id: function
  ...
  inputBinding:
    prefix: --function
- id: final
  doc: In combination with -Fp stop search when sequence  is found with E(s)-F is
    smaller than final,  where F=-kT*ln(Q).
  type: double
  inputBinding:
    prefix: --final
- id: temp
