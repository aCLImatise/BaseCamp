...
task ErneMap {
  ...
  command <<<
    erne-map \
      ...
      ~{if defined(errorsErrorsPerBase) then ("--errors-per-base " +  '"' + errorsErrorsPerBase + '"') else ""} \
      ...
      ~{if defined(printPrintAtMost) then ("--print-at-most " +  '"' + printPrintAtMost + '"') else ""} \
