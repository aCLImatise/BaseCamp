...
task BiscuitAlign {
  ...
  parameter_meta {
    ...
    bsw_strand_bsc: "1: BSW strand; 3: BSC strand; 0 (default): both; (libraries\\ntargeting either BSW or BSC are unseen so far!)"
    ...
    look_internal_longer: "look for internal seeds inside a seed longer than\\n{-k} * FLOAT [1.5]"
    ...
    perform_most_int: "perform at most INT rounds of mate rescues for a read [50]"
    ...
    insert_str_header: "insert STR to header if it starts with @; or insert lines\\nin FILE [null]"
