...
task CruxAdapter {
  ...
  parameter_meta {
    ...
    enzyme: "The enzyme used for peptide digestion. (default: 'trypsin' valid: 'custom-enzyme', 'trypsin', 'lys-c', 'lys-n', 'asp-n', 'arg-c', 'chymotrypsin', 'iodosobenzoate', 'staph-protease', 'proline-endopeptidase', 'glu-c', 'pepsin-a', 'elastase-trypsin-chymotrypsin', 'trypsin/p', 'cyanogen-bromide', 'clostripain', 'no-enzyme', 'elastase')"
