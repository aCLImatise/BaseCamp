...
task PrecursorMassCorrector {
  ...
  parameter_meta {
    ...
    precursor_mass_tolerance: "Maximal deviation in Th which is acceptable to be corrected; this value should be set to the instruments selection window. (default: '1.5' min: '0.0')"
