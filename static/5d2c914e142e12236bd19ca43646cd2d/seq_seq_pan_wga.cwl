...
- id: in_ku_bernet_es
  ...
  inputBinding:
    prefix: --kubernetes
- id: in_ku_bernet_es_env
  doc: "Specify environment variables to pass to the\nkubernetes job."
  type: string[]
  inputBinding:
...
- id: in_container_image
  doc: "Docker image to use, e.g., when submitting jobs to\nkubernetes. By default,\
    ...
    \ currently running Snakemake instance.\nNote that overwriting this value is up\
