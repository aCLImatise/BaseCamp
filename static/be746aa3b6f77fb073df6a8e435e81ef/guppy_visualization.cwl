...
- id: in_fpd
  ...
  inputBinding:
    position: 4
- id: in_indep_c
  doc: calculates the independent contrasts of pqueries
  type: string
  inputBinding:
    position: 5
- id: in_kr
...
- id: in_kr_heat
  ...
  inputBinding:
    position: 7
- id: in_lpc_a
  doc: performs length principal components
  type: string
  inputBinding:
    position: 8
- id: in_mcl
  doc: cluster pqueries using Markov clustering via MCL
  type: string
  inputBinding:
    position: 9
- id: in_pm_lpc_a
  doc: performs poor-man's length principal components
  type: string
  inputBinding:
    position: 10
- id: in_rare_fact
...
- id: in_mft
  ...
  inputBinding:
    position: 26
- id: in_o_graph
  doc: finds the overlap graph of one or more pqueries
  type: string
  inputBinding:
    position: 27
- id: in_placemat
  doc: prints out a pairwise distance matrix between placements
  type: string
  inputBinding:
    position: 28
- id: in_rare_fy
