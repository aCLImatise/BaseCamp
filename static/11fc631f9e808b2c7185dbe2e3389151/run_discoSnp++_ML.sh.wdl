...
task RunDiscoSnpMLsh {
  ...
  parameter_meta {
    ...
    graph: "Reuse a previously created graph (.h5 file) with same prefix and same k and c parameters (here, contrary to discoSnp++.sh, no graph file can be specified)."
