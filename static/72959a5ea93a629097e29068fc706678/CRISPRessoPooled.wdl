...
task CRISPRessoPooled {
  input {
    ...
    Boolean debugDebug
    Boolean noNoRerun
    String ampliconsAmpliconsFile
    String geneGeneAnnotations
    String nNProcesses
    String bowtie2Bowtie2Index
    String bowtie2Bowtie2OptionsString
  ...
  command <<<
    CRISPRessoPooled \
      ...
      ~{if defined(ampliconsAmpliconsFile) then ("--amplicons_file " +  '"' + ampliconsAmpliconsFile + '"') else ""} \
      ...
      ~{if defined(bowtie2Bowtie2Index) then ("--bowtie2_index " +  '"' + bowtie2Bowtie2Index + '"') else ""} \
      ~{if defined(bowtie2Bowtie2OptionsString) then ("--bowtie2_options_string " +  '"' + bowtie2Bowtie2OptionsString + '"') else ""} \
