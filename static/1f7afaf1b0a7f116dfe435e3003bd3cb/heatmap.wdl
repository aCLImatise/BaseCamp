...
task Heatmap.py {
  ...
  >>>
  parameter_meta {
    secondary_model_tar: "secondary model tar if combining the prediction of two different phenotype collections into one heatmap"
    ...
    sample_f: "restrict phenotype predictions to the sample found in <sample_file>"
