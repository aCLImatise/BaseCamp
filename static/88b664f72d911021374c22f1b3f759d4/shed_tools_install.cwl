...
- id: in_latest
  doc: "Will override the revisions in the tools file and\nalways install the latest\
    \ revision."
  type: boolean?
  inputBinding:
    prefix: --latest
