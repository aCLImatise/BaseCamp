...
- id: in_ipl
  ...
  inputBinding:
    prefix: -ipl
- id: in_branching
  doc: "(afc, action, chb) default: afc\nbranching variants"
  type: boolean?
  inputBinding:
    prefix: -branching
- id: in_decay
...
- id: in_restart
  ...
  inputBinding:
    prefix: -restart
- id: in_restart_base
  doc: "(double) default: 1.3\nbase for geometric restart sequence"
  type: boolean?
  inputBinding:
    prefix: -restart-base
- id: in_restart_scale
  doc: "(unsigned int) default: 5000\nscale factor for restart sequence"
  type: boolean?
  inputBinding:
...
- id: in_verbose
  ...
  inputBinding:
    prefix: -verbose
- id: in_probes
  doc: "(unsigned int) default: 50\nhow many probes to perform"
  type: boolean?
  inputBinding:
    prefix: -probes
- id: in_fail_probe
  doc: "(unsigned int) default: 10000\nfailure limit per probe"
  type: boolean?
  inputBinding:
    prefix: -fail-probe
- id: in_time_probe
  doc: "(unsigned int) default: 30000\ntime-out for probing (in milliseconds)"
  type: boolean?
  inputBinding:
    prefix: -time-probe
- id: in_time_adjust
