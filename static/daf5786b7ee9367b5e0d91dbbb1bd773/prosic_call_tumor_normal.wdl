...
task ProsicCallTumorNormal {
  ...
  command <<<
    prosic call-tumor-normal \
      ...
      ~{true="--flat-priors" false="" flat_priors} \
  ...
  parameter_meta {
    ...
    deletion_factor: "Factor of deletion mutation rate relative to SNV mutation rate (0.03 according to Hodkinson et al. Nature Reviews Genetics 2011). [default: 0.03]"
    eff_mut: "Effective SNV mutation rate of tumor sample (should be estimated from somatic SNVs). [default: 2000.0]"
    ...
    insertion_factor: "Factor of insertion mutation rate relative to SNV mutation rate (0.01 according to Hodkinson et al. Nature Reviews Genetics 2011). [default: 0.01]"
    ...
    spurious_i_size_rate: "Rate of wrongly reported insert size abberations (should be set depending on mapper, BWA: 0.01332338, LASER: 0.05922201). [default: 0.0]"
