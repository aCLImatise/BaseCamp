...
- id: in_ipl
  ...
  inputBinding:
    prefix: -ipl
- id: in_branching
  doc: "(none, size, sizedeg, sizeafc, afc) default: sizeafc\nbranching variants\n\
    none: none\nsize: min size\nsizedeg: min size over degree\nsizeafc: min size over\
    \ afc\nafc: maximum afc"
  type: boolean?
  inputBinding:
    prefix: -branching
