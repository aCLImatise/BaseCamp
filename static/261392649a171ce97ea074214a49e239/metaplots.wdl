...
task Metaplots {
  input {
    ...
    Int? minimum_length
    Int? maximum_length
    String? p_value_one_cut_off
    String? p_value_two_cut_off
  ...
  parameter_meta {
    ...
    p_value_one_cut_off: "pvalue cutoff of frame0 > frame2 for automatically predicting P-site location, default 0.001"
    p_value_two_cut_off: "pvalue cutoff of frame0 > frame2 for automatically predicting P-site location, default 0.001"
    frame_zero_percent: "proportion threshold of the number of reads in frame0, defined by f0/(f0+f1+f2), default 0.65"
