...
task OpenSwathChromatogramExtractor {
  ...
  parameter_meta {
    ...
    rt_window: "Extraction window in RT dimension (-1 means extract over the whole range). This is the full window size, e.g. a value of 1000 seconds would extract 500 seconds on either side. (default: '-1')"
    ...
    mz_window: "Extraction window in m/z dimension (in Thomson, to use ppm see -ppm flag). This is the full window size, e.g. 100 ppm would extract 50 ppm on either side. (default: '0.05' min: '0')"
