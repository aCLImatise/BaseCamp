...
inputs:
- id: in_in
  doc: Input sequence file in FASTA format. Can be an assembled genome or transcriptome
    (DNA), or protein sequences from an annotated gene set.
  type: File?
  inputBinding:
    prefix: --in
- id: in_out
...
- id: in_augustus_parameters
  doc: "\"--PARAM1=VALUE1,--PARAM2=VALUE2\"\nPass additional arguments to Augustus.\
    \ All arguments should be contained within a single pair of quotation marks, separated\
    \ by commas."
  type: boolean?
  inputBinding:
...
- id: in_meta_e_uk_parameters
  doc: "\"--PARAM1=VALUE1,--PARAM2=VALUE2\"\nPass additional arguments to Metaeuk\
    \ for the first run. All arguments should be contained within a single pair of\
...
- id: in_meta_e_uk_rerun_parameters
  doc: "\"--PARAM1=VALUE1,--PARAM2=VALUE2\"\nPass additional arguments to Metaeuk\
    \ for the second run. All arguments should be contained within a single pair of\
    \ quotation marks, separated by commas."
  type: boolean?
  inputBinding:
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/busco:5.1.2--py_0
cwlVersion: v1.1
baseCommand:
- busco
