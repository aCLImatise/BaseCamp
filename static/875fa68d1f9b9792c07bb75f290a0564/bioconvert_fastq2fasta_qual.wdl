...
task BioconvertFastq2fastaQual {
  input {
    Boolean? force
    String? verbosity
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{python}], --method [{python}] The method to use to do the conversion. (default: python)"
