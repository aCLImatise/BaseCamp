...
task HaphpipeCliquesnv {
  input {
    ...
    String? outdir
    String? jar_dir
    String? o_two_two_min
    String? o_two_two_min_freq
    Boolean? print_log
    String? merging
    String? fast_a_format
    String? output_start
    String? output_end
    Boolean? quiet
    String? log_file
  ...
  parameter_meta {
    ...
    jar_dir: "Path to clique-snv.jar (existing) (Default: current directory) (default: .)"
    o_two_two_min: "minimum threshold for O22 value"
    o_two_two_min_freq: "minimum threshold for O22 frequency relative to read coverage"
    print_log: "Print log data to console (default: False)"
    merging: "Cliques merging algorithm: accurate or fast"
    fast_a_format: "Fasta defline format: short or extended, add number at end to adjust precision of frequency (default: extended4)"
