...
- id: in_enzyme
  doc: "The enzyme used for peptide digestion. (default: 'trypsin' valid: 'custom-enzyme',\
    \ 'cyanogen-bromide', 'clostripain', 'elastase-trypsin-chymotrypsin', 'trypsin',\
    \ 'staph-protease', 'proline-endopeptidase', 'chymotrypsin', 'trypsin/p', 'asp-n',\
    \ 'glu-c', 'pepsin-a', 'elastase', 'iodosobenzoate', 'no-enzyme', 'arg-c', 'lys-c',\
    \ 'lys-n')"
  type: string?
  inputBinding:
    prefix: -enzyme
