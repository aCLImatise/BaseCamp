...
task SpectraSTSearchAdapter {
  ...
  parameter_meta {
    ...
    output_files: "[ <OutputFileName2> ... <OutputFileNameN> ]*       Output files. Make sure to specify one output file for each input file (valid formats: 'txt', 'tsv', 'pep.xml', 'xml', 'pepXML', 'html')"
