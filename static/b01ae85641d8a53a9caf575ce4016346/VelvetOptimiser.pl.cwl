...
- id: in_amosfile_turn_velvet
  ...
  inputBinding:
    prefix: --a
- id: in_velvetgoptionss_velvetg_options
...
- id: out_dirfinals_name_put
  doc: "|dir_final=s The name of the directory to put the final output into. (default\
    \ '.')."
  type: Directory?
  outputBinding:
    glob: $(inputs.in_dirfinals_name_put)
hints: []
cwlVersion: v1.1
baseCommand:
- VelvetOptimiser.pl
