...
inputs:
- id: in_bin_folder
  doc: Path to directory containing bins.
  type: boolean?
  inputBinding:
    prefix: --bin_folder
...
- id: in_bin_suffix
  doc: 'Suffix of bins in bin folder (default: .fna).'
  type: boolean?
  inputBinding:
    prefix: --bin_suffix
- id: in_range
  doc: 'r parameter [0-49] (default: 5).'
  type: boolean?
  inputBinding:
    prefix: --range
- id: in_out_prefix
  doc: 'Prefix for output files (default: ./out.BAT).'
  type: boolean?
  inputBinding:
    prefix: --out_prefix
- id: in_proteins_fast_a
  doc: "Path to concatenated predicted proteins fasta file\ngenerated during an earlier\
    \ run of BAT on the same\nbins. If supplied, BAT will skip the protein\nprediction\
    \ step."
  type: boolean?
  inputBinding:
