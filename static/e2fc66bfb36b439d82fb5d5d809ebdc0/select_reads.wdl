...
task Selectreads {
  input {
    ...
    File? specify_file_containing_list_print
    File? specify_file_containing_list_eids
  ...
  command <<<
    select_reads \
      ...
      ~{if defined(specify_file_containing_list_print) then ("-i " +  '"' + specify_file_containing_list_print + '"') else ""} \
      ~{if defined(specify_file_containing_list_eids) then ("-I " +  '"' + specify_file_containing_list_eids + '"') else ""} \
  ...
  parameter_meta {
    ...
    specify_file_containing_list_print: "Specify file containing list of iid's to print"
    specify_file_containing_list_eids: "Specify file containing list of eid's to print"
