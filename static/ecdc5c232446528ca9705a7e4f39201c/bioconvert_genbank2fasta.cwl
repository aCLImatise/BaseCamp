...
id: ../../../../home/ubuntu/BiocondaCli/bioconvert_genbank2fasta.cwl
inputs:
- id: force
...
- id: method_use_conversion
  doc: '[{biopython,python,squizz}], --method [{biopython,python,squizz}] The method
    to use to do the conversion. (default: biopython)'
  type: boolean
  inputBinding:
    prefix: -m
- id: show_methods
