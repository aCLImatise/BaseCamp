...
inputs:
- id: in_bam_file
  doc: "Sorted and indexed BAM file to analyze. (default:\nNone)"
  type: File?
  inputBinding:
    prefix: --bam-file
- id: in_contig_name
  doc: 'The name of a single contig (default: None)'
  type: string?
  inputBinding:
    prefix: --contig-name
...
- id: in_collection_txt
  doc: "Provide a collection text file. The first column\nshould be contig names and\
    ...
    \ anvi-export-collection. (default:\nNone)"
  type: File?
  inputBinding:
...
- id: in_file
  ...
  inputBinding:
    position: 0
- id: in_coverages_txt
  doc: '🍺 More on `anvi-script-get-coverage-from-bam`:'
  type: string
  inputBinding:
    position: 0
outputs:
