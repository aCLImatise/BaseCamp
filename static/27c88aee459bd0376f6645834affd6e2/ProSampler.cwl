...
- id: in_name_input_file
  ...
  inputBinding:
    prefix: -i
- id: in_name_background_generate
...
- id: in_prefix_names_output
  ...
  inputBinding:
    prefix: -o
- id: in_number_motifs_output
  doc: ': Number of motifs to be output (default: All)'
  type: boolean
  inputBinding:
    prefix: -m
- id: in_number_find_default
...
- id: in_cutoff_extend_motifsdefault
  ...
  inputBinding:
    prefix: -z
- id: in_cutoff_construct_default
