...
- id: include_both
  ...
  inputBinding:
    prefix: --include_both
- id: extend_five
  doc: Extend the region of interaction in the target to  some residues on the 5'
    side
  type: long
  inputBinding:
    prefix: --extend5
- id: extend_three
  doc: Extend the region of interaction in the target to  some residues on the 3'
    side
  type: long
  inputBinding:
    prefix: --extend3
