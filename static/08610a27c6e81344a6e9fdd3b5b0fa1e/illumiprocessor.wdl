...
task Illumiprocessor {
  input {
    ...
    Boolean? no_merge
    String? cores
    String? r_one_pattern
    String? r_two_pattern
    Boolean? se
    String? phred
    String? log_path
    String? verbosity
  ...
  >>>
  parameter_meta {
    input_directory_trim: "The input directory of raw reads to trim. (default: None)"
    output_directory_create: "The output directory of clean reads to create. (default: None)"
    config: "A configuration file containing the tag:sample mapping and renaming options. (default: None)"
    trim_mo_matic: "The path to the trimmomatic-0.XX.jar file. (default: /tmp/tmp0e300ahp/bin/trimmomatic)"
    min_len: "The minimum length of reads to keep. (default: 40)"
    no_merge: "When trimming PE reads, do not merge singleton files. (default: False)"
    cores: "Number of compute cores to use. (default: 1)"
    r_one_pattern: "An optional regex pattern to find R1 reads. (default: None)"
    r_two_pattern: "An optional regex pattern to find R2 reads. (default: None)"
