...
- id: in_if
  ...
  inputBinding:
    prefix: --if
- id: in_sf
  doc: "The name of the field containing reads (default:\nsequence_alignment)"
  type: string?
  inputBinding:
    prefix: --sf
- id: in_gf
  doc: "The name of the field containing germline sequences\n(default: germline_alignment)"
  type: string?
  inputBinding:
    prefix: --gf
- id: in_cf
  doc: "The name of the field containing containing sorted\nclone IDs (default: None)"
  type: string?
  inputBinding:
    prefix: --cf
- id: in_mf
