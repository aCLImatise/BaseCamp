...
task Cutadapt {
  ...
  parameter_meta {
    ...
    error_rate: "Maximum allowed error rate as value between 0 and 1\\n(no. of errors divided by length of matching region).\\nDefault: 0.1 (=10%)"
    no_indels: "Allow only mismatches in alignments. Default: allow\\nboth mismatches and indels"
    ...
    max_expected_errors: "Discard reads whose expected number of errors\\n(computed from quality values) exceeds ERRORS."
    ...
    discard_casa_va: "Discard reads that did not pass CASAVA filtering\\n(header has :Y:)."
