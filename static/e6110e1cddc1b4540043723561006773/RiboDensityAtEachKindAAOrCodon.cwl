...
id: RiboDensityAtEachKindAAOrCodon.cwl
inputs:
- id: in_bam_list_file
...
- id: in_upstream_position
  doc: "The left position (codon level) you want to\nchose.[upstream position]. default=none"
  type: string?
  inputBinding:
    prefix: --upstream_position
- id: in_downstream_position
  doc: "The right position (codon level) you want to\nchose.[downstream position].\
    \ default=none"
  type: string?
  inputBinding:
    prefix: --downstream_position
