...
id: ../../../../home/ubuntu/BiocondaCli/BETA_basic.cwl
inputs:
- id: peak_file
...
- id: genome
  ...
  inputBinding:
    prefix: --genome
- id: g_name_two
  doc: If this switch is on, gene or transcript IDs in files given through -e will
...
- id: method
  ...
  inputBinding:
    prefix: --method
- id: name
  doc: this argument is used as the prefix for the result files. If not set, 'NA'
