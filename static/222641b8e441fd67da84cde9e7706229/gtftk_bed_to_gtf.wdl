...
task GtftkBedToGtf {
  ...
  parameter_meta {
    input_file: "Path to the poor BED file to would like to behave as if it was a GTF. (default: <stdin>)"
    output_file: "Output file. (default: <stdout>)"
    ft_type: "The type of features you are trying to mimic... (default: transcript)"
    source: "The source of annotation. (default: Unknown)"
