...
- id: in_restrict_search_database
  doc: Restrict search of database to results of Entrez2 lookup [String]  Optional
  type: boolean?
  inputBinding:
    prefix: -u
...
- id: in_x_dropoff_value_final
  ...
  inputBinding:
    prefix: -Z
- id: in_rps_blast_search
  doc: "RPS Blast search [T/F]\ndefault = F"
  type: boolean?
  inputBinding:
    prefix: -R
...
- id: in_use_compositionbased_adjustments
  ...
  inputBinding:
    prefix: -C
- id: in_compute_smithwaterman_alignments
