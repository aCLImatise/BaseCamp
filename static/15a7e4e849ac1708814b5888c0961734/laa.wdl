...
task Laa {
  ...
  command <<<
    laa \
      ...
      ~{true="--clusterGuide" false="" cluster_guide} \
  ...
  parameter_meta {
    ...
    cluster_guide: "Path to a fasta file of sequences to use for guided clustering"
    ...
    max_reads: "Maximum number of input reads to cluster per barcode. [2000]"
