...
task PanphlanProfilingpy {
  ...
  parameter_meta {
    i_dna: "Input directory of panphlan_map.py results or text\\nfile with"
    ...
    i_rna: "RNA-seq: input directory of RNA mapping results\\nSAMPLE_RNA.csv.bz2"
    sample_pairs: "RNA-seq: list of DNA-RNA sequencing pairs from the\\nsame biological sample."
    rna_max_zeros: "Max accepted percent of zero coveraged gene-families\\n(default: <10 %)."
    rna_norm_percentile: "Percentile for normalizing RNA/DNA ratios"
    o_rna: "Write normalized gene-family transcription values\\n(RNA-seq)."
    ...
    pan_genome: "Path to pangenome tsv file\\n"
