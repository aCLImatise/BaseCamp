...
task Contree {
  ...
  parameter_meta {
    ...
    non_shared_tips: "print tip names not present in the other tree."
    give_tree_format: "[newick/nexus]         give tree format for output, nexus (nex or x for\\nshort) or newick (new or w for short), e.g\\n--output x. (default w)."
    robinson_foulds: "compute Robinson-Foulds metric between trees."
    rooted: "treat trees as rooted for --add_to_support and\\n--calculate_support."
