...
- id: in_length_difference_cutoff_default
  ...
  inputBinding:
    prefix: -s
- id: in_length_difference_cutoff_amino
...
- id: in_cy
  ...
  inputBinding:
    prefix: -cy
- id: in_ap
  doc: "alignment position constrains,  default 0, no constrain\nif set to 1, the\
    \ program will force sequences to align at beginings\nwhen set to 1, the program\
    \ only does +/+ alignment"
  type: boolean?
  inputBinding:
    prefix: -ap
