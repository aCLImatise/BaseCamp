...
task Kissreads2 {
  ...
  command <<<
    kissreads2 \
      ...
      ~{if (arg_size_k_used) then "-k" else ""} \
  ...
  parameter_meta {
    ...
    arg_radseq_option: "(0 arg) :    [Experimental] Radseq option, homogeneous read depth along the prediction"
    ...
    hamming: "(1 arg) :    Maximal hamming distance authorized while mapping  [default '1']"
    coverage_file: "(1 arg) :    File (.h5) generated by kissnp2, containing the coverage threshold per read set  [default '_removemeplease']"
    arg_size_k_used: "(1 arg) :    Size of k, used as minial overlap and kmer spanning read coherence  [default '31']"
