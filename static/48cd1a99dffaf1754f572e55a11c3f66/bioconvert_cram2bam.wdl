...
task BioconvertCram2bam {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{samtools}], --method [{samtools}] The method to use to do the conversion. (default: samtools)"
    show_methods: "A converter may have several methods (default: False)"
    threads: "threads to be used (default: 8)"
    reference: "the reference used (FASTA format). If not provided, prompt will appear (default: None)"
