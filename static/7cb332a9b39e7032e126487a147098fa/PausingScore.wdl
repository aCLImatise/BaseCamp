...
task PausingScore {
  ...
  command <<<
    PausingScore \
      ...
      ~{if defined(left_position) then ("--Left_position " +  '"' + left_position + '"') else ""} \
      ~{if defined(right_position) then ("--Right_position " +  '"' + right_position + '"') else ""} \
  ...
  parameter_meta {
    ...
    left_position: "Left position of the interesting region [codon level].\\ndefault=none"
    right_position: "Right position of the interesting region [codon\\nlevel]. default=none"
