...
task Nullarbor.pl {
  ...
  command <<<
    nullarbor.pl \
      ...
      ~{true="--prefill" false="" prefill} \
      ~{true="--link-cmd" false="" link_cmd} \
  ...
  parameter_meta {
    ...
    cpus: "Maximum number of CPUs to use in total (8)"
    ...
    conf: "Config file (/tmp/tmp33w_n1r_/bin/../conf/nullarbor.conf)"
