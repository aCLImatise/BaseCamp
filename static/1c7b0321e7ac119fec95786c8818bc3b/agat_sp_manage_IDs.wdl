...
task AgatSpManageIDs.pl {
  ...
  command <<<
    agat_sp_manage_IDs.pl \
      ...
      ~{true="--gap" false="" gap} \
      ~{true="--ensembl" false="" ensembl} \
      ~{true="--prefix" false="" prefix} \
      ~{true="--type_dependent" false="" type_dependent} \
      ~{true="--collective" false="" collective} \
      ~{true="--tair" false="" tair} \
      ~{true="--nb" false="" nb} \
  ...
  parameter_meta {
    ...
    tair: "Boolean - Tair like Output: NbV1Ch01 TAIR10 gene 5928 8737 . - . ID=AT1G01020 NbV1Ch01 TAIR10 mRNA 5928 8737 . - . ID=AT1G01020.1 NbV1Ch01 TAIR10 exon 5928 8737 . - . ID=AT1G01020.1-exon1"
    ...
    _output_file: ", --output , --out or --outfile String - Output GFF file. If no output file is specified, the output will be written to STDOUT."
  }
}