...
- id: in_hsp_method
  ...
  inputBinding:
    prefix: --hsp_method
- id: in_edge_exponent
  doc: "Setting for maximum parisomony hidden-state\nprediction. Specifies weighting\
    \ transition costs by\nthe inverse length of edge lengths. If 0, then edge\nlengths\
    \ do not influence predictions. Must be a non-\nnegative real-valued number (default:\
    \ 0)."
  type: long?
  inputBinding:
