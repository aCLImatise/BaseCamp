...
task BioconvertFastq2fasta {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{awk,awk_v2,biopython,mappy,mawk,mawk_v2,mawk_v3,perl,python_internal,readfq,sed,sed_v2,seqtk}], --method [{awk,awk_v2,biopython,mappy,mawk,mawk_v2,mawk_v3,perl,python_internal,readfq,sed,sed_v2,seqtk}] The method to use to do the conversion. (default: readfq)"
