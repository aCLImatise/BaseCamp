...
task OvStoreDump {
  ...
  parameter_meta {
    ...
    coverage: "[b[-e]]    one line per read, with some simple descriptive statistics on\\nthe number of overlaps for that read"
    ...
    width: "* for -picture, the width of the overlaps picture"
    scores: "* for -picture, also report the score used for correction"
