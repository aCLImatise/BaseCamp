...
- id: in_force_connected
  doc: /n    analyze clustering, make sure it induces cocos
  type: string?
  inputBinding:
    prefix: -force-connected
- id: in_check_connected
  doc: /n    analyze clustering, see whether it induces cocos
  type: string?
  inputBinding:
...
- id: in_write_limit
  ...
  inputBinding:
    prefix: --write-limit
- id: in_show_log
  doc: /n      send log to stdout
  type: string?
  inputBinding:
    prefix: -show-log
- id: in_discard_loops
  doc: /n    remove loops in input graphs if any
  type: string?
  inputBinding:
...
- id: in_quiet_level_logging
  ...
  inputBinding:
    prefix: -q
- id: in_analyze
  doc: /n       append performance/characteristics measures
  type: string?
  inputBinding:
    prefix: -analyze
- id: in_sort
...
- id: in_rigid_pruning_threshold
  ...
  inputBinding:
    prefix: -p
- id: in_inverted_rigid_threshold
  doc: (inverted) rigid pruning threshold (cf -z)
  type: long?
  inputBinding:
    prefix: -P
- id: in_recover_maximally_int
