...
- id: in_interface_dot
  doc: "--show-all-layers     When declared, this flag tells the interface to show\n\
    every additional layer even if there are no hits. By\ndefault, anvi'o doesn't\
    \ show layers if there are no\nhits for any of your items. (default: False)"
  type: string
  inputBinding:
    position: 0
- id: in_genome
