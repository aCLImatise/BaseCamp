...
task MassCalculator {
  ...
  command <<<
    MassCalculator \
      ...
      ~{true="-average_mass" false="" average_mass} \
  ...
  >>>
  parameter_meta {
    in: "Input file with peptide sequences and optionally charge numbers (mutually exclusive to 'in_seq') (valid formats: 'txt')"
    ...
    format: "Output format ('list': human-readable list, 'table': CSV-like table, 'mass_only': mass values only, 'mz_only': m/z values only) (default: 'list' valid: 'list', 'table', 'mass_only', 'mz_only')"
    average_mass: "Compute average (instead of monoisotopic) peptide masses"
    fragment_type: "For what type of sequence/fragment the mass should be computed (default: 'full' valid: 'full', 'internal', 'N-terminal', 'C-terminal', 'a-ion', 'b-ion', 'c-ion', 'x-ion', 'y-ion', 'z-ion')"
