...
task ClusterMassTraces {
  ...
  parameter_meta {
    ...
    max_rt_apex_difference: "Maximal difference of the apex in retention time (default: '5.0')"
    max_intensity_cut_off: "Maximal intensity to be added to a spectrum (default: '0.0')"
    add_precursor: "Add a precursor mass (default: '0.0')"
