...
task GetEmpiricalDist.R {
  ...
  parameter_meta {
    ...
    semantic_sim_metric: "Semantic similarity scoring method. Must be supported by Onassis package.  See listSimilarities()$pairwiseMeasures for a list of accepted options Obviously must correspond to similarity metric used in other scripts."
