...
- id: in_target_file
  ...
  inputBinding:
    prefix: --targetFile
- id: in_color_list
  doc: "Colorlist for the viewpoint lines (Default g b c m y\nk)."
  type: string[]
  inputBinding:
    prefix: --colorList
- id: in_threads
