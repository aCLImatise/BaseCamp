...
- id: in_delim
  ...
  inputBinding:
    prefix: --delim
- id: in_list_add_default
  doc: 'List of fields to add. (default: None)'
  type: string[]
  inputBinding:
    prefix: -f
- id: in_list_values_add
  doc: "List of values to add for each field. (default: None)\n"
  type: string[]
  inputBinding:
    prefix: -u
outputs:
