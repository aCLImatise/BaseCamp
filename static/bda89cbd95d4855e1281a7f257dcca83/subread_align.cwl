...
- id: in_name_pairedend_file
  ...
  inputBinding:
    prefix: -r
- id: in_type_sequencing_data
  doc: "Type of input sequencing data. Its values include\n0: RNA-seq data\n1: genomic\
    \ DNA-seq data."
  type: long?
  inputBinding:
    prefix: -t
...
- id: in_multi_mapping
  ...
  inputBinding:
    prefix: --multiMapping
- id: in_maximum_number_equallybest
...
- id: in_maximum_fragmentinsert_length
  ...
  inputBinding:
    prefix: -D
- id: in_fffrrf_orientation_forwardreverse
...
- id: in_dp_gap_open
  ...
  inputBinding:
    prefix: --DPGapOpen
- id: in_sv
  doc: "Detect structural variants (eg. long indel, inversion,\nduplication and translocation)\
    \ and report breakpoints. Refer\nto Users Guide for breakpoint reporting."
  type: boolean?
  inputBinding:
    prefix: --sv
