...
- id: in_km_er_bias
  ...
  inputBinding:
    prefix: --KmerBias
- id: in_base_caller
  doc: "Simulate homopolymers and/or base qualities with\nrespect to chosen basecaller:\
    \ albacore or guppy"
  type: string?
  inputBinding:
    prefix: --basecaller
...
- id: in_perfect
  ...
  inputBinding:
    prefix: --perfect
- id: in_polya
  doc: Simulate polyA tails for given list of transcripts
  type: string?
  inputBinding:
    prefix: --polya
- id: in_fast_q
  doc: Output fastq files instead of fasta files
  type: boolean?
  inputBinding:
    prefix: --fastq
- id: in_num_threads
