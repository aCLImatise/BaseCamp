...
task Binsanitywf {
  input {
    ...
    Int? specify_convergence_number
  ...
  command <<<
    Binsanity_wf \
      ...
      ~{if defined(specify_convergence_number) then ("-v " +  '"' + specify_convergence_number + '"') else ""} \
  ...
  parameter_meta {
    ...
    specify_convergence_number: "Specify the convergence iteration number [Default: 400]\\ne.g Number of iterations with no change in the number\\nof estimated clusters that stops the convergence."
