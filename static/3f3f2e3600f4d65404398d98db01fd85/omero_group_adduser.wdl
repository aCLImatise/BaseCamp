...
task OmeroGroupAdduser {
  ...
  parameter_meta {
    ...
    user_id: "ID of the user(s) to add to the group"
    user_name: "Name of the user(s) to add to the group"
    as_owner: "Add the users as owners of the group"
    ...
    id_name_users: "ID or name of the user(s) to add to the group"
