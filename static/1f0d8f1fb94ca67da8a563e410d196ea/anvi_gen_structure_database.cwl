...
- id: in_output_db_path
  doc: 'Output file path for the new database. (default: None)'
  type: File?
  inputBinding:
...
- id: in_num_models
  ...
  inputBinding:
    prefix: --num-models
- id: in_deviation
  doc: 'Deviation (angstroms) (default: 4.0)'
  type: double?
  inputBinding:
    prefix: --deviation
...
- id: in_percent_cut_off
  doc: "If a protein in the database has a percent identity to\nthe gene of interest\
    \ that is less than this parameter,\nthen it is not considered as a template.\
    \ The default\nis 30.000000."
  type: double?
  inputBinding:
    prefix: --percent-cutoff
- id: in_alignment_fraction_cut_off
  doc: "If a protein in the database aligns to a fraction of\nthe gene of interest\
    \ that is less than this parameter,\nthe template is not considered. For example,\
    \ if\n--alignment-cutoff is set to 0.90, and the fraction of\nthe gene of interest\
    \ that is covered by a potential\ntemplate is 0.80 in their alignment, the template\
    \ does\nnot align to enough of the gene of interest to be\nconsidered. The default\
    \ is 0.800000."
  type: double?
  inputBinding:
    prefix: --alignment-fraction-cutoff
...
- id: in_structure_db
  doc: '🍺 More on `anvi-gen-structure-database`:'
  type: string
  inputBinding:
    position: 0
outputs:
