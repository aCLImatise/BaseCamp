...
task BioconvertBam2sam {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{pysam,sambamba,samtools}], --method [{pysam,sambamba,samtools}] The method to use to do the conversion. (default: samtools)"
