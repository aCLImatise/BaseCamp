...
task Surveypl {
  ...
  command <<<
    survey_pl \
      ...
      ~{if defined(read_stack_necessary) then ("-d " +  '"' + read_stack_necessary + '"') else ""}
  >>>
  parameter_meta {
    ...
    read_stack_necessary: "read stack height necessary for triggering excision"
  }
  output {
