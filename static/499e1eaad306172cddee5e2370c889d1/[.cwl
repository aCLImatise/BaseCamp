...
- id: in_length_string_zero
  ...
  inputBinding:
    prefix: -z
- id: in_file_exists_is_block
  doc: FILE exists and is block special
  type: File?
  inputBinding:
    prefix: -b
- id: in_file_exists_is_character
  doc: FILE exists and is character special
  type: File?
  inputBinding:
    prefix: -c
- id: in_file_exists_is_directory
...
- id: in_file_exists
  ...
  inputBinding:
    prefix: -e
- id: in_file_exists_is_file
  doc: FILE exists and is a regular file
  type: File?
  inputBinding:
    prefix: -f
- id: in_file_exists_is_setgroupid
  doc: FILE exists and is set-group-ID
  type: File?
  inputBinding:
    prefix: -g
- id: in_file_exists_group
...
- id: in_file_exists_read
  ...
  inputBinding:
    prefix: -r
- id: in_file_exists_has
  doc: FILE exists and has a size greater than zero
  type: File?
  inputBinding:
    prefix: -s
- id: in_file_exists_is_socket
