...
- id: in_arg_sample_name
  ...
  inputBinding:
    prefix: -a
- id: in_arg_gzipped_json_file
  doc: '[ --jsonout ] arg     gzipped json output file'
  type: File
  inputBinding:
    prefix: -j
- id: in_arg_gzipped_tsv_file
...
- id: out_stdout
  ...
  type: stdout
- id: out_arg_gzipped_json_file
  doc: '[ --jsonout ] arg     gzipped json output file'
  type: File
  outputBinding:
    glob: $(inputs.in_arg_gzipped_json_file)
- id: out_arg_gzipped_tsv_file
  doc: '[ --outfile ] arg     gzipped tsv output file'
  type: File
  outputBinding:
    glob: $(inputs.in_arg_gzipped_tsv_file)
cwlVersion: v1.1
baseCommand:
- alfred
- qc
