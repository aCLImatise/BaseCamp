...
task BisSnp {
  input {
    ...
    Boolean secondsSecondsBetweenProgressUpdates
    ...
    String unsafeUnsafe
    Boolean useUseJdkDefLater
    Boolean useUseJdkInfLater
    Boolean noNoCmdlineInHeader
  ...
  command <<<
    bis-snp \
      ...
      ~{true="--secondsBetweenProgressUpdates" false="" secondsSecondsBetweenProgressUpdates} \
      ...
      ~{true="--use_jdk_deflater" false="" useUseJdkDefLater} \
      ~{true="--use_jdk_inflater" false="" useUseJdkInfLater} \
      ~{true="--no_cmdline_in_header" false="" noNoCmdlineInHeader} \
