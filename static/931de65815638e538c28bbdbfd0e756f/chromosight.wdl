...
task Chromosight {
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/chromosight:1.5.0--pyhdfd78af_0"
  }
  parameter_meta {
    ...
    name: "Only show information related to a particular\\nkernel.[default: all]"
