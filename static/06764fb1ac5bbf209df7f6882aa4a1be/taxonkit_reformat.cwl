...
- id: in_pseudo_strain
  doc: use the node with lowest rank as strain name, only if which rank is lower than
    "species" and not "subpecies" nor "strain". It affects {t}, {S}, {T}. This flag
    needs flag -F
  type: boolean?
  inputBinding:
...
- id: in_taxid_field
  doc: field index of taxid. input data should be tab-separated. it overrides -i/--lineage-field
  type: long?
  inputBinding:
    prefix: --taxid-field
- id: in_trim
