...
Clustalw2Phylip_V0_1_0 = CommandToolBuilder(tool="clustalw2phylip", base_command=["clustalw2phylip"], inputs=[ToolInput(tag="in_clustalw_two_phy_i_lip", input_type=Int(), position=0, doc=InputDocumentation(doc="")), ToolInput(tag="in_clustalw_file", input_type=File(), position=1, doc=InputDocumentation(doc=""))], outputs=[], container="quay.io/biocontainers/meme:5.3.0--py38pl526hc1f1133_0", version="v0.1.0")


if __name__ == "__main__":
    # or "cwl"
    Clustalw2Phylip_V0_1_0().translate("wdl")
