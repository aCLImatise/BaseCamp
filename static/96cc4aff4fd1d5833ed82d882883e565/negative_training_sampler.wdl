...
task NegativeTrainingSampler {
  ...
  parameter_meta {
    ...
    reference_file: "Input genome reference in fasta format [required]"
    genome_file: "Input genome file of reference  [required]"
    output_file: "Path to output file."
    label_num: "Number of separate label columns."
    precision: "Precision of decimals when computing the attributes like GC content."
    ...
    memory: "amount of memory per core (e.g. 2 cores * 2GB = 4GB) default: 2GB"
  }
}