...
- id: in_zscore
  ...
  inputBinding:
    prefix: --zscore
- id: in_zscore_pre_filter
  doc: Apply the z-score filtering in the forward
  type: boolean?
  inputBinding:
    prefix: --zscore-pre-filter
- id: in_zscore_report_subsumed
  doc: "Report subsumed structures if their z-score is\nless than that of the enclosing\
    \ structure\n(default=off)"
  type: boolean?
  inputBinding:
    prefix: --zscore-report-subsumed
- id: in_backtrack_global
  doc: "Backtrack a global MFE structure.\n(default=off)"
  type: boolean?
  inputBinding:
    prefix: --backtrack-global
- id: in_g_quad
