...
task RiboDensityAtEachKindAAOrCodon {
  input {
    File? bam_list_file
    ...
    String? upstream_position
    String? downstream_position
  ...
  command <<<
    RiboDensityAtEachKindAAOrCodon \
      ...
      ~{if defined(upstream_position) then ("--upstream_position " +  '"' + upstream_position + '"') else ""} \
      ~{if defined(downstream_position) then ("--downstream_position " +  '"' + downstream_position + '"') else ""} \
  ...
  parameter_meta {
    ...
    upstream_position: "The left position (codon level) you want to\\nchose.[upstream position]. default=none"
    downstream_position: "The right position (codon level) you want to\\nchose.[downstream position]. default=none"
