...
- id: in_format
  ...
  inputBinding:
    prefix: --format
- id: in_stranded
  doc: "[option]   Is this a stranded library? (yes, no, or reverse).\nDEFAULT: yes."
  type: boolean?
  inputBinding:
    prefix: --stranded
- id: in_mode
