...
task PpanggolinPanrgp {
  ...
  parameter_meta {
    ...
    output_directory_default: "Output directory (default: ppanggolin_output_DATE2020- 06-23_HOUR13.42.39_PID29494)"
    ...
    interest: "Comma separated list of elements to flag when drawing and writing hotspots (default: )"
