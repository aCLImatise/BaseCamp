...
task InspectAdapter {
  ...
  parameter_meta {
    in: "*                      Input file in mzXML or mzData format.\\nNote: In mode 'inspect_out' an Inspect results (txt) file is read. (valid formats: 'mzXML', 'mzData', 'txt')"
    out: "*                     Output file in idXML format.\\nNote: In mode 'inspect_in' an Inspect input file is written as txt. (valid formats: 'idXML', 'txt')"
    ...
    inspect_output: "Name for the output file of Inspect (may only be used in a full run) (valid formats: 'txt')"
    inspect_input: "Name for the input file of Inspect (may only be used in a full run) (valid formats: 'txt')"
