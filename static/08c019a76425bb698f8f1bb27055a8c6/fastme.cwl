...
- id: in_mbranchm__branchlengthmbranchmuse
  ...
  inputBinding:
    prefix: -w
- id: in_mdatasetsm__datasetsmdatasetsmuse
...
- id: in_mnumber_option_set
  ...
  inputBinding:
    prefix: -f
- id: in_mnumber_threadsm_nbthreadsmnumber
