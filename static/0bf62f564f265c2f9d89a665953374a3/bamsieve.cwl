...
id: ../../../../home/ubuntu/BiocondaCli/bamsieve.cwl
inputs:
- id: log_file
...
- id: sub_reads
  doc: 'If set, the whitelist or blacklist will be assumed to contain one subread
    name per line, or a BAM/DataSet file from which to extract subreads (default:
    False)'
  type: boolean
  inputBinding:
    prefix: --subreads
...
- id: keep_uuid
  ...
  inputBinding:
    prefix: --keep-uuid
- id: min_adapters
  doc: 'Minimum number of adapters to filter for (default: None)'
  type: long
  inputBinding:
    prefix: --min-adapters
- id: input_bam
