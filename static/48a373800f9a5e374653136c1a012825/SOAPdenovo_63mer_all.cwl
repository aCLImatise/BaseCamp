...
- id: in_optional_resolve_repeats
  ...
  inputBinding:
    prefix: -R
- id: in_edgecovcutoff_edges_larger
...
- id: in_mergelevelmin_max_strength
  ...
  inputBinding:
    prefix: -M
- id: in_arcweight_two_edges
  doc: "arcWeight: two edges, between which the arc's weight is larger than arcWeight,\
    \ will be linerized, [0]"
  type: long?
  inputBinding:
    prefix: -e
- id: in_maxkmer_max_size
  doc: 'maxKmer (max 63): maximum kmer size used for multi-kmer, [NO]'
  type: long?
  inputBinding:
    prefix: -m
- id: in_optional_merge_bubble
  ...
  inputBinding:
    prefix: -E
- id: in_max_kmer_size
  doc: 'kmer_R2C(min 13, max 63): kmer size used for mapping reads to contigs, [K]'
  type: long?
  inputBinding:
    prefix: -k
...
- id: in_gaplendiff_allowed_difference
  ...
  inputBinding:
    prefix: -G
- id: in_shortest_contig_scaffolding
...
- id: in_maxcontigcvg_maximum_contig
  ...
  inputBinding:
    prefix: -C
- id: in_insertsizeupperbound_bavgins_used
