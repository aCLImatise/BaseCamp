...
id: ../../../../home/ubuntu/BiocondaCli/IntaRNA1.cwl
inputs:
- id: q
...
- id: seed_tq
  ...
  inputBinding:
    prefix: --seedTQ
- id: seed_bp
  doc: (=6)             number of inter-molecular base pairs within the seed region
    (arg in range [2,20])
  type: string
  inputBinding:
    prefix: --seedBP
- id: arg_h_prediction
  ...
  inputBinding:
    prefix: -m
- id: model
  doc: "(=S)              interaction model :  'S' = single-site, minimum-free-energy\
...
- id: int_len_max
  ...
  inputBinding:
    prefix: --intLenMax
- id: int_loop_max
  doc: '(=16)        interaction site : maximal number of unpaired  bases between
