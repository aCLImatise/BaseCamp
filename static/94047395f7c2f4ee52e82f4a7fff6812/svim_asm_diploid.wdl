...
task SvimAsmDiploid {
  ...
  parameter_meta {
    ...
    bam_file_one: "SAM/BAM file with alignment of query assembly's first haplotype to reference assembly (needs to be coordinate-sorted)"
    bam_file_two: "SAM/BAM file with alignment of query assembly's second haplotype to reference assembly (needs to be coordinate-sorted)"
