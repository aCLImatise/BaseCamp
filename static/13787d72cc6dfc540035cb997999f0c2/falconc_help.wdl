...
task FalconcHelp {
  ...
  parameter_meta {
    ...
    high_copy_sample_rate: "=  float   1.0       Downsample reads from high\\ncopy elements to expected\\ncoverage maxCov*rate\\n[0=discard reads]"
    int_minimum_amount: "=           int     0         Minimum amount of overhang\\nbases in an overlap to keep\\nthe overlap"
    ...
    lasjsonfn_string_required: "=, --las-json-fn=      string  REQUIRED         List of las files\\nfrom falcon, e.g\\n../1-preads_ovl/las-merge-combine/las_fofn.json"
    ...
    var_65: "-m=, --min-len=           int     6000      Minimum read length, reads"
    var_66: "--min-cov=                int     2         Minimum number of overlaps on"
    _infn_string: "--in-fn=                  string  REQUIRED  M4 overlaps file"
    o__string_required: "-o=, --out-fn=           string  REQUIRED         Final m4 overlap file"
    ...
    r_readtocontigmap_string: "-r=, --read-to-contig-map=  string  \\\"./4-quiver/read_maps/read_to_contig_map\\\"                       set"
    _rawreadids_string: "--rawread-ids=              string  \\\"\\\"                                           set rawread_ids"
    var_77: "-s=, --shard-prefix=    string  \\\"shard\\\"   The output. Shard files are"
    ctg_name: "-o=, --out-ids-fn=            string  \\\"all_shard_ids\\\"              If given,"
    corresponding: "to the"
    shard_prefix_dot_block_id: "files."
    deprecated: "Options:"
    var_82: "-s=, --shard-prefix=  string  \\\"shard_id\\\"  The output. Shard files are"
  }
  output {
