...
task Stagfilterpl {
  input {
    ...
    Boolean? countprints_number_nodes
    Boolean? filter_file
  ...
  command <<<
    stag_filter_pl \
      ...
      ~{if (countprints_number_nodes) then "-c" else ""} \
