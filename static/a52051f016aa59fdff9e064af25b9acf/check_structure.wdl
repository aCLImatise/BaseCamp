...
task CheckStructure {
  ...
  command <<<
    check_structure \
      ...
      ~{if (rename_terms) then "--rename_terms" else ""} \
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/biobb_structure_checking:3.7.3--py_0"
  }
  parameter_meta {
    ...
    rename_terms: "Renames terminal residues to NXXX, CXXX"
