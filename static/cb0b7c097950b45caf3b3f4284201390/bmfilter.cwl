...
- id: in_clip_lowercase
  doc: Should lowercase head and tail of each read be clipped [off]
  type: boolean?
  inputBinding:
    prefix: --clip-lowercase
- id: in_clip_n_win
  doc: Clip sequence head or tail as long as it has at least one N per this long window
  type: long?
  inputBinding:
    prefix: --clip-N-win
- id: in_clip_quality
...
- id: in_output
  ...
  inputBinding:
    prefix: --output
- id: in_tag
  doc: Produce .tag file [off]
  type: boolean?
  inputBinding:
    prefix: --tag
- id: in_post
  doc: Produce .short?.fa and .long?.fa files [off]
  type: boolean?
  inputBinding:
    prefix: --post
- id: in_report
  doc: Produce .report file [off]
  type: boolean?
  inputBinding:
    prefix: --report
- id: in_post_clipped
  doc: Put clipped versions of sequences to output .fa files [off]
  type: boolean?
  inputBinding:
    prefix: --post-clipped
- id: in_complexity
