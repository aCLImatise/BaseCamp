...
id: ../../../../home/ubuntu/BiocondaCli/bioconvert_gz2bz2.cwl
inputs:
- id: force
...
- id: method_use_conversion
  doc: '[{gunzip_bzip2,pigz_pbzip2,python}], --method [{gunzip_bzip2,pigz_pbzip2,python}]
    The method to use to do the conversion. (default: pigz_pbzip2)'
  type: boolean
  inputBinding:
    prefix: -m
- id: show_methods
