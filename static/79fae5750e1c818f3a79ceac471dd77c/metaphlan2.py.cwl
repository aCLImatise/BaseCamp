...
- id: in_input_type
  doc: "set whether the input is the multifasta file of metagenomic reads or\nthe\
    \ SAM file of the mapping of the reads against the MetaPhlAn db.\n[default 'automatic',\
...
- id: in_bowtie_two_db
  doc: Folder containing the MetaPhlAn database. Used if --input_type is fastq, fasta,
    multifasta, or multifastq [default /usr/local/bin/metaphlan_databases]
  type: long?
  inputBinding:
    prefix: --bowtie2db
- id: in_index
...
- id: in_stat
  doc: "EXPERIMENTAL! Statistical approach for converting marker abundances into clade\
    ...
    \ clade global average at --stat_q quantile\n'tavg_l' : trunated average of length-normalized\
