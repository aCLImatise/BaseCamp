...
task ClusterMassTracesByPrecursor {
  ...
  parameter_meta {
    ...
    max_rt_apex_difference: "Maximal difference of the apex in retention time (in seconds). This is a hard parameter, all profiles further away will not be considered at all. (default: '5.0')"
    swath_lower: "Swath lower isolation window (default: '0.0')"
    swath_upper: "Swath upper isolation window (default: '0.0')"
