...
id: ../../../gmcloser_blast_LR_MT.pl.cwl
inputs:
- id: in_target_s_caf
...
- id: in_sam_dir
  ...
  inputBinding:
    prefix: --sam_dir
- id: in_query_index
  doc: basename of bowtie2 index files for query long reads [optional]
  type: long
  inputBinding:
    prefix: --query_index
- id: in_align_file
...
- id: in_blast
  ...
  inputBinding:
    prefix: --blast
- id: in_min_match_len
  doc: "minimum overlap length to be filtered for BLASTn alignments.\nContig-alignments\
...
- id: in_min_identity
  doc: 'minimum overlap identity (%) to be filtered for BLASTn alignments. Alignments
...
- id: in_min_subcon
  doc: 'minimum length of subcontigs, to be used for gapclosing [default: 150]'
  type: long
  inputBinding:
    prefix: --min_subcon
- id: in_min_gap_size
  doc: 'minimum length of gap, when spliting the target scaffold sequences into subcontigs
    [>0, default: 1]'
  type: long
  inputBinding:
    prefix: --min_gap_size
