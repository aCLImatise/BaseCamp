...
- id: in_index
  ...
  inputBinding:
    prefix: -index
- id: in_minimal_frequence_extracted
...
- id: in_line
  ...
  inputBinding:
    prefix: -line
- id: in_rb_xu
  doc: "If the reads of the union are already extracted,\nprovide this argument '--rbxu'\
    \ [optional]"
  type: boolean
  inputBinding:
    prefix: --rbxu
- id: in_kmer_sizes_used
  doc: "[KMER [KMER ...]]  k-mer size(s) used for gap-filling [default: [51, 41,\n\
    31, 21]]"
  type: boolean
  inputBinding:
    prefix: -k
...
- id: in_minimal_abundance_threshold
  doc: "[ABUNDANCE_THRESHOLD [ABUNDANCE_THRESHOLD ...]]\nMinimal abundance threshold\
