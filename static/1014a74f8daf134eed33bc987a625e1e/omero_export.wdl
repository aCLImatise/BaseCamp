...
task OmeroExport {
  ...
  >>>
  parameter_meta {
    file: "Filename to export to or '-' for stdout. File may not exist"
    type: "Type of export. Default: TIFF"
    iterate: "Iterate over an object and write individual objects to the directory named by --file (EXPERIMENTAL)"
