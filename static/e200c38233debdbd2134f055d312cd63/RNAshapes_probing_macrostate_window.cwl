...
id: RNAshapes_probing_macrostate_window.cwl
inputs:
- id: in_specify_window_size
  ...
  inputBinding:
    prefix: -w
- id: in_specify_window_incrementdefault
  doc: "Specify the window increment.\nDefault is 1. Use with -w."
  type: long?
  inputBinding:
    prefix: -i
- id: in_rescale_energy_parameters
  doc: "Rescale energy parameters to a temperature of <float-value> C.\nDefault is\
    \ 37C."
  type: double?
  inputBinding:
    prefix: -T
- id: in_read_energy_parameters
  ...
  inputBinding:
    prefix: -P
- id: in_set_energy_range_sets_energy_range_percentage
  ...
  inputBinding:
    prefix: -c
- id: in_set_energy_range_sets_energy_range_absolute
...
- id: in_alignment_folding_use
  ...
  inputBinding:
    prefix: -R
- id: in_set_shape_abstraction
  doc: Set shape abstraction level [5]
  type: long?
  inputBinding:
    prefix: -q
- id: in_allow_base_pairs
