...
task Bwise {
  ...
  command <<<
    bwise \
      ...
      ~{if defined(integer_smallest_default) then ("-k " +  '"' + integer_smallest_default + '"') else ""} \
  ...
  parameter_meta {
    ...
    integer_smallest_default: "an integer, smallest k-mer size (default 63)"
    ...
    fraction_anchor_indexed: "Fraction of the anchor that are indexed (default all,\\nput 10 to index one out of 10 anchors)"
