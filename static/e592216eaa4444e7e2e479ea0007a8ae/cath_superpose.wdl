...
task CathSuperpose {
  input {
    ...
    String? show_dna_within_dist
    String? show_organic_within_dist
    String alignment_source
    String pdb_file_source
  ...
  parameter_meta {
    ...
    regions_context: "(=alone)     Show the alignment regions in the context <context>, one of available options: alone    - alone in_chain - within the chain(s) in which the regions appear in_pdb   - within the PDB in which the regions appear"
