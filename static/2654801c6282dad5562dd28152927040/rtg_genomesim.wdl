...
task RtgGenomesim {
  ...
  parameter_meta {
    ...
    freq: "relative frequencies of A,C,G,T in the generated sequence (Default is 1,1,1,1)"
    length: "length of generated sequence. May be specified 0 or more times, or as a comma separated list"
