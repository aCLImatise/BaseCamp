...
task BcftoolsCsq {
  ...
  parameter_meta {
    ...
    output_type: "|u|z|v|t     b: compressed BCF, u: uncompressed BCF, z: compressed VCF\\nv: uncompressed VCF, t: plain tab-delimited text output [v]"
