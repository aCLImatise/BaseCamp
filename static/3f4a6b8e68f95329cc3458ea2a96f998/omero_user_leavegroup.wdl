...
task OmeroUserLeavegroup {
  ...
  parameter_meta {
    ...
    group_id: "ID  of the group(s) to leave"
    group_name: "Name of the group(s) to leave"
    as_owner: "Leave the owner list of the group(s)"
    ...
    id_name_leave: "ID or name of the group(s) to leave"
