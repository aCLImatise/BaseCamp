...
- id: in_input_log_path
  doc: 'AMBER (sander) minimization output (log) file. Accepted formats: log, out,
    txt, o.'
  type: File?
  inputBinding:
    prefix: --input_log_path
- id: in_output_dat_path
  doc: "Dat output file containing data from the specified terms along the minimization\
    \ process. File type: output. Accepted formats: dat, txt, csv.\n"
  type: File?
  inputBinding:
