...
- id: in_output_path
  ...
  inputBinding:
    prefix: --outputpath
- id: in_input_taxid
  doc: NCBI taxonomy ID number of input RNA
  type: long?
  inputBinding:
    prefix: --inputtaxid
...
- id: in_input_blast_database
  doc: "Specify name of blast database to use,\nin offline mode the filepath to the\n\
    blast database (/home/user/nt_v5).\nDefault: nt"
  type: File?
  inputBinding:
    prefix: --inputblastdatabase
- id: in_length_filter
...
- id: in_threads
  ...
  inputBinding:
    prefix: --threads
- id: in_taxonomy_restriction
  doc: Restrict search space to taxonomic
  type: string?
  inputBinding:
    prefix: --taxonomyrestriction
...
- id: in_check_setup
  ...
  inputBinding:
    prefix: --checksetup
- id: in_taxonomy_dump_path
  doc: Path to NCBI taxonomy dump directory.
  type: File?
  inputBinding:
    prefix: --taxonomydumppath
- id: in_offline_mode
  doc: "Uses locally installed blast and\ndatabases. Default: False"
  type: boolean?
  inputBinding:
    prefix: --offlinemode
...
- id: in_quiet
  ...
  inputBinding:
    prefix: --quiet
- id: in_organism
  doc: -z --inputnscicutoff=NUM             Only candidate sequences with a
  type: string
  inputBinding:
    position: 0
- id: in_kingdom
  doc: (bacteria,archea,eukaryia,cellularorganisms,viruses).
  type: string
  inputBinding:
    position: 0
outputs:
