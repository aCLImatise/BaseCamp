...
task IRFinder {
  ...
  command <<<
    IRFinder \
      ...
      ~{if defined(number_use_use) then ("-t " +  '"' + number_use_use + '"') else ""} \
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/irfinder:1.3.1--h516909a_0"
  }
  parameter_meta {
    ...
    number_use_use: ": The number of physical CPUs to use by IRFinder. When ommited (default), IRFinder will use all physical CPUs."
