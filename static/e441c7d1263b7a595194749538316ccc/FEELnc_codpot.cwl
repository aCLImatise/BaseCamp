...
- id: verbosity
  ...
  inputBinding:
    prefix: --verbosity
- id: in_file
  doc: Specify the .GTF or .FASTA file  (such as a cufflinks transcripts/merged .GTF
    or .FASTA file)
  type: File
  inputBinding:
    prefix: --infile
- id: mrna_file
  doc: Specify the annotation .GTF or .FASTA file  (file of protein coding transcripts
    .GTF or .FASTA file)
  type: File
  inputBinding:
    prefix: --mRNAfile
- id: genome
  ...
  inputBinding:
    prefix: --genome
- id: l_ncrna_file
  doc: Specify a known set of lncRNA for training .GTF or .FASTA  [ default undef
    ]
  type: File
  inputBinding:
    prefix: --lncRNAfile
...
- id: learn_orf_type
  doc: "Integer [0,1,2,3,4] to specify the type of longest ORF calculate [ default:\
    \ 3 ] for learning data set. If the CDS is annotated in the .GTF, then the CDS\
    \ is considered as the longest ORF, whatever the --orftype value. '0': ORF with\
    \ start and stop codon; '1': same as '0' and ORF with only a start codon, take\
    \ the longest; '2': same as '1' but with a stop codon; '3': same as '0' and ORF\
    \ with a start or a stop, take the longest (see '1' and '2'); '4': same as '3'\
    \ but if no ORF is found, take the input sequence as ORF."
  type: string
  inputBinding:
    prefix: --learnorftype
- id: test_orf_type
