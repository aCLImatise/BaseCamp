...
task CruxAdapter {
  input {
    ...
    String? fragment_bin_offset
    String? fragment_bin_width
    ...
    String? c_term_modifications
    String? n_term_modifications
  ...
  parameter_meta {
    ...
    precursor_mass_tolerance: "Precursor monoisotopic mass tolerance (Crux parameter: peptide_mass_tolerance) (default: '10')"
    precursor_mass_units: "Unit of precursor mass tolerance (amu, m/z or ppm) (default: 'ppm' valid: 'mass', 'mz', 'ppm')"
    fragment_bin_offset: "In the discretization of the m/z axes of the observed and theoretical spectra, this parameter specifies the location of the left edge of the first bin, relative to mass = 0 (i.e., mz-bin-offset = 0.xx means the left edge of the first bin will be located at +0.xx Da). (default: '0')"
    ...
    enzyme: "The enzyme used for peptide digestion. (default: 'trypsin' valid: 'custom-enzyme', 'asp-n', 'clostripain', 'elastase-trypsin-chymotrypsin', 'lys-n', 'trypsin/p', 'lys-c', 'arg-c', 'staph-protease', 'trypsin', 'elastase', 'pepsin-a', 'cyanogen-bromide', 'no-enzyme', 'iodosobenzoate', 'chymotrypsin', 'glu-c', 'proline-endopeptidase')"
