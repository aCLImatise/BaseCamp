...
- id: in_max_complexity_get
  ...
  inputBinding:
    prefix: -c
- id: in_flattened_seqid_ortypenumber
...
- id: out_stdout
  ...
  type: stdout
- id: out_filename_default_stdout
  doc: "Filename for output  [File Out]\ndefault = stdout"
  type: File?
  outputBinding:
    glob: $(inputs.in_filename_default_stdout)
