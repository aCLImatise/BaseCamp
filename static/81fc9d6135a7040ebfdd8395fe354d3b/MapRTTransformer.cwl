...
- id: in_in
  ...
  inputBinding:
    prefix: -in
- id: in_out
  doc: "Output file (same file type as 'in'). Either this option or 'trafo_out' has\
    \ to be provided; they can be used together. (valid formats: 'mzML', 'featureXML',\
    \ 'consensusXML', 'idXML')"
  type: File
  inputBinding:
    prefix: -out
- id: in_traf_o_in
  ...
  inputBinding:
    prefix: -trafo_in
- id: in_traf_o_out
  doc: "Transformation output file. Either this option or 'out' has to be provided;\
