...
id: fa2htgs.cwl
inputs:
- id: in_filename_fasta_optionaldefault
  doc: "Filename for fasta input [File In]  Optional\ndefault = stdin"
  type: boolean?
  inputBinding:
    prefix: -i
- id: in_filename_seqsubmit_templatesub
...
- id: in_htgs_phase_default
  ...
  inputBinding:
    prefix: -p
- id: in_genbank_accession_update
...
- id: in_filename_comment_optional
  ...
  inputBinding:
    prefix: -O
- id: in_filename_phrap_input_optional
...
- id: in_contigs_use_separate
  ...
  inputBinding:
    prefix: -P
- id: in_filename_accession_optional
...
- id: in_coordinates_resulting_sequence
  ...
  inputBinding:
    prefix: -X
- id: in_sequence_optionaldefault_f
...
- id: in_t_clone_eg
  ...
  inputBinding:
    prefix: '-7'
- id: in_filename_phrap_contig_optional
...
- id: in_htgscancelled_keyword_optionaldefault
  ...
  inputBinding:
    prefix: -q
- id: in_filename_quality_optional
