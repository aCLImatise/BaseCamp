...
task CsvtkComb {
  ...
  command <<<
    csvtk comb \
      ...
      ~{if (nat_sort) then "--nat-sort" else ""} \
  ...
  parameter_meta {
    ...
    number: "number of items in a combination, 0 for no limit, i.e., return all combinations (default 2)"
    sort: "sort items in a combination"
