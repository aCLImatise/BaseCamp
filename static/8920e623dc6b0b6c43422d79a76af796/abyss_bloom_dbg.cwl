...
id: ../../../../home/ubuntu/BiocondaCli/abyss_bloom_dbg.cwl
inputs:
- id: __assemblyfasta
...
- id: km_er
  ...
  inputBinding:
    prefix: --kmer
- id: kc
  doc: use a cascading Bloom filter with N levels, instead of a counting Bloom filter
    [2]
  type: string
  inputBinding:
    prefix: --kc
...
- id: cov_track
  ...
  inputBinding:
    prefix: --cov-track
- id: trace_file
  doc: write debugging info about extension of each read to FILE
  type: File
  inputBinding:
    prefix: --trace-file
- id: ref
