...
task SamtoolsMarkdup {
  ...
  parameter_meta {
    ...
    reduce_optical_accuracy: "Reduce optical duplicate accuracy (faster results with many duplicates)."
    ...
    no_multi_dup: "Reduced duplicates of duplicates checking."
