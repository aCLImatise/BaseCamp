...
- id: in_load_type_project
  ...
  inputBinding:
    prefix: -f
- id: in_write_sequencesassembly_allowed
...
- id: in_set_default_quality
  ...
  inputBinding:
    prefix: -q
- id: in_rename_contigssingletsreads_given
...
- id: in_extract_contigs_consensus
  ...
  inputBinding:
    prefix: -M
- id: in_recalculate_consensus_cons
...
- id: in_defines_minimum_coverage
  ...
  inputBinding:
    prefix: -V
- id: in_minimum_contig_unclipped
...
- id: in_gc_wig
  ...
  inputBinding:
    position: 2
- id: in_sequences_consensus_fasta
