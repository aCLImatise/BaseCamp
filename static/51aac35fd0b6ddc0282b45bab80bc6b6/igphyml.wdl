...
task Igphyml {
  input {
    ...
    Boolean? hotness
    Boolean? motifs
    Boolean? frequencies_mempiricalm_mftfcfafgmmftfcfafgftfcfafgftfcfafgmmorm
    Boolean? f_model
  ...
  command <<<
    igphyml \
      ...
      ~{if (musertreefilem_only_i) then "-u" else ""} \
      ...
      ~{if (frequencies_mempiricalm_mftfcfafgmmftfcfafgftfcfafgftfcfafgmmorm) then "-f" else ""} \
