...
task Multibinpacking {
  ...
  parameter_meta {
    model: "(single, multi) default: multi\\nmodel variants\\nsingle: use single-dimensional bin-packing constraints\\nmulti: use single-dimensional bin-packing constraints"
    symmetry: "(none, max-conflict) default: max-conflict\\nsymmetry variants"
    ipl: "(def,val,bnd,dom,basic,advanced)\\ndefault: def\\ninteger propagation level (comma-separated list)"
    branching: "(degree, afc) default: afc\\nbranching variants"
    ...
    disabled: "Options for MultiBinPacking:"
  }
  output {
