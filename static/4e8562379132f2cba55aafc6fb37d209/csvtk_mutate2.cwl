...
inputs:
- id: in_digits
  doc: number of digits after the decimal dot (default 2)
  type: long?
  inputBinding:
    prefix: --digits
- id: in_expression
...
- id: in_name
  ...
  inputBinding:
    prefix: --name
- id: in_numeric_as_string
  doc: treat even numeric fields as strings to avoid converting big numbers into scientific
    notation
  type: boolean?
  inputBinding:
