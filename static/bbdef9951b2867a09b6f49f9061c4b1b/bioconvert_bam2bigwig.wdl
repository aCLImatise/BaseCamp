...
task BioconvertBam2bigwig {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{bamCoverage,ucsc}], --method [{bamCoverage,ucsc}] The method to use to do the conversion. (default: bamCoverage)"
    show_methods: "A converter may have several methods (default: False)"
    chrom_sizes: "a two-column file/URL: <chromosome name> <size in bases>. Used by the ucsc method only (default: None)"
