...
id: ../../../../home/ubuntu/BiocondaCli/gaas_fasta_extractFaFromMultiFa.sh_multiFastaFile.fa.cwl
inputs:
- id: extended_regexp
...
- id: include
  ...
  inputBinding:
    prefix: --include
- id: exclude
  doc: skip files and directories matching GLOB
  type: string
  inputBinding:
    prefix: --exclude
- id: exclude_from
  doc: skip files matching any file pattern from FILE
  type: File
  inputBinding:
    prefix: --exclude-from
- id: exclude_dir
