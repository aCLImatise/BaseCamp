...
task Wordsquare {
  input {
    ...
    Boolean? file_stat
    Boolean? trace
    Boolean? string_default_nonefile
    String disabled
  }
  command <<<
    word_square \
      ...
      ~{if (string_default_nonefile) then "-file" else ""}
  >>>
  runtime {
  ...
  parameter_meta {
    ...
    branching: "(words, letters) default: letters\\nbranching variants"
    ...
    string_default_nonefile: "(string) default: NONE\\nfile name of dictionary"
    disabled: "Options for WordSquare:"
  }
  output {
