...
task TranslatorxVLocalpl {
  ...
  parameter_meta {
    ...
    parameters_gblocks_g: ": parameters for GBlocks (Optional)\\nExample: -g \\\"-b2 x -b3 x -b4 x...\\\""
