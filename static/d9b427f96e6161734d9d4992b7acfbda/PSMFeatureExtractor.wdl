...
task PSMFeatureExtractor {
  ...
  parameter_meta {
    in: "*                 Input file(s) (valid formats: 'idXML', 'mzid')"
    out: "*                 Output file in mzid or idXML format (valid formats: 'idXML', 'mzid')"
    out_type: "Output file type -- default: determined from file extension or content. (valid: 'idXML', 'mzid')"
