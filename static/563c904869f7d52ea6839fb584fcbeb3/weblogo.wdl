...
task Weblogo {
  ...
  parameter_meta {
    ...
    show_x_axis: "/NO      Display sequence numbers along x-axis?\\n(default: True)"
    xlabel: "X-axis label"
    ...
    rotate_numbers: "/NO  Draw X-axis numbers with vertical orientation\\n(default: False)."
    ...
    show_yaxis: "/NO      Display entropy scale along y-axis? (default:\\nTrue)"
    ylabel: "Y-axis label (default depends on plot type and\\nunits)"
    show_ends: "/NO       Label the ends of the sequence? (default:\\nFalse)"
    fine_print: "The fine print (default: weblogo version)"
    tic_marks: "Distance between ticmarks (default: 1.0)"
    error_bars: "/NO       Display error bars? (default: True)"
    reverse_stacks: "/NO  Draw stacks with largest letters on top?\\n(default: True)"
    ...
    box: "/NO             Draw boxes around symbols? (default: no)"
    ...
    scale_width: "/NO     Scale the visible stack width by the fraction\\nof symbols in the column?  (I.e. columns with\\nmany gaps of unknowns are narrow.)  (Default:\\nyes)"
    debug: "/NO           Output additional diagnostic information.\\n(Default: False)"
