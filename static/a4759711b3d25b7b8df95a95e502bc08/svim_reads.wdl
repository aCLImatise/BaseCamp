...
task SvimReads {
  ...
  command <<<
    svim reads \
      ...
      ~{if (all_b_nds) then "--all_bnds" else ""} \
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/svim:1.4.2--py_0"
  }
  parameter_meta {
    verbose: "Enable more verbose logging (default: False)"
    cores: "CPU cores to use for the alignment (default: 1)"
    aligner: "Tool for read alignment: ngmlr or minimap2 (default:\\nngmlr)"
    nano_pore: "Use Nanopore settings for read alignment (default:\\nFalse)"
