...
task ContigOverlapTrimmer {
  ...
  parameter_meta {
    ...
    overlap_boundary_max: "Maximum boundary of overlap expressed as percentage of contig length [50]"
    ...
    min_trim_length: "Minimum acceptable trimmed length expressed as percentage of total contig length [0.89]"
