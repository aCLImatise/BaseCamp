...
task PlanemoProfileCreate {
  ...
  parameter_meta {
    ...
    engine: "[galaxy|docker_galaxy|external_galaxy] Select an engine to serve artifacts such as tools and workflows. Defaults to a local Galaxy, but running Galaxy within a Docker container."
