...
- id: in_obo
  ...
  inputBinding:
    prefix: -obo
- id: in_an_no
  doc: HPO annotations file from 'https://ci.monarchinitiative.org/view/hpo/job/hpo.annotations/lastSuccessfulBuild/artifact/rare-diseases/util/annotation/phenotype_to_genes.txt'
  type: File?
  inputBinding:
    prefix: -anno
- id: in_omim
...
- id: in_clin_var
  doc: "ClinVar VCF file for additional disease-gene information. Download and unzip\
    \ from 'ftp://ftp.ncbi.nlm.nih.gov/pub/clinvar/vcf_GRCh37/archive_2.0/2021/clinvar_20210110.vcf.gz'.\n\
    Default value: ''"
  type: File?
  inputBinding:
    prefix: -clinvar
- id: in_hgmd
  doc: "HGMD phenobase file (Manually download and unzip 'hgmd_phenbase-2020.4.dump').\n\
    Default value: ''"
  type: File?
  inputBinding:
    prefix: -hgmd
