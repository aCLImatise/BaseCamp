...
id: ../../../../home/ubuntu/BiocondaCli/mhcflurry_predict_scan.cwl
inputs:
...
- id: no_throw
  ...
  inputBinding:
    prefix: --no-throw
- id: peptide_lengths
  doc: 'Peptide lengths to consider. Pass as START-END (e.g. 8-11) or a comma-separated
    list (8,9,10,11). When using START-END, the range is INCLUSIVE on both ends. Default:
    8-11.'
  type: string
  inputBinding:
