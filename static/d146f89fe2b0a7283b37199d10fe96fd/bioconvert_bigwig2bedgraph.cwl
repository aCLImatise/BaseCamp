...
id: ../../../../home/ubuntu/BiocondaCli/bioconvert_bigwig2bedgraph.cwl
inputs:
- id: force
...
- id: method_use_conversion
  doc: '[{pybigwig,ucsc}], --method [{pybigwig,ucsc}] The method to use to do the
    conversion. (default: pybigwig)'
  type: boolean
  inputBinding:
    prefix: -m
- id: show_methods
