...
id: ../../../../home/ubuntu/BiocondaCli/get_refseq.py.cwl
inputs:
- id: organism
...
- id: output
  ...
  inputBinding:
    prefix: --output
- id: server
  doc: The UCSC server from where the RefSeq gene annotations are downloaded. Default
    is 'hgdownload.cse.ucsc.edu'.
  type: string
  inputBinding:
    prefix: --server
outputs: []
