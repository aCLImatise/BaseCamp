...
- id: in_orient
  ...
  inputBinding:
    prefix: --orient
- id: in_db_mask
  doc: '|dust|soft     mask db seqs with dust, soft or no method (dust)'
  type: string?
  inputBinding:
    prefix: --dbmask
- id: in_word_length
  doc: length of words used for matching 3-15 (12)
  type: long?
  inputBinding:
    prefix: --wordlength
- id: in_not_matched
...
- id: in_udb_stats
  ...
  inputBinding:
    prefix: --udbstats
- id: in__db_filename_reference_database
  doc: --db FILENAME               reference database for --uchime_ref
  type: string
  inputBinding:
    position: 0
- id: in_abskew_real_minimum
...
- id: in__maxuniquesize_abundance
  ...
  inputBinding:
    position: 0
- id: in_output_filename_output_fasta
...
- id: in_var_207
  ...
  inputBinding:
    position: 1
- id: in__db_filename_database_sequences
  doc: --db FILENAME               database of sequences in correct orientation
  type: string
  inputBinding:
    position: 0
- id: in_for_oriented_sequences
  doc: --fastaout FILENAME         FASTA output filename for oriented sequences
  type: string
  inputBinding:
    position: 1
- id: in_var_210
...
- id: in__eetabbedout_filename
  ...
  inputBinding:
    position: 2
- id: in_cutpattern_string_pattern
  doc: --cut_pattern STRING        pattern to match with ^ and _ at cut sites
  type: string
  inputBinding:
    position: 0
- id: in__fastaout_filename_filename
...
- id: in_var_217
  ...
  inputBinding:
    position: 0
- id: in__fastaout_output_filename
...
- id: out_uc
  ...
  outputBinding:
    glob: $(inputs.in_uc)
- id: out_output_file_statistics
  doc: output file for fastq_eestats(2) statistics
  type: File?
  outputBinding:
    glob: $(inputs.in_output_file_statistics)
- id: out_fast_q_out
  doc: output to specified FASTQ file
  type: File?
  outputBinding:
...
- id: out_not_matched
  ...
  type: File?
  outputBinding:
    glob: $(inputs.in_not_matched)
- id: out_tabbed_out
  doc: output filename for result information
  type: File?
  outputBinding:
    glob: $(inputs.in_tabbed_out)
- id: out_fast_a_out
  doc: FASTA output filename for merged sequences
  type: File?
  outputBinding:
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/vsearch:2.17.0--h95f258a_1
cwlVersion: v1.1
baseCommand:
- vsearch
