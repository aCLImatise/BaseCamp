...
- id: database
  ...
  inputBinding:
    prefix: -database
- id: comet_executable
  doc: "*        Comet executable of the installation e.g. 'comet.exe'"
  type: string
  inputBinding:
    prefix: -comet_executable
- id: comet_version
  doc: "Comet version: (year,version,revision) (default: '2016.01 rev. 2' valid: '2016.01\
    \ rev. 2', '2016.01 rev. 3', '2017.01 rev. 0beta')"
  type: string
  inputBinding:
    prefix: -comet_version
- id: pin_out
  doc: "Output file - for Percolator input (valid formats: 'csv')"
  type: File
  inputBinding:
    prefix: -pin_out
...
- id: precursor_mass_tolerance
  doc: "Precursor monoisotopic mass tolerance (Comet parameter: peptide_mass_tolerance).\
    \  See also precursor_error_units to set the unit. (default: '10')"
  type: string
  inputBinding:
...
- id: enzyme
  doc: "The enzyme used for peptide digestion. (default: 'Trypsin' valid: 'Chymotrypsin',\
    \ 'glutamyl endopeptidase', 'Trypsin/P', 'PepsinA', 'Asp-N', 'Trypsin', 'Arg-C',\
    \ 'CNBr',  'Lys-C', 'unspecific cleavage', 'Lys-N')"
  type: string
  inputBinding:
    prefix: -enzyme
