...
- id: in_output_directory
  ...
  inputBinding:
    prefix: -o
- id: in_organelle_type_embplantptotherptembplantmtembpl
...
- id: in_debug
  ...
  inputBinding:
    prefix: --debug
- id: in_ant_nr_slash_animal_mt_slash_fungus_mt_slash_anonym_dot
  doc: --linear              By default, this script would only disentangle the
  type: string
  inputBinding:
    position: 0
- id: in_cases_dot
  doc: --weight-f=WEIGHT_FACTOR
  type: string
  inputBinding:
    position: 0
outputs:
