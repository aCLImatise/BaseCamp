...
- id: in_number_use_use
  doc: ': The number of physical CPUs to use by IRFinder. When ommited (default),
    IRFinder will use all physical CPUs.'
  type: long?
  inputBinding:
    prefix: -t
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/irfinder:1.3.1--h516909a_0
cwlVersion: v1.1
baseCommand:
- IRFinder
