...
id: ../../../../home/ubuntu/BiocondaCli/ccs_alt.cwl
inputs:
- id: min_passes
...
- id: ccs
  ...
  inputBinding:
    position: 0
- id: in_dot_sub_reads_dot_bam_vertical_line_xml
  doc: ''
  type: string
  inputBinding:
    position: 1
- id: out_dot_ccs_dot_bam_vertical_line_fast_q_do_tgz_vertical_line_xml
  doc: ''
  type: string
  inputBinding:
    position: 2
