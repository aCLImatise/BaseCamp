...
- id: in_label
  ...
  inputBinding:
    prefix: --label
- id: in_show_x_axis
  doc: "/NO      Display sequence numbers along x-axis?\n(default: True)"
  type: string?
  inputBinding:
    prefix: --show-xaxis
- id: in_xlabel
...
- id: in_rotate_numbers
  doc: "/NO  Draw X-axis numbers with vertical orientation\n(default: False)."
  type: string?
  inputBinding:
...
- id: in_yaxis
  ...
  inputBinding:
    prefix: --yaxis
- id: in_show_yaxis
  doc: "/NO      Display entropy scale along y-axis? (default:\nTrue)"
  type: string?
  inputBinding:
    prefix: --show-yaxis
- id: in_ylabel
  ...
  inputBinding:
    prefix: --ylabel
- id: in_show_ends
  doc: "/NO       Label the ends of the sequence? (default:\nFalse)"
  type: string?
  inputBinding:
    prefix: --show-ends
- id: in_fine_print
...
- id: in_reverse_stacks
  doc: "/NO  Draw stacks with largest letters on top?\n(default: True)"
  type: string?
  inputBinding:
...
- id: in_resolution
  ...
  inputBinding:
    prefix: --resolution
- id: in_scale_width
  doc: "/NO     Scale the visible stack width by the fraction\nof symbols in the column?\
    \  (I.e. columns with\nmany gaps of unknowns are narrow.)  (Default:\nyes)"
  type: string?
  inputBinding:
    prefix: --scale-width
- id: in_debug
  doc: "/NO           Output additional diagnostic information.\n(Default: False)"
  type: string?
  inputBinding:
    prefix: --debug
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/weblogo:3.7.8--py_0
cwlVersion: v1.1
baseCommand:
- weblogo
