...
task Weblogo {
  input {
    ...
    String? small_font_size
    String? number_font_size
    String? text_font
    String? logo_font
    String? title_font
    String? stack_width
    ...
    String? scale_width
    String? debug
    String? errorbar_fraction
    String? errorbar_width_fraction
    String? errorbar_gray
    Boolean? serve
    String? port
  ...
  parameter_meta {
    ...
    datatype: "Type of multiple sequence alignment or position weight matrix file: (clustal, fasta, msf, genbank, nbrf, nexus, phylip, stockholm, intelligenetics, table, array, transfac)"
    ...
    units: "A unit of entropy ('bits' (default), 'nats', 'digits'), or a unit offree energy ('kT', 'kJ/mol', 'kcal/mol'), or 'probability' for probabilities"
    ...
    rotate_numbers: "Draw X-axis numbers with vertical orientation (default: False)."
    number_interval: "Distance between numbers on X-axis (default: 5)"
    ...
    errorbar_fraction: "Sets error bars display proportion (default: 0.9)"
    errorbar_width_fraction: "Sets error bars width display proportion (default: 0.25)"
    errorbar_gray: "Sets error bars' gray scale percentage (default: 0.75)"
