...
task MsisensorproBaseline {
  ...
  command <<<
    msisensor_pro baseline \
      ...
      ~{if (double_site_less) then "-l" else ""} \
  ...
  parameter_meta {
    ...
    double_site_less: "<double>   a site with a ratio of deteced in all samples less than this parameter will be removed in following analysis, default=0.5"
