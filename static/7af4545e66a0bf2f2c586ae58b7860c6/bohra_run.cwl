...
- id: in_kraken_db
  ...
  inputBinding:
    prefix: --kraken_db
- id: in_kraken_threads
  doc: 'Number of threads for each kraken2 (default: 16)'
  type: long?
  inputBinding:
...
- id: in_keep
  ...
  inputBinding:
    prefix: --keep
- id: in_verbose
  doc: 'Output verbose snakemake (default: False)'
  type: boolean?
  inputBinding:
    prefix: --verbose
outputs:
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/bohra:1.2.19--py_1
cwlVersion: v1.1
baseCommand:
- bohra
- run
