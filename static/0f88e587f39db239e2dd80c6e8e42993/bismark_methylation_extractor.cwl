...
- id: in_ample_memory
  ...
  inputBinding:
    prefix: --ample_memory
- id: in_ucsc
  doc: "Writes out an additional bedGraph file (ending in '_UCSC.bedGraph.gz') that\
    \ is compatible with the\nUCSC genome browser. If alignments were carried out\
    \ against an Ensembl version of the genome, this\nstep will prefix chromosome\
