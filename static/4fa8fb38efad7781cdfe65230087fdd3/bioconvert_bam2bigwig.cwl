...
- id: in_method_use_do
  doc: "[{bamCoverage,ucsc}], --method [{bamCoverage,ucsc}]\nThe method to use to\
    \ do the conversion. (default:\nbamCoverage)"
  type: boolean?
  inputBinding:
    prefix: -m
- id: in_show_methods
  ...
  inputBinding:
    prefix: --show-methods
- id: in_chrom_sizes
  doc: "a two-column file/URL: <chromosome name> <size in\nbases>. Used by the ucsc\
    \ method only (default: None)"
  type: long?
  inputBinding:
    prefix: --chrom-sizes
- id: in_input_file
