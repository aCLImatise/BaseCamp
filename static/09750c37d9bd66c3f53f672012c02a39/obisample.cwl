...
- id: in__samplesizesize_generated
  doc: "###, --sample-size=###\nSize of the generated sample. If -a option is set,\n\
    size is expressed as fraction"
  type: boolean?
  inputBinding:
    prefix: -s
- id: in_approx_sampling
  doc: "Switch to an approximative algorithm, useful for large\nfiles"
  type: boolean?
  inputBinding:
    prefix: --approx-sampling
- id: in_without_replacement
  doc: Ask for sampling without replacement
  type: boolean?
  inputBinding:
