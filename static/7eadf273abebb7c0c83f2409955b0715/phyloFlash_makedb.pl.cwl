...
- id: in_overwrite
  ...
  inputBinding:
    prefix: --overwrite
- id: in_ref_minlength
  doc: "Minimum length of database sequences to keep after trimming of\nvectors and\
    \ contaminant sequences. Default of 800 bp is about\n50% for SSU rRNA gene length,\
    \ but should be changed if a custom\ndatabase is used.\nDefault: 800"
  type: boolean?
  inputBinding:
    prefix: --ref_minlength
- id: in_cpus
