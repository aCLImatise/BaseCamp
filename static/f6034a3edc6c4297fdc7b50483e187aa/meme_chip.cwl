...
- id: in_seed
  doc: "<seed>  : seed for the randomized selection of sequences\nfor MEME and the\
    \ shuffling of sequences for STREME;\ndefault: seed randomly"
  type: boolean?
  inputBinding:
    prefix: -seed
- id: in_min_w
  doc: '<num>   : minimum motif width; default: 6'
  type: boolean?
  inputBinding:
    prefix: -minw
- id: in_max_w
  doc: '<num>   : maximum motif width; default: 15'
  type: boolean?
  inputBinding:
    prefix: -maxw
- id: in_c_cut
...
- id: in_meme_mod
  ...
  inputBinding:
    prefix: -meme-mod
- id: in_meme_n_motifs
  doc: "<num>   : maximum number of motifs to find; default: 3\n: if =0, MEME will\
    \ not be run"
  type: boolean?
  inputBinding:
    prefix: -meme-nmotifs
...
- id: in_meme_nr_and
  ...
  inputBinding:
    prefix: -meme-nrand
- id: in_s_treme_pvt
  doc: '<num>  : stop if hold-out set p-value greater than <num>'
  type: boolean?
  inputBinding:
    prefix: -streme-pvt
- id: in_s_treme_n_motifs
  doc: "<num>  : maximum number of motifs to find; overrides -streme-pvt;\n: if =0,\
    \ STREME will not be run"
  type: boolean?
  inputBinding:
    prefix: -streme-nmotifs
...
- id: in_fimo_skip
  ...
  inputBinding:
    prefix: -fimo-skip
- id: in_dnarna_sequences_converted
  doc: '-dna2rna                  : input DNA sequences will be converted to RNA'
  type: string
  inputBinding:
    position: 0
outputs:
- id: out_stdout
  ...
  type: stdout
- id: out_dir_output_failing
  doc: '<dir>   : output to the specified directory, failing if the directory exists'
  type: Directory?
  outputBinding:
    glob: $(inputs.in_dir_output_failing)
- id: out_oc
  doc: '<dir>   : output to the specified directory, overwriting if the directory
    exists'
  type: Directory?
