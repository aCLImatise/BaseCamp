...
- id: in_in
  doc: "*                      Input file in mzXML or mzData format.\nNote: In mode\
    \ 'inspect_out' an Inspect results (txt) file is read. (valid formats: 'mzXML',\
    \ 'mzData', 'txt')"
  type: File?
  inputBinding:
    prefix: -in
- id: in_out
  doc: "*                     Output file in idXML format.\nNote: In mode 'inspect_in'\
    \ an Inspect input file is written as txt. (valid formats: 'idXML', 'txt')"
  type: File?
  inputBinding:
    prefix: -out
- id: in_inspect_in
...
- id: in_inspect_output
  doc: "Name for the output file of Inspect (may only be used in a full run) (valid\
    \ formats: 'txt')"
  type: File?
  inputBinding:
    prefix: -inspect_output
- id: in_inspect_input
  doc: "Name for the input file of Inspect (may only be used in a full run) (valid\
    \ formats: 'txt')"
  type: File?
  inputBinding:
