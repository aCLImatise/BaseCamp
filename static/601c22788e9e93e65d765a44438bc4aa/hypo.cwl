...
inputs:
- id: in_reads_short
  doc: "Input file name containing reads (in fasta/fastq format; can be compressed).\
    ...
    \ CIGAR information).\n-c, --coverage-short <int>\nApproximate mean coverage of\
    \ the short reads.\n-s, --size-ref <str>\nApproximate size of the genome (a number;\
    \ could be followed by units k/m/g; e.g. 10m, 2.3g)."
  type: long
  inputBinding:
    prefix: --reads-short
- id: in_bam_lr
  doc: "Input file name containing the alignments of long reads against the draft\
    ...
    Number of contigs to be processed in one batch. Lower value means less memory\
    ...
    \ CCS reads)\n[Default] sr.\n-m, --match-sr <int>\nScore for matching bases for\
    \ short reads.\n[Default] 5.\n-x, --mismatch-sr <int>\nScore for mismatching bases\
    \ for short reads.\n[Default] -4.\n-g, --gap-sr <int>\nGap penalty for short reads\
    \ (must be negative).\n[Default] -8.\n-M, --match-lr <int>\nScore for matching\
    \ bases for long reads.\n[Default] 3.\n-X, --mismatch-lr <int>\nScore for mismatching\
    \ bases for long reads.\n[Default] -5.\n-G, --gap-lr <int>\nGap penalty for long\
    \ reads (must be negative).\n[Default] -4.\n-n, --ned-th <int>\nThreshold for\
    \ Normalised Edit Distance of long arms allowed in a window (in %). Higher number\
    \ means more arms allowed which may slow down the execution.\n[Default] 20.\n\
    -q, --qual-map-th <int>\nThreshold for mapping quality of reads. The reads with\
    \ mapping quality below this threshold will not be taken into consideration.\n\
    [Default] 2.\n-i, --intermed\nStore or use (if already exist) the intermediate\
