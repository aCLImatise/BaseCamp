...
id: ../../../../home/ubuntu/BiocondaCli/spacepharer_predictmatch.cwl
inputs:
- id: comp_bias_corr
...
- id: add_string_convert
  ...
  inputBinding:
    prefix: -a
- id: alignment_mode
  doc: 'How to compute the alignment: 0: automatic 1: only score and end_pos 2: also
    start_pos and cov 3: also seq.id 4: only ungapped alignment [2]'
  type: long
  inputBinding:
...
- id: list_matches_evalue
  doc: List matches below this E-value (range 0.0-inf) [200.000]
  type: double
  inputBinding:
    prefix: -e
- id: min_seq_id
...
- id: sens_steps
  ...
  inputBinding:
    prefix: --sens-steps
- id: simple_best_hit
  doc: Update the p-value by a single best hit, or by best and second best hits [1]
  type: boolean
  inputBinding:
...
- id: fmt
  ...
  inputBinding:
    prefix: --fmt
- id: report_pam
  doc: Report protospacer adjacent motifs up and downstream of hits [0,1] [1]
  type: long
  inputBinding:
    prefix: --report-pam
- id: sub_mat
