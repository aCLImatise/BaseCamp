...
task MsstitchPeptides {
  ...
  command <<<
    msstitch peptides \
      ...
      ~{if defined(total_proteome) then ("--totalproteome " +  '"' + total_proteome + '"') else ""}
  >>>
  runtime {
