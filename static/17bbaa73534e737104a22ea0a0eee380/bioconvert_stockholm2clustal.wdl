...
task BioconvertStockholm2clustal {
  input {
    Boolean? force
    String? verbosity
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{biopython,squizz}], --method [{biopython,squizz}] The method to use to do the conversion. (default: biopython)"
