...
task SplitSeqpySort {
  ...
  command <<<
    SplitSeq_py sort \
      ...
      ~{if defined(maximum_number_sequences) then ("-n " +  '"' + maximum_number_sequences + '"') else ""} \
  ...
  parameter_meta {
    ...
    maximum_number_sequences: "Maximum number of sequences in each new file.\\n(default: None)"
