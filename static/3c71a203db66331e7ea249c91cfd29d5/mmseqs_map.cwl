...
- id: in_comp_bias_corr
  doc: 0               correct for locally biased amino acid composition [0,1]
  type: boolean
  inputBinding:
...
- id: in_list_matches_fraction
  ...
  inputBinding:
    prefix: -c
- id: in_cov_mode
  doc: '2               0: coverage of query and target, 1: coverage of target, 2:
...
- id: in_no_preload
  ...
  inputBinding:
    prefix: --no-preload
- id: in_re_score_mode
  doc: '2               Rescore diagonal with: 0: Hamming distance, 1: local alignment
