...
task Blfastq2fasta {
  ...
  parameter_meta {
    specify_multiple_input_files: "specify multiple FASTQ input files"
    specify_multiple_corresponding_output_files: "specify multiple (corresponding) FASTA output files"
    specify_multiple_corresponding_qual_files: "specify multiple (corresponding) QUAL output files"
