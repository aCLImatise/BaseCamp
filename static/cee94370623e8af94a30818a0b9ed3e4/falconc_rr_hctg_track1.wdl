...
task FalconcRrhctgtrack1 {
  ...
  parameter_meta {
    ...
    cli_gen_erated: "help"
    phased_read_file: "-r=, --read-to-contig-map=  string  \\\"./4-quiver/read_maps/read_to_contig_map\\\"                       set"
    read_to_contig_map: "--rawread-ids=              string  \\\"./2-asm-falcon/read_maps/dump_rawread_ids/rawread_ids\\\"         set rawread_ids"
  }
  output {
