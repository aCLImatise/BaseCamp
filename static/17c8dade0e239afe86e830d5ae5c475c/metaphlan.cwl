...
- id: in_force
  ...
  inputBinding:
    prefix: --force
- id: in_bowtie_two_db
  doc: Folder containing the MetaPhlAn database.[default /usr/local/lib/python3.8/site-packages/metaphlan/metaphlan_databases]
  type: long?
  inputBinding:
    prefix: --bowtie2db
- id: in_index
...
- id: in_bowtie_two_out
  ...
  inputBinding:
    prefix: --bowtie2out
- id: in_min_mapq_val
  doc: Minimum mapping quality value (MAPQ) [default 5]
  type: long?
  inputBinding:
    prefix: --min_mapq_val
- id: in_no_map
