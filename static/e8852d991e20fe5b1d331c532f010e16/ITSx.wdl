...
task ITSx {
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/itsx:1.1.2--0"
  }
  parameter_meta {
    ...
    search_eval: ": The E-value cutoff used in the HMMER search, high numbers may slow down the process, cannot be used with the --search_score option, default is 0.01"
    search_score: ": The score cutoff used in the HMMER search, low numbers may slow down the process, cannot be used with the --search_eval option, default is to used E-value cutoff, not score"
