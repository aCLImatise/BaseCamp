...
- id: in_less_redundant
  doc: If given, output a subset of metrics that should be less redundant. If this
    flag is used, the same flag should be passed to mkarv when making the viewer.
  type: boolean?
  inputBinding:
