...
task ParseHeaderspyDelete {
  input {
    ...
    Boolean? fast_a
    String? delim
    Array[String] list_delete_default
  }
  command <<<
    ParseHeaders_py delete \
      ...
      ~{if defined(list_delete_default) then ("-f " +  '"' + list_delete_default + '"') else ""}
  >>>
  runtime {
    docker: "None"
  }
  parameter_meta {
    ...
    list_delete_default: "List of fields to delete. (default: None)\\n"
  }
  output {
