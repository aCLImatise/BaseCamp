...
task Perldoc {
  ...
  command <<<
    perldoc \
      ...
      ~{if defined(var_12) then ("-d " +  '"' + var_12 + '"') else ""} \
      ~{if defined(o) then ("-o " +  '"' + o + '"') else ""} \
      ~{if defined(var_14) then ("-M " +  '"' + var_14 + '"') else ""} \
      ~{if defined(optionvalue) then ("-w " +  '"' + optionvalue + '"') else ""} \
