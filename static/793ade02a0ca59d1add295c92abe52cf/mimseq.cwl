...
- id: in_no_cca_analysis
  doc: "Disable analysis of 3'-CCA ends. When enabled, this\ncalculates proportions\
    \ of CC vs CCA ending reads per\ncluster and performs DESeq2 analysis. Useful\
...
- id: in_no_snp_tolerance
  doc: "Disable GSNAP SNP-tolerant read alignment, where known\nmodifications from\
...
- id: in_min_cov
  doc: "coverage per cluster\nMinimum coverage per cluster required to include this\n\
    ...
    \ DESeq2. Default = 0.0005 (0.05% mapped\nreads)."
  type: long?
  inputBinding:
    prefix: --min-cov
- id: in_max_multi
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/mimseq:0.3.3.2--pyhdfd78af_0
cwlVersion: v1.1
baseCommand:
- mimseq
