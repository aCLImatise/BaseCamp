...
- id: in_request_file_path
  doc: "[p]ath: string\npath to store request files to"
  type: boolean?
  inputBinding:
    prefix: --request-file-path
- id: in_request_file_format
  doc: "[f]ormat: string (default: #t.dump)\nrequest file name format"
  type: boolean?
  inputBinding:
    prefix: --request-file-format
