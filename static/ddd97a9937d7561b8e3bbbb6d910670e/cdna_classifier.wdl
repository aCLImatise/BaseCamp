...
task CdnaClassifier.py {
  input {
    ...
    String? file_hmms_none
    String? file_specify_configurations
    String? cutoff_parameter_autotuned
    Int? minimum_mean_base
    Int? minimum_segment_length
    String? report_pdf_cdnaclassifierreportpdf
    String? write_unclassified_reads
    String? write_fragments_failing
    String? write_rescued_reads
    String? write_statistics_file
    String? write_reads_filter
    String? approximate_number_reads
    String? number_samples_taken
    String? write_alignment_scores
    String? detection_method_phmm
    String? protocolspecific_read_rescue
    Boolean? keep_primers_trim
    String? number_threads_use
    String? maximum_number_reads
    String? stats_tab_separated
    String input_fast_x
  ...
  command <<<
    cdna_classifier.py \
      ...
      ~{true="-p" false="" keep_primers_trim} \
  ...
  parameter_meta {
    ...
    file_specify_configurations: "File to specify primer configurations for each direction (None)."
    ...
    approximate_number_reads: "Approximate number of reads used for tuning the cutoff parameter (10000)."
    number_samples_taken: "Number of samples taken when tuning cutoff parameter (30)."
    ...
    maximum_number_reads: "Maximum number of reads processed in each batch (1000000)."
