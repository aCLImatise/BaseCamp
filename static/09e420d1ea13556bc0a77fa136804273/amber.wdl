...
task Amber.py {
  ...
  parameter_meta {
    ...
    silent: "Silent mode"
    min_completeness: "Comma-separated list of min. completeness thresholds (default %: 50,70,90)"
    max_contamination: "Comma-separated list of max. contamination thresholds (default %: 10,5)"
    remove_genomes: "File with list of genomes to be removed"
    keyword: "Keyword in the second column of file with list of genomes to be removed (no keyword=remove all genomes in list)"
