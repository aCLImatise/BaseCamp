...
task Gcluster.pl {
  input {
    ...
    Boolean? interested_gene_file
    Boolean? start_at_map
  }
  command <<<
    Gcluster.pl \
      ~{true="--genbank_file_directory" false="" genbank_file_directory} \
      ~{true="--interested_gene_file" false="" interested_gene_file} \
      ~{true="--start_at_map" false="" start_at_map}
  >>>
  parameter_meta {
