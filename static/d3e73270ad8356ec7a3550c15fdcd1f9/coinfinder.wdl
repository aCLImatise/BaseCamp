...
task Coinfinder {
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/coinfinder:1.0.7--py38h69d548c_0"
  }
  parameter_meta {
    ...
    up_fil_threshold: "filter threshold for high-abundance data filtering (default: 1.0 i.e. any gene in >=100/% of genomes."
    fil_threshold: "Threshold for low-abundance data filtering (default: 0.05 i.e. any gene in <=5% of genomes."
