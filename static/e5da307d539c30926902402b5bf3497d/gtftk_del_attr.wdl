...
task GtftkDelAttr {
  ...
  parameter_meta {
    ...
    key: "comma-separated list of attribute names or a regular expression (see -r). (default: None)"
    reg_exp: "The key name is a regular expression. (default: False)"
    invert_match: "Delected keys are those not matching any of the specified key. (default: False)"
