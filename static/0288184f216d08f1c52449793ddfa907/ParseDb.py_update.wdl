...
task ParseDbpyUpdate {
  input {
    ...
    Array[String] values_replaced_default
  ...
  command <<<
    ParseDb_py update \
      ...
      ~{if defined(values_replaced_default) then ("-u " +  '"' + values_replaced_default + '"') else ""} \
  ...
  parameter_meta {
    ...
    values_replaced_default: "The values that will be replaced. (default: None)"
