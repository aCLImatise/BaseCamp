...
inputs:
- id: in_analysis
  doc: "CRISPR/Cas9 outcomes from batch deep sequencing data-\n_                 \
    \                            _\n'  )                                         \
    \ '  )\n.-'            _________________              .-'\n(____          | __\
    \    ___ __    |            (____\nC)|     \\         ||__) /\\ | /  |__||   \
    \      C)|     \\\n\\     /         ||__)/--\\| \\__|  ||           \\     /\n\
...
- id: in_use_legacy_insertion_quantification
  doc: "If set, the legacy insertion quantification method\nwill be used (i.e. with\
    \ a 1bp quantification window,\nindels at the cut site and 1bp away from the cut\
    \ site\nwould be quantified). By default (if this parameter is\nnot set) with\
    \ a 1bp quantification window, only\ninsertions at the cut site will be quantified.\n\
    (default: False)"
  type: boolean?
  inputBinding:
    prefix: --use_legacy_insertion_quantification
...
- id: in_bam_chr_loc
  ...
  inputBinding:
    prefix: --bam_chr_loc
- id: in_batch_settings
  doc: "Settings file for batch. Must be tab-separated text\nfile. The header row\
    \ contains CRISPResso parameters\n(e.g., fastq_r1, fastq_r2, amplicon_seq, and\
    \ other\noptional parameters). Each following row sets\nparameters for an additional\
    \ batch. (default: None)"
  type: File?
  inputBinding:
    prefix: --batch_settings
- id: in_skip_failed
  doc: "Continue with batch analysis even if one sample fails\n(default: False)"
  type: boolean?
  inputBinding:
    prefix: --skip_failed
- id: in_min_reads_for_inclusion
  doc: "Minimum number of reads for a batch to be included in\nthe batch summary (default:\
    \ 0)"
  type: long?
  inputBinding:
    prefix: --min_reads_for_inclusion
- id: in_n_processes
  doc: "Specify the number of processes to use for\nquantification. Please use with\
    \ caution since\nincreasing this parameter will increase the memory\nrequired\
    \ to run CRISPResso. (default: 1)"
  type: long?
  inputBinding:
    prefix: --n_processes
- id: in_batch_output_folder
  doc: "Directory where batch analysis output will be stored\n(default: None)"
  type: Directory?
  inputBinding:
...
- id: out_batch_output_folder
  doc: "Directory where batch analysis output will be stored\n(default: None)"
  type: Directory?
  outputBinding:
    glob: $(inputs.in_batch_output_folder)
hints:
