...
task BioconvertNexus2clustal {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{biopython,goalign,squizz}], --method [{biopython,goalign,squizz}] The method to use to do the conversion. (default: goalign)"
