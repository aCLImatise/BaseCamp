...
- id: in_mapper_param
  doc: "any parameter that could be passed to the GEM, BOWTIE2 or HISAT2\nmapper.\
    ...
    \ indel length to 10, (in GEM v2 it would be: -e 0.05\n--max-big-indel-length\
    \ 10), here we could write: \"--mapper_param\ne:0.05 max-big-indel-length:10\"\
    . For BOWTIE2, GEM3 and HISAT2 you\ncan also pass directly the parameters enclosed\
