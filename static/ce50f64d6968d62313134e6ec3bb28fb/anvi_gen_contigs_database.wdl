...
task Anvigencontigsdatabase {
  ...
  command <<<
    anvi_gen_contigs_database \
      ...
      ~{if (skip_predict_frame) then "--skip-predict-frame" else ""}
  >>>
  runtime {
  ...
  parameter_meta {
    ...
    output_db_path: "Output file path for the new database. (default:\\nCONTIGS.db)"
