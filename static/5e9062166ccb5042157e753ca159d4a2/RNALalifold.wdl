...
task RNALalifold {
  ...
  >>>
  parameter_meta {
    span: "Set the maximum allowed separation of a base  pair to span. I.e. no pairs (i,j) with  j-i>span will be allowed. (default=`70')"
    csv: "Create comma seperated output (csv) (default=off)"
    part_func: "[=INT]          Calculate the partition function and base  pairing probability matrix in addition to the  mfe structure.  (default=`1')"
