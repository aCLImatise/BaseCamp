...
- id: in_bound_heuristic
  doc: ''
  type: string
  inputBinding:
    prefix: --BOUND_HEURISTIC
...
- id: in_bounds_only
  ...
  inputBinding:
    prefix: --BOUNDS_ONLY
- id: in_no_multi_event
  doc: ''
  type: boolean
  inputBinding:
    prefix: --NO_MULTI_EVENT
- id: in_results
  doc: ''
  type: File
  inputBinding:
...
- id: in_get_values
  ...
  inputBinding:
    prefix: --GET_VALUES
- id: in_no_interval_selection
  doc: ''
  type: boolean
  inputBinding:
    prefix: --NO_INTERVAL_SELECTION
- id: in_read_depth_file
  doc: ''
  type: File
  inputBinding:
    prefix: --READ_DEPTH_FILE
- id: in_graph_format
