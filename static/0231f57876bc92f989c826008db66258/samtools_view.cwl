...
- id: in_only_include_reads_read_str
  ...
  inputBinding:
    prefix: -r
- id: in_only_include_reads_read_group
  doc: only include reads with read group listed in FILE [null]
  type: File?
  inputBinding:
    prefix: -R
- id: in_only_include_reads_read_name
  doc: only include reads with read name listed in FILE [null]
  type: File?
  inputBinding:
    prefix: -N
- id: in_only_include_reads_tag
...
- id: in_only_exclude_reads
  ...
  inputBinding:
    prefix: -G
- id: in_only_include_reads_matching
  doc: only include reads matching the filter expression [null]
  type: string?
  inputBinding:
    prefix: -e
