...
- id: in_convert_gvc_f_truth
  doc: "Convert the truth set from genome VCF format to a VCF\nbefore processing."
  type: boolean?
  inputBinding:
    prefix: --convert-gvcf-truth
- id: in_convert_gvc_f_query
  doc: "Convert the query set from genome VCF format to a VCF\nbefore processing."
  type: boolean?
  inputBinding:
