...
task BuildCellOntologyDictR {
  ...
  parameter_meta {
    ...
    condensed_sd_rf: "Boolean: is the provided SDRF file in a condensed form?\\nDefault: TRUE"
    barcode_col_name: "Name of the barcode column in SDRF files (must be identical\\nacross all files)"
    cell_label_col_name: "Name of the cell label column in SDRF files\\n(must be identical across all files)"
    cell_ontology_col_name: "Name of the cell ontology terms column in SDRF files\\n(must be identical across all files)"
