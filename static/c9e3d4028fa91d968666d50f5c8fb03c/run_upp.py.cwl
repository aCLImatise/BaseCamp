...
- id: in_only_consider_nmin
  doc: "\"Nmin Nmax\", --full_length_range \"Nmin Nmax\"\nOnly consider sequences\
    \ with lengths within Nmin and\nNmax"
  type: boolean?
  inputBinding:
    prefix: -R
...
- id: in_tempdir
  ...
  inputBinding:
    prefix: --tempdir
- id: in_rem_temp
  doc: 'Remove tempfile directory. [default: disabled]'
  type: boolean?
  inputBinding:
    prefix: --remtemp
- id: in_output
...
- id: in_molecule
  ...
  inputBinding:
    prefix: --molecule
- id: in_ignore_overlap
  doc: "When a query sequence has the same name as a backbone\nsequence, ignore the\
    \ query sequences and keep the\nbackbone sequence[default: False]"
  type: boolean?
  inputBinding:
    prefix: --ignore-overlap
- id: in_sequence_file
...
- id: in_alignment
  ...
  inputBinding:
    prefix: --alignment
- id: in_back_translation
  doc: "Fasta file containing unaligned DNA sequences\ncorresponding every reference\
    \ and query sequence\n[default: None]"
  type: File?
  inputBinding:
    prefix: --backtranslation
- id: in_cpu
