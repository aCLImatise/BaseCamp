...
task BioconvertTsv2csv {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{pandas,python,python_v2}], --method [{pandas,python,python_v2}] The method to use to do the conversion. (default: python)"
