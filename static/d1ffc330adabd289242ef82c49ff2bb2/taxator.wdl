...
task Taxator {
  input {
    ...
    Boolean? arg_query_sequences_created
  ...
  parameter_meta {
    ...
    arg_query_sequences_created: "[ --query-sequences-index ] arg query sequences FASTA index, for\\nout-of-memory operation; is created if not\\nexisting"
    ...
    arg_devnull_specify: "[ --logfile ] arg (=/dev/null)  specify name of file for logging\\n(appending lines)\\n"
