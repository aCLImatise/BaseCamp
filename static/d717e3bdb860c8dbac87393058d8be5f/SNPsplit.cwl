...
- id: in_snp_file
  ...
  inputBinding:
    prefix: --snp_file
- id: in_paired
  doc: 'Paired-end mode. (Default: AUTO-DETECT).'
  type: boolean?
  inputBinding:
    prefix: --paired
- id: in_outdir
...
- id: in_sam
  ...
  inputBinding:
    prefix: --sam
- id: in_skip_tag_two_sort
  doc: "Carry out the allele-tagging process, and exit afterwards. This might be desirable\
    \ when using SNPsplit in\npipelining systems, such as Nextflow, when a deduplication\
    \ step is to be added following allele tagging."
  type: boolean?
  inputBinding:
    prefix: --skip_tag2sort
outputs:
- id: out_stdout
