...
- id: in_required_prefix_output
  ...
  inputBinding:
    prefix: -p
- id: in_optional_name_fasta
  doc: (Optional) Name of fasta header. By default, the prefix is used to create the
    fasta header in the following format, Consensus_<prefix>_threshold_<frequency-threshold>_quality_<minimum-quality>
  type: boolean?
  inputBinding:
    prefix: -i
- id: in_var_7
