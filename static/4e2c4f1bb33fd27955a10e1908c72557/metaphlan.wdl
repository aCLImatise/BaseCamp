...
task Metaphlan {
  ...
  parameter_meta {
    ...
    bowtie_two_db: "Folder containing the MetaPhlAn database.[default /usr/local/lib/python3.7/site-packages/metaphlan/metaphlan_databases]"
    index: "Specify the id of the database version to use. If \\\"latest\\\", MetaPhlAn will get the latest version. If the database\\nfiles are not found on the local MetaPhlAn installation they\\nwill be automatically downloaded [default latest]"
