...
task FusionFinder.py {
  ...
  parameter_meta {
    ...
    cluster_report_csv: "cluster_report.csv, optional, if given will generate count info."
    dun_merge_five_shorter: "Don't collapse shorter 5' transcripts (default: turned off)"
    min_locus_coverage: "Minimum per-locus coverage in percentage (default: 0.05)"
