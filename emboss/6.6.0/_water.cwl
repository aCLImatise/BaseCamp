...
id: ../../../../home/ubuntu/BiocondaCli/_water.cwl
inputs:
- id: gap_open
  doc: float      [10.0 for any sequence] The gap open penalty is the score taken
    ...
    sequences, and the EDNAFULL matrix for nucleotide sequences. (Number from 0.000
    to 100.000)
  type: boolean
  inputBinding:
    prefix: -gapopen
- id: gap_extend
  doc: float      [0.5 for any sequence] The gap extension penalty is added to the
    ...
    penalty to control gap scoring. (Number from 0.000 to 10.000)
  type: boolean
  inputBinding:
    prefix: -gapextend
outputs: []
