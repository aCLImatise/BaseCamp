...
id: ../../../../home/ubuntu/BiocondaCli/_fuzztran.cwl
inputs:
- id: pattern
  doc: "pattern    The standard IUPAC one-letter codes for the amino acids are used.\
    ...
    \ acids that are not accepted at a gven position. For example: {AM} stands for\
    \ any amino acid except Ala and Met. Each element in a pattern is separated from\
    \ its neighbor by a '-'. (Optional in fuzztran) Repetition of an element of the\
