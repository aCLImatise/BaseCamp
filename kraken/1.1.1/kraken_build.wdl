...
task KrakenBuild {
  ...
  parameter_meta {
    ...
    download_library: "Download partial library (TYPE = one of \"archaea\", \"bacteria\", \"plasmid\",  \"viral\", \"human\")"
    ...
    use_wget: "Use wget for downloading instead of RSYNC; used with --download-library/--standard"
