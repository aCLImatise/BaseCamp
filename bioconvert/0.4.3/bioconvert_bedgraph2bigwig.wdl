...
task BioconvertBedgraph2bigwig {
  input {
    Boolean? force
    String? verbosity
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{ucsc}], --method [{ucsc}] The method to use to do the conversion. (default: ucsc)"
    show_methods: "A converter may have several methods (default: False)"
    chrom_sizes: "a two-column file/URL: <chromosome name> <size in bases> (default: None)"
