...
task BioconvertGenbank2fasta {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{biopython,python,squizz}], --method [{biopython,python,squizz}] The method to use to do the conversion. (default: biopython)"
