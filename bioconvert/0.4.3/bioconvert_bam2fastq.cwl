...
id: ../../../../home/ubuntu/BiocondaCli/bioconvert_bam2fastq.cwl
inputs:
- id: force
...
- id: method_use_conversion
  doc: '[{bedtools,samtools}], --method [{bedtools,samtools}] The method to use to
    do the conversion. (default: samtools)'
  type: boolean
  inputBinding:
    prefix: -m
- id: show_methods
