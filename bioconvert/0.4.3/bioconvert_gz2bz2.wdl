...
task BioconvertGz2bz2 {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{gunzip_bzip2,pigz_pbzip2,python}], --method [{gunzip_bzip2,pigz_pbzip2,python}] The method to use to do the conversion. (default: pigz_pbzip2)"
