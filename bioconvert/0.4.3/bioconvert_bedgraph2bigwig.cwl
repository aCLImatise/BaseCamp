...
id: ../../../../home/ubuntu/BiocondaCli/bioconvert_bedgraph2bigwig.cwl
inputs:
- id: force
...
- id: method_use_conversion
  doc: '[{ucsc}], --method [{ucsc}] The method to use to do the conversion. (default:
    ucsc)'
  type: boolean
  inputBinding:
    prefix: -m
- id: show_methods
  ...
  inputBinding:
    prefix: --show-methods
- id: chrom_sizes
  doc: 'a two-column file/URL: <chromosome name> <size in bases> (default: None)'
  type: string
  inputBinding:
    prefix: --chrom-sizes
- id: input_file
