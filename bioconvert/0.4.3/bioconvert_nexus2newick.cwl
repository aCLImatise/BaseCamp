...
id: ../../../../home/ubuntu/BiocondaCli/bioconvert_nexus2newick.cwl
inputs:
- id: force
...
- id: method_use_conversion
  doc: '[{biopython,gotree}], --method [{biopython,gotree}] The method to use to do
    the conversion. (default: gotree)'
  type: boolean
  inputBinding:
    prefix: -m
- id: show_methods
