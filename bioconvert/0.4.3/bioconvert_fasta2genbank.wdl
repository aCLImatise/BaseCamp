...
task BioconvertFasta2genbank {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{bioconvert,biopython,squizz}], --method [{bioconvert,biopython,squizz}] The method to use to do the conversion. (default: bioconvert)"
