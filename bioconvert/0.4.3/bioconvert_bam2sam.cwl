...
id: ../../../../home/ubuntu/BiocondaCli/bioconvert_bam2sam.cwl
inputs:
- id: force
...
- id: method_use_conversion
  doc: '[{pysam,sambamba,samtools}], --method [{pysam,sambamba,samtools}] The method
    to use to do the conversion. (default: samtools)'
  type: boolean
  inputBinding:
    prefix: -m
- id: show_methods
