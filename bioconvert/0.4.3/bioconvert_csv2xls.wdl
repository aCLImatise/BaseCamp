...
task BioconvertCsv2xls {
  ...
  parameter_meta {
    ...
    method_use_conversion: "[{pandas,pyexcel}], --method [{pandas,pyexcel}] The method to use to do the conversion. (default: pandas)"
    show_methods: "A converter may have several methods (default: False)"
    sheet_name: "The name of the sheet to create (default: Sheet 1)"
