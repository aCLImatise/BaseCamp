...
task FastqExtractUMI {
  ...
  parameter_meta {
    ...
    cut_one: "Number of bases from the head of read 1 to use as UMI. Default value: '0'"
    cut_two: "Number of bases from the head of read 2 to use as UMI. Default value: '0'"
