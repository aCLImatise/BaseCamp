...
task BedToBigBed {
  ...
  command <<<
    bedToBigBed \
      ...
      ~{if defined(you_nonstandard_fields) then ("-as " +  '"' + you_nonstandard_fields + '"') else ""} \
  ...
  parameter_meta {
    ...
    you_nonstandard_fields: "- If you have non-standard \\\"bedPlus\\\" fields, it's great to put a definition\\nof each field in a row in AutoSql format here."
