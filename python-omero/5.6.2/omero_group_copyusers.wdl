...
task OmeroGroupCopyusers {
  ...
  >>>
  parameter_meta {
    as_owner: "Copy the group owners only"
    ...
    from_group: "ID or name of the source group whose users will be copied"
    to_group: "ID or name of the target group which will have new users added"
