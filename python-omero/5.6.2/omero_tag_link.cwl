...
id: omero_tag_link.cwl
inputs:
- id: object
  doc: The object to link to. Should be of form <object_type>:<object_id>
  type: string
  inputBinding:
    position: 0
- id: tag_id
  doc: The tag annotation ID
  type: string
  inputBinding:
    position: 1
- id: omer_o_userdir
...
- id: omer_o_password
  ...
  inputBinding:
    position: 3
- id: admin
  doc: Perform action as an administrator
  type: boolean
  inputBinding:
    prefix: --admin
- id: no_page
  doc: Disable pagination
  type: boolean
  inputBinding:
    prefix: --nopage
- id: create
