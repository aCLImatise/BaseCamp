...
task ExpConvertEntrez2gene.py {
  ...
  command <<<
    exp_convert_entrez2gene.py \
      ...
      ~{true="--strip-affy-suffix" false="" strip_affy_suffix} \
  ...
  parameter_meta {
    ...
    gene_file: "The gene file (e.g., generated by the ensembl_extract_protein_coding_genes.py script)."
    entrez_two_gene_file: "The entrez2gene file (.e.g., generated by the ncbi_extract_entrez2gene.py script)."
    output_file: "The output file."
    strip_affy_suffix: "Strip the suffix \"_at\" from all Entrez IDs. (For use in affymetrix microarray pipeline.)"
