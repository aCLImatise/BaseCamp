...
- id: int_matching_score
  doc: INT    Matching score. [-1]
  type: boolean
  inputBinding:
    prefix: -A
- id: int_mismatch_penalty
...
- id: lj_min_ratio
  ...
  inputBinding:
    prefix: --lj-min-ratio
- id: int_length_changes
  doc: INT    Max intron length (changes -r). [-1]
  type: boolean
  inputBinding:
    prefix: -G
- id: int_cost_noncanonical
