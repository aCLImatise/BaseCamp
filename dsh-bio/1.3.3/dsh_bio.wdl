...
task DshBio {
  input {
    ...
    String compress_gfa_one
    String compress_gfa_two
    String compress_gff_three
    String compress_sam
    String compress_vcf
    ...
    String extract_fast_q_by_length
    String fast_a_to_fast_q
    String fast_q_description
    String fast_q_sequence_length
    String fast_q_to_fast_a
    String filter_bed
    String filter_fast_a
    String filter_fast_q
    String filter_gfa_one
    String filter_gfa_two
    String filter_gff_three
    String filter_sam
    String filter_vcf
    String gfa_one_to_gfa_two
    Int interleave_fast_q
    String reassemble_paths
    String remap_phase_set
    String split_bed
    String split_fast_a
    String split_fast_q
    String split_gff_three
  ...
  parameter_meta {
    ...
    create_sequence_dictionary: "create a SequenceDictionary from sequences in FASTA format"
    ...
    fast_a_to_fast_q: "convert sequences in FASTA format to FASTQ format"
