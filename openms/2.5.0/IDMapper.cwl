...
- doc: "M/z tolerance (in ppm or Da) for the matching of peptide identifications and\
    \ (consensus) features. Tolerance is understood as 'plus or minus x', so the matching\
    \ range increases by twice the given value. (default: '20.0' min: '0.0')"
  id: mz_tolerance
  inputBinding:
    prefix: -mz_tolerance
  type: string
...
- doc: "Source of m/z values for peptide identifications. If 'precursor', the precursor-m/z\
    ...
    \ avoid false-positive matches.) (default: 'peptide' valid: 'precursor', 'peptide')"
  id: mz_reference
  inputBinding:
    prefix: -mz_reference
  type: string
- doc: ":use_centroid_rt <choice>  Use the RT coordinates of the feature centroids\
  ...
  inputBinding:
    prefix: -feature
  type: boolean
- doc: ":use_centroid_mz <choice>  Use the m/z coordinates of the feature centroids\
    \ for matching, instead of the m/z ranges of the features/mass traces. (If you\
    \ choose 'peptide' as 'mz_reference', you should usually set this flag to avoid\
    \ false-positive matches.) (default: 'true' valid: 'true', 'false')"
  id: feature
  inputBinding:
    prefix: -feature
  type: boolean
