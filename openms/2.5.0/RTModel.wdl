...
task RTModel {
  ...
  command <<<
    RTModel \
      ...
      ~{true="-first_dim_rt" false="" first_dim_rt} \
  ...
  >>>
  parameter_meta {
    in: "This is the name of the input file (RT prediction). It is assumed that the file type is idXML. Alternatively you can provide a .txt file having a sequence and the corresponding rt per line. (valid formats: 'idXML', 'txt')"
    in_positive: "Input file with positive examples (peptide separation prediction) (valid formats: 'idXML')"
    in_negative: "Input file with negative examples (peptide separation prediction) (valid formats: 'idXML')"
    ...
    svm_type: "The type of the svm (NU_SVR or EPSILON_SVR for RT prediction, automatically set to C_SVC for separation prediction) (default: 'NU_SVR' valid: 'NU_SVR', 'NU_SVC', 'EPSILON_SVR', 'C_SVC')"
    ...
    max_std: "Max standard deviation for a peptide to be included (if there are several ones for one peptide string)(median is taken) (default: '10.0' min: '0.0')"
    k_mer_length: "K_mer length of the POBK (default: '1' min: '1')"
    sigma: "Sigma of the POBK (default: '5.0')"
    total_gradient_time: "The time (in seconds) of the gradient (only for RT prediction) (default: '1.0' min: '1.0e-05')"
