...
task CruxAdapter {
  ...
  parameter_meta {
    ...
    enzyme: "The enzyme used for peptide digestion. (default: 'trypsin' valid: 'custom-enzyme', 'arg-c', 'chymotrypsin', 'asp-n', 'cyanogen-bromide', 'clostripain', 'elastase-trypsin-chymotrypsin', 'no-enzyme', 'lys-c', 'lys-n', 'trypsin/p', 'elastase', 'iodosobenzoate', 'staph-protease', 'proline-endopeptidase', 'glu-c', 'pepsin-a', 'trypsin')"
