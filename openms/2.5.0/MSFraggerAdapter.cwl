...
- doc: ":precursor_mass_tolerance <precursor_mass_tolerance>           Precursor mass\
    \ tolerance (window is +/- this value) (default: '20.0' min: '0.0')"
  id: tolerance
  inputBinding:
    prefix: -tolerance
  type: boolean
...
- doc: ":search_enzyme_name <search_enzyme_name>                          Name of\
    \ the enzyme to be written to the pepXML file (default: 'Trypsin' valid: 'Glu-C+P',\
    \ 'PepsinA + P', 'cyanogen-bromide', 'Clostripa in/P', 'elastase-trypsin-chymotrypsin',\
...
- doc: ":mass_range_min <digest_mass_range_min>                           Min mass\
    \ of peptides to be generated (Da) (default: '500.0' min: '0.0')"
  id: digest
  inputBinding:
    prefix: -digest
  type: boolean
- doc: ":mass_range_max <digest_mass_range_max>                           Max mass\
    \ of peptides to be generated (Da) (default: '5000.0' min: '0.0')"
  id: digest
  inputBinding:
    prefix: -digest
  type: boolean
...
- doc: ":minimum_ratio <minimum_ratio>                                  Filters out\
    ...
    \ peak intensity (default: '0.0' min: '0.0'  max: '1.0')"
  id: spectrum
  inputBinding:
    prefix: -spectrum
  type: boolean
- doc: ":clear_mz_range_min <clear_mz_range_min>                        Removes peaks\
    ...
    \ (i.e. 0.0 150.0) (default: '0.0'  min: '0.0')"
  id: spectrum
  inputBinding:
    prefix: -spectrum
  type: boolean
...
- doc: ":zero_bin_mult_expect <zero_bin_mult_expect>                      Multiplies\
    ...
    \ 1 for boosting) (default: '1.0' min: '0.0')"
  id: search
  inputBinding:
    prefix: -search
  type: boolean
