...
- doc: 'Regions description file. A BED format file containing the regions to analyze,
    ...
    help for more details on these last 3 parameters) (default: None)'
  id: region_file
  inputBinding:
    prefix: --region_file
  type: string
- doc: 'A FASTA format reference file (for example hg19.fa for the human genome) (default:
    )'
  id: reference_file
  inputBinding:
...
- doc: 'Specify the number of processes to use for the quantification. Please use
    with caution since increasing this parameter will increase the memory required
