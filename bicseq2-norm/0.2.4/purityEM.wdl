...
task PurityEM {
  ...
  parameter_meta {
    ...
    m_ploidy: ": specify a rough upper bound of the ploidy number. A smaller value (e.g. 4) is suggested as a larger value will make the program quite slow"
    max_comp: ": specify the maximum number of component in the mixture of normal model; Default 15 this option will overload the option --mploidy; this is the default method"
