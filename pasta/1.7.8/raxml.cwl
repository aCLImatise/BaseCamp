...
- id: in_specify_exclude_name
  ...
  inputBinding:
    prefix: -E
- id: in_select_algorithm_analysis
...
- id: in_specify_file_name_need
  ...
  inputBinding:
    prefix: -g
- id: in_enable_mlbased_heuristicsby
  ...
  inputBinding:
    prefix: -G
- id: in_enable_mpbased_heuristicsby
...
- id: in_specify_one_multistate
  ...
  inputBinding:
    prefix: -K
- id: in_switch_estimation_individual
...
- id: in_specify_user_starting
  ...
  inputBinding:
    prefix: -t
- id: in_pthreads_version_specify
