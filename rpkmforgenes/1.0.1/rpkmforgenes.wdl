...
task Rpkmforgenes.py {
  input {
    String? by_output_file
    String? list_input_files
    String? by_annotation_file
    String? bigwig_file_alternatively
    String? no_three_utr
    ...
    String? min_qual
    String? max_nm
    String? list_sample_names
    String? number_files_process
    String? quite
  ...
  command <<<
    rpkmforgenes.py \
      ...
      ~{true="-readpresent" false="" read_present} \
