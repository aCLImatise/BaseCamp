...
id: ../../../../home/ubuntu/BiocondaCli/contigtax_assign.cwl
inputs:
- id: format
  doc: Type of file format for diamond results. blast=blast tabular output, 'contigtax'=blast
...
- id: taxid_map
  ...
  inputBinding:
    prefix: --taxidmap
- id: tax_dir
  doc: Directory specified during 'contigtax download taxonomy'. Defaults to taxonomy/.
  type: string
  inputBinding:
    prefix: --taxdir
- id: sqlite_db
...
- id: assign_ranks
  ...
  inputBinding:
    prefix: --assignranks
- id: report_ranks
  doc: Ranks to report in output. Defaults to superkingom phylum class order family
    genus species
  type: string[]
  inputBinding:
    prefix: --reportranks
