...
- id: add_noise
  ...
  inputBinding:
    prefix: --addnoise
- id: time_order
  doc: Time order for ODE solving (1 (default), 2 or 1,2). Order 2 is more precise
    but more time consuming. The value '1,2' makes to start solving the ODE with the
