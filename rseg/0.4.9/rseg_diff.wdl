...
task RsegDiff {
  input {
    ...
    String? mappedMappedReadLocationsA
    String? mappedMappedReadLocationsB
  }
  command <<<
    rseg-diff \
      ~{optionsOptions} \
      ...
      ~{true="-fg" false="" fgFg} \
      ~{true="-bg" false="" bgBg} \
      ~{true="-training-size" false="" trainingTrainingSize} \
      ...
      ~{mappedMappedReadLocationsA} \
      ~{mappedMappedReadLocationsB}
  >>>
}