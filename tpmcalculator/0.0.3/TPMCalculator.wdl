...
task TPMCalculator {
  ...
  parameter_meta {
    ...
    use_only_properly: "Use only properly paired reads. Default: No. Recommended for paired-end reads."
    ...
    extended_output_will: "Extended output. This will include transcript level TPM values. Default: No."
