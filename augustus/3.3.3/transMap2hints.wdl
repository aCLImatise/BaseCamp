...
task TransMap2hints.pl {
  input {
    ...
    String? ep_margin
    String? ip_cut_off
    String? u_trend_cut_off
    String? min_intron_len
    String? min_intron_len_utr
    String? start_stop_radius
    String? tss_tts_radius
    String? source
  }
  command <<<
    transMap2hints.pl \
  ...
  parameter_meta {
    ...
    ep_margin: "(default 18) each exon suggested by the input yields 3 exonpart hints: |             exon as suggested by transmap          | |  ep   |    ep       |   ep  | |ep_cutoff |       |   exon      |       | ep_cutoff | |    ep_margin     |   exon      |    ep_margin      |"
