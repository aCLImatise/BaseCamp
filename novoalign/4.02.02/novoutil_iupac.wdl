...
task NovoutilIupac {
  input {
    ...
    Boolean? replace_base_included
    Boolean? update_reference_changes
    Boolean? use_snp_files
    Int? sets_sample_based
    String snp_file
    String fast_a_files
    String bed_files
  }
