...
task CATContigs {
  ...
  >>>
  parameter_meta {
    _contigsfasta_path: ", --contigs_fasta  Path to contigs fasta file."
    ...
    _proteinsfasta_path: ", --proteins_fasta  Path to predicted proteins fasta file. If supplied, CAT will skip the protein prediction step."
    _diamondalignment_path: ", --diamond_alignment  Path to DIAMOND alignment table. If supplied, CAT will skip the DIAMOND alignment step and directly classify the contigs. A predicted proteins fasta file should also be supplied with argument [-p / --proteins]."
    path_to_prodigal: "Path to Prodigal binaries. Please supply if CAT can not find Prodigal."
    path_to_diamond: "Path to DIAMOND binaries. Please supply if CAT can not find DIAMOND."
