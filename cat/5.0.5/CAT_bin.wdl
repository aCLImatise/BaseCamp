...
task CATBin {
  ...
  parameter_meta {
    ...
    _proteinsfasta_path: ", --proteins_fasta  Path to predicted proteins fasta file. If supplied, BAT will skip the protein prediction step."
    _diamondalignment_path: ", --diamond_alignment  Path to DIAMOND alignment table. If supplied, BAT will skip the DIAMOND alignment step and directly classify the bin. A predicted proteins fasta file should also be supplied with argument [-p / --proteins]."
