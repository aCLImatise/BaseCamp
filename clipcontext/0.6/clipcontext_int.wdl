...
task ClipcontextInt {
  ...
  >>>
  parameter_meta {
    min_intron_ol: "Minimum intron overlap of a site to be reported as intron overlapping (intersectBed -f parameter) (default: 0.9)"
    ...
    tr: "Transcript sequence IDs list file to define intron regions"
    gtf: "Genomic annotations (hg38) GTF file (.gtf or .gtf.gz)"
    out: "CLIP peak regions overlapping with introns output BED file"
  }
}