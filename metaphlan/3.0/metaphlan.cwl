...
- id: output_file
  ...
  inputBinding:
    position: 1
- id: input_type
  doc: '. Two steps: first apply BowTie2 and then feed MetaPhlAn with the obtained
    sam:'
  type: boolean
  inputBinding:
    prefix: --input_type
- id: input_type
  doc: set whether the input is the FASTA file of metagenomic reads or  the SAM file
    of the mapping of the reads against the MetaPhlAn db. [default 'FASTQ']
  type: string
  inputBinding:
    prefix: --input_type
- id: force
  ...
  inputBinding:
    prefix: --force
- id: bowtie2db
  doc: Folder containing the MetaPhlAn database.[default /tmp/tmpw7g_o585/lib/python3.7/site-packages/metaphlan/metaphlan_databases]
  type: string
  inputBinding:
    prefix: --bowtie2db
- id: index
...
- id: stat
  doc: "Statistical approach for converting marker abundances into clade abundances\
    ...
    \ average at --stat_q quantile 'tavg_l' : trunated average of length-normalized\
