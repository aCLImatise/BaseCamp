...
id: ../../../../home/ubuntu/BiocondaCli/metaphlan.cwl
inputs:
- id: input_type_dot
  ...
  inputBinding:
    prefix: --input_type.
- id: input_type
  doc: set whether the input is the FASTA file of metagenomic reads or  the SAM file
...
- id: force
  ...
  inputBinding:
    prefix: --force
- id: bowtie_two_db
  doc: Folder containing the MetaPhlAn database.[default /tmp/tmphczlrijk/lib/python3.7/site-packages/metaphlan/metaphlan_databases]
  type: string
  inputBinding:
    prefix: --bowtie2db
- id: index
  doc: Specify the id of the database version to use. If "latest", MetaPhlAn will
    get the latest version. If the database files are not found on the local MetaPhlAn
    installation they will be automatically downloaded [default latest]
  type: string
  inputBinding:
    prefix: --index
- id: bt_two_ps
  doc: 'presets Presets options for BowTie2 (applied only when a FASTA file is provided)
