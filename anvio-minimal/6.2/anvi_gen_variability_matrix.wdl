...
task AnviGenVariabilityMatrix {
  input {
    ...
    Int? min_scatter
    String? min_ratio_of_competing_s_nts
    File? output_file
    String summary_dict
  }
  command <<<
