...
- id: git_sha1
  ...
  inputBinding:
    position: 1
- id: build_date
  doc: ': 2019-10-26/13:26:37'
  type: string
  inputBinding:
    position: 2
- id: build_system
  doc: ': Linux-5.0.0-1020-azure'
  type: string
  inputBinding:
    position: 3
- id: build_compiler
  doc: ': /opt/conda/conda-bld/gatb_1572096118930/_build_env/bin/x86_64-conda_cos6-linux-gnu-cc  (7.3.0)'
  type: string
  inputBinding:
    position: 4
- id: build_km_er_size
...
- id: solidity_custom
  doc: "(1 arg) :    when solidity-kind is cutom, specifies list of files where kmer\
