...
task GcloudServicemanagementGetiampolicy {
  input {
    Boolean? filter
    Int? limit
    Int? page_size
    Boolean? sort_by
    String synopsis
    String name_service_iam
  }
  command <<<
    gcloud service_management get_iam_policy \
      ~{synopsis} \
      ~{name_service_iam} \
  ...
  parameter_meta {
    ...
    synopsis: "SYNOPSIS"
    name_service_iam: "The name of the service whose IAM policy is to be described."
  }
  output {
