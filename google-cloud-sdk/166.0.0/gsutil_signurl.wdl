...
task GsutilSignurl {
  input {
    ...
    Boolean? specifies_duration_specified
  ...
  command <<<
    gsutil signurl \
      ...
      ~{if (specifies_duration_specified) then "-d" else ""} \
