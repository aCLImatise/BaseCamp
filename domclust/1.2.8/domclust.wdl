...
task Domclust {
  ...
  command <<<
    domclust \
      ...
      ~{if (cutoff_scoredistance_can) then "-c" else ""} \
      ~{if (ci) then "-ci" else ""} \
      ~{if (scoredistance_missing_relationships) then "-m" else ""} \
      ~{if (mr) then "-mr" else ""} \
      ~{if (cutoff_score_domain) then "-C" else ""} \
      ~{if (alignment_coverage_domain) then "-V" else ""} \
      ...
      ~{if (a_i) then "-ai" else ""} \
      ~{if (ao) then "-ao" else ""} \
      ~{if (use_tree_file) then "-t" else ""} \
      ~{if (restore_dump_file) then "-R" else ""} \
