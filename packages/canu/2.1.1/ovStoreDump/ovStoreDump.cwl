...
- id: in_mandatory_path_overlap
  ...
  inputBinding:
    prefix: -O
- id: in_overlaps
  doc: '[b[-e]]    a list of the overlaps involving a specific read (default)'
  type: boolean?
  inputBinding:
    prefix: -overlaps
- id: in_picture
  doc: '[b[-e]]    an ASCII picture of the overlaps relative to a read'
  type: boolean?
  inputBinding:
    prefix: -picture
- id: in_metadata
...
- id: in_erate_len
  ...
  inputBinding:
    prefix: -eratelen
- id: in_coverage
  doc: "[b[-e]]    one line per read, with some simple descriptive statistics on\n\
...
- id: in_prefix
  ...
  inputBinding:
    prefix: -prefix
- id: in_width
  doc: '* for -picture, the width of the overlaps picture'
  type: string?
  inputBinding:
    prefix: -width
- id: in_scores
  doc: '* for -picture, also report the score used for correction'
  type: boolean?
  inputBinding:
    prefix: -scores
- id: in_raw
