...
task KNeighborsCoefficient {
  ...
  parameter_meta {
    ...
    output_plot_path: "Path to the accuracy plot. Accepted formats: png."
    input_dataset_path: "Path to the input dataset. Accepted formats: csv."
    output_results_path: "Path to the accuracy values list. Accepted formats: csv.\\n"
  }
  output {
