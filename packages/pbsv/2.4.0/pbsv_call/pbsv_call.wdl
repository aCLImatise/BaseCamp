...
task PbsvCall {
  ...
  command <<<
    pbsv call \
      ...
      ~{if (preserve_non_acgt) then "--preserve-non-acgt" else ""} \
  ...
  parameter_meta {
    ...
    preserve_non_acgt: "Preserve non-ACGT in REF allele instead of replacing with N."
