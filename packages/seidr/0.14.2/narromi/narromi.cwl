...
- id: in__arg_file_containing_gene_names
  ...
  inputBinding:
    prefix: -g
- id: in_arg_simplex_method
  doc: "[ --algorithm ] arg (=simplex)     Method for linear programming\noptimisaton.\
    \ One of 'interior-point' or\n'simplex'."
  type: boolean?
  inputBinding:
    prefix: -m
- id: in_arg_alpha_cutoff
  doc: '[ --alpha ] arg (=0.05)            Alpha cutoff for MI selection.'
  type: boolean?
  inputBinding:
    prefix: -a
...
- id: in_force_overwrite_output
  ...
  inputBinding:
    prefix: -f
- id: in_arg_narromiscorestsvoutput_file
  doc: "[ --outfile ] arg (=narromi_scores.tsv)\nOutput file path"
  type: File?
  inputBinding:
    prefix: -o
- id: in_save_resume
...
- id: out_stdout
  ...
  type: stdout
- id: out_arg_narromiscorestsvoutput_file
  doc: "[ --outfile ] arg (=narromi_scores.tsv)\nOutput file path"
  type: File?
  outputBinding:
    glob: $(inputs.in_arg_narromiscorestsvoutput_file)
hints:
