...
task Panaroo {
  ...
  parameter_meta {
    ...
    edge_support_threshold: "minimum support required to keep an edge that has been\\nflagged as a possible mis-assembly"
