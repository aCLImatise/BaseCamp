...
id: LCA.cwl
inputs:
- id: in_assignments_ref_database
...
- id: in_id
  ...
  inputBinding:
    prefix: -id
- id: in_cover
  doc: '[0-1] fraction of query coverage required to accept a hit. Default=0.5'
  type: boolean?
  inputBinding:
    prefix: -cover
outputs:
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/lca:0.21--he513fc3_0
cwlVersion: v1.1
baseCommand:
- LCA
