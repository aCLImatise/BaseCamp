...
- id: in_arg_max_breakpoint
  ...
  inputBinding:
    prefix: -b
- id: in_arg_min_reciprocal
  doc: '[ --ratio ] arg (=0.800000012)     min. reciprocal overlap'
  type: boolean?
  inputBinding:
    prefix: -r
- id: in_s
...
- id: in_arg_max_distance
  ...
  inputBinding:
    prefix: -t
- id: in_report_contained_genes
  doc: "[ --contained ]                    report contained genes (useful for CNVs\n\
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/sansa:0.0.8--hf925130_1
cwlVersion: v1.1
baseCommand:
- sansa
- annotate
