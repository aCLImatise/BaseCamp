...
task CdnaClassifierpy {
  ...
  command <<<
    cdna_classifier_py \
      ...
      ~{if defined(use_primer_sequences) then ("-k " +  '"' + use_primer_sequences + '"') else ""} \
  ...
  >>>
  runtime {
    docker: "quay.io/biocontainers/pychopper:2.5.0--py_0"
  }
  parameter_meta {
    ...
    use_primer_sequences: "Use primer sequences from this kit (PCS109)."
