...
task ChicAggregateStatistic {
  ...
  parameter_meta {
    ...
    out_filename_suffix: "File name suffix to save the result (Default:\\n_aggregate_target.txt)."
    ...
    output_folder: "Output folder containing the files (Default:\\naggregatedFiles)."
    write_filenames_to_file: "(Default: aggregatedFilesBatch.txt)."
