...
- id: in_sensitivity_faster_fast
  doc: 'Sensitivity: 1.0 faster; 4.0 fast; 7.5 sensitive [2.000]'
  type: double?
  inputBinding:
    prefix: -s
...
- id: in_list_matches_evalue
  doc: List matches below this E-value (range 0.0-inf) [1.000E+00]
  type: double?
  inputBinding:
    prefix: -e
- id: in_min_seq_id
...
- id: in_tax_output_mode
  doc: '0: output LCA, 1: output alignment 2: output both [0]'
  type: long?
  inputBinding:
