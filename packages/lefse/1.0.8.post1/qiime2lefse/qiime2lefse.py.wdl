...
task Qiime2lefsepy {
  input {
    ...
    String? attribute_attribute_use_as
    String? input_file
  ...
  command <<<
    qiime2lefse_py \
      ...
      ~{if defined(attribute_attribute_use_as) then ("-u " +  '"' + attribute_attribute_use_as + '"') else ""}
  >>>
  parameter_meta {
    ...
    attribute_attribute_use_as: "attribute  the attribute to use as subject"
    input_file: ""
    metadata_file: ""
  }
  output {
