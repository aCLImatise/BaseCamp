...
task Vcf2mafpl {
  ...
  parameter_meta {
    ...
    ref_fast_a: "Reference FASTA file [~/.vep/homo_sapiens/101_GRCh37/Homo_sapiens.GRCh37.dna.toplevel.fa.gz]"
    ...
    cache_version: "Version of offline cache to use with VEP (e.g. 75, 91, 101) [Default: Installed version]"
