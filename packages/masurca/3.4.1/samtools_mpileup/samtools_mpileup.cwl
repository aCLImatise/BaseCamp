...
- id: in_list_input_bam
  ...
  inputBinding:
    prefix: -b
- id: in_parameter_adjusting_disable
...
- id: in_max_perbam_depth
  ...
  inputBinding:
    prefix: -d
- id: in_recalculate_extended_baq
...
- id: in_output_persample_strand
  ...
  inputBinding:
    prefix: -S
- id: in_generate_uncompress_output
  doc: generate uncompress BCF output
  type: boolean?
  inputBinding:
    prefix: -u
- id: in_phredscaled_extension_seq
