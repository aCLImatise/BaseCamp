...
task GetOrganelleFromReadspy {
  ...
  command <<<
    get_organelle_from_reads_py \
      ...
      ~{if defined(flag_followed_be) then ("-F " +  '"' + flag_followed_be + '"') else ""} \
  ...
  parameter_meta {
    ...
    phred_offset: "Phred offset for spades-hammer. Default: GetOrganelle-\\nautodetect"
