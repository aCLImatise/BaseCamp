...
- id: in_no_enable_unannotated
  doc: "Enable mapping uf unannotated delta masses.\n[default: False]"
  type: boolean?
  inputBinding:
    prefix: --no-enable_unannotated
- id: in_no_enable_mass_diff
  doc: "Enable mapping uf mass differences reported\nby legacy search engines.  [default:\
    \ False]"
  type: boolean?
  inputBinding:
