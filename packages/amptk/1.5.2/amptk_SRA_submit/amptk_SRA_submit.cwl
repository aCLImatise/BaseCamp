...
- id: in_bio_sample
  ...
  inputBinding:
    prefix: --biosample
- id: in_platform
  doc: 'Sequencing platform. Defalt: ion (ion, illumina, illumina3, 454)'
  type: boolean?
  inputBinding:
    prefix: --platform
- id: in_names
...
- id: in_append
  ...
  inputBinding:
    prefix: --append
- id: in_reads_forward
  doc: Input R1 reads (-p illumina3)
  type: boolean?
  inputBinding:
    prefix: --reads-forward
- id: in_reads_reverse
  doc: Input R2 reads (-p illumina3)
  type: boolean?
  inputBinding:
    prefix: --reads-reverse
- id: in_reads_index
  doc: Input Index reads (-p illumina3)
  type: boolean?
  inputBinding:
    prefix: --reads-index
- id: in_barcode_rev_comp
  doc: Barocdes reverse complemented (-p illumina3)
  type: boolean?
  inputBinding:
