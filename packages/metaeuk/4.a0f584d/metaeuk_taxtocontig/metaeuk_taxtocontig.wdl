...
task MetaeukTaxtocontig {
  ...
  parameter_meta {
    ...
    lca_mode: "LCA Mode 1: single search LCA , 2/3: accelerated 2bLCA, 4: top hit [3]"
    tax_output_mode: "0: output LCA, 1: output alignment 2: output both [2]"
    majority: "minimal fraction of agreement among taxonomically assigned sequences of a set [0.500]"
    vote_mode: "Mode of assigning weights to compute majority. 0: uniform, 1: minus log E-value [1]"
