...
task GsutilNotification {
  input {
    ...
    Boolean? specifies_format_beeither
    ...
    Int projects_slash_slash_buckets_slash_example_bucket_slash_notification_configs_slash_one
    String generated_dot
  }
  command <<<
    gsutil notification \
      ~{projects_slash_slash_buckets_slash_example_bucket_slash_notification_configs_slash_one} \
      ~{generated_dot} \
      ~{if (specify_type_filter) then "-e" else ""} \
      ~{if (specifies_format_beeither) then "-f" else ""} \
  ...
  parameter_meta {
    ...
    projects_slash_slash_buckets_slash_example_bucket_slash_notification_configs_slash_one: "OPTIONS"
