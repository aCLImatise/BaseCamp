...
- id: in_create_new_branch
  doc: "[BRANCH ...]       create new branch of Assembly as params-{branch}.txt,\n\
    and can be used to drop samples from Assembly."
  type: boolean?
  inputBinding:
    prefix: -b
- id: in_merge_multiple_assemblies
  doc: "[MERGE ...]        merge multiple Assemblies into one joint Assembly, and\n\
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/ipyrad:0.9.71--pyh5e36f6f_0
cwlVersion: v1.1
baseCommand:
- ipyrad
