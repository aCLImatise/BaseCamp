...
task SimulatorpyTranscriptome {
  ...
  parameter_meta {
    ...
    base_caller: "Simulate homopolymers and/or base qualities with\\nrespect to chosen basecaller: albacore or guppy"
    read_type: "Simulate homopolymers and/or base qualities with\\nrespect to chosen read type: dRNA, cDNA_1D or cDNA_1D2"
    ...
    polya: "Simulate polyA tails for given list of transcripts"
    fast_q: "Output fastq files instead of fasta files"
