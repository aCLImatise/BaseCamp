...
- id: in_max_diff
  ...
  inputBinding:
    prefix: --max-diff
- id: in_high_copy_sample_rate
  doc: "=  float   1.0       Downsample reads from high\ncopy elements to expected\n\
    coverage maxCov*rate\n[0=discard reads]"
  type: boolean?
  inputBinding:
    prefix: --high-copy-sample-rate
...
- id: in_lasjsonfn_string_required
  doc: "=, --las-json-fn=      string  REQUIRED         List of las files\nfrom falcon,\
