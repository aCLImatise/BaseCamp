...
task Lastal {
  ...
  parameter_meta {
    ...
    mismatch_cost_m: ": mismatch cost (3 if -M, else 18 if 0<Q<5, else 1 if DNA)"
    ...
    gap_existence_cost: ": gap existence cost (DNA: 7, protein: 11, 0<Q<5: 21)"
    gap_extension_cost: ": gap extension cost (DNA: 1, protein:  2, 0<Q<5:  9)"
    ...
    input_format_fasta: ": input format: 0=fasta or fastq-ignore, 1=fastq-sanger, 2=fastq-solexa,\\n3=fastq-illumina, 4=prb, 5=PSSM (fasta)"
    last_db_name: ""
    fast_a_sequence_file: ""
  }
  output {
