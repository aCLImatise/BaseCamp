...
- id: in_no_stats
  ...
  inputBinding:
    prefix: -noStats
- id: in_filter_interval
  doc: '<file>   : Only analyze changes that intersect with the intervals specified
    in this file (you may use this option many times)'
  type: boolean?
  inputBinding:
...
- id: out_fast_a_prot
  ...
  type: File?
  outputBinding:
    glob: $(inputs.in_fast_a_prot)
hints:
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/snpeff:5.0--0
cwlVersion: v1.1
baseCommand:
- snpEff
