...
id: csvtk_csv2rst.cwl
inputs:
- id: in_cross
  doc: charactor of cross (default "+")
  type: string?
  inputBinding:
    prefix: --cross
- id: in_header
  doc: charactor of separator between header row and data rowws (default "=")
  type: string?
  inputBinding:
    prefix: --header
- id: in_horizontal_border
  doc: charactor of horizontal border (default "-")
  type: string?
  inputBinding:
    prefix: --horizontal-border
- id: in_padding
  doc: charactor of padding (default " ")
  type: string?
  inputBinding:
    prefix: --padding
- id: in_vertical_border
  doc: charactor of vertical border (default "|")
  type: string?
  inputBinding:
