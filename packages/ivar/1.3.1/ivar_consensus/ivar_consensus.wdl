...
task IvarConsensus {
  ...
  command <<<
    ivar consensus \
      ...
      ~{if (optional_name_fasta) then "-i" else ""} \
  ...
  parameter_meta {
    ...
    optional_name_fasta: "(Optional) Name of fasta header. By default, the prefix is used to create the fasta header in the following format, Consensus_<prefix>_threshold_<frequency-threshold>_quality_<minimum-quality>"
    var_7: ""
    d: ""
    a: ""
    aa: ""
