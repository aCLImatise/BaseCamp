...
- id: in_nucleotide_flank_five_output
  doc: Output nucleotide FASTA file of reported nucleotide sequences with 5' flanking
    sequences
  type: File?
  inputBinding:
    prefix: --nucleotide_flank5_output
- id: in_nucleotide_flank_five_size
...
- id: out_nucleotide_flank_five_output
  doc: Output nucleotide FASTA file of reported nucleotide sequences with 5' flanking
    sequences
  type: File?
  outputBinding:
    glob: $(inputs.in_nucleotide_flank_five_output)
hints:
