...
task RunLefsepy {
  input {
    ...
    Int? ing_curtissapproach_default
  ...
  command <<<
    run_lefse_py \
      ...
      ~{if defined(ing_curtissapproach_default) then ("-c " +  '"' + ing_curtissapproach_default + '"') else ""} \
  ...
  parameter_meta {
    ...
    ing_curtissapproach_default: "set whether perform the wilcoxon test ing the Curtis's\\napproach [BETA VERSION] (default 0)"
