...
inputs:
- id: in_model
  doc: "(none, symmetry) default: none\nmodel variants\nnone: no symmetry breaking\n\
    symmetry: static symmetry breaking"
  type: boolean?
  inputBinding:
    prefix: -model
- id: in_propagation
  doc: "(set, int, mixed) default: set\npropagation variants\nset: Use set intersection\
    \ cardinality for pair play constraints\nint: Use integer distinct for pair play\
    \ constraints\nmixed: Use set interesection cardinality and integer distinct for\
    \ pair play constraints"
  type: boolean?
  inputBinding:
    prefix: -propagation
- id: in_ipl
...
- id: in_trace
  ...
  inputBinding:
    prefix: -trace
- id: in_int_default_number_weeks
  doc: "(int) default: 9\nnumber of weeks"
  type: boolean?
  inputBinding:
    prefix: -w
- id: in_int_default_number_groups
  doc: "(int) default: 8\nnumber of groups"
  type: boolean?
  inputBinding:
    prefix: -g
- id: in_int_default_number_players
  doc: "(int) default: 4\nnumber of players per group\n"
  type: boolean?
  inputBinding:
    prefix: -s
- id: in_disabled
  doc: 'Options for Golf:'
  type: string
  inputBinding:
    position: 0
outputs:
