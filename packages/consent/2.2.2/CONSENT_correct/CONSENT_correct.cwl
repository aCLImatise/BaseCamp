...
- id: in_window_size
  ...
  inputBinding:
    prefix: --windowSize
- id: in_min_support
  doc: ':      Minimum support to consider a window for correction. (default: 3)'
  type: long?
  inputBinding:
    prefix: --minSupport
- id: in_max_support
  doc: ':      Maximum number of overlaps to include in a pile. (default: 150)'
  type: long?
  inputBinding:
    prefix: --maxSupport
- id: in_mer_size
