...
- id: in_tsv_stats
  ...
  inputBinding:
    prefix: --tsv_stats
- id: in_info_in_report
  doc: Add NanoPlot run info in the report.
  type: boolean?
  inputBinding:
    prefix: --info_in_report
- id: in_legacy
  doc: "Create four types of bivariate plots of x vs y, containing marginal summaries,\n\
...
- class: DockerRequirement
  dockerPull: quay.io/biocontainers/nanoplot:1.35.5--pyhdfd78af_0
cwlVersion: v1.1
baseCommand:
- NanoPlot
