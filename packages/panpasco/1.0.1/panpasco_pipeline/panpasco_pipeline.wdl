...
task Panpascopipeline {
  ...
  parameter_meta {
    ...
    show_failed_logs: "Automatically display logs of failed jobs."
    ...
    cond_a_cleanup_envs: "Cleanup unused conda environments."
    cond_a_cleanup_pkgs: "Cleanup conda packages after creating environments."
