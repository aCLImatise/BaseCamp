...
task Daameganizer {
  ...
  parameter_meta {
    ...
    files: "-i, --in [string(s)]                 Input DAA file(s). Each is meganized separately. Mandatory option."
    mode: "-lg, --longReads                     Parse and analyse as long reads. Default value: false."
    parameters: "-class, --classify                   Run classification algorithm. Default value: true."
  }
  output {
