...
- id: in_vcf_type
  ...
  inputBinding:
    prefix: --vcftype
- id: in_precision
  doc: "How much precision to use when printing decimals\n(default: 3)"
  type: long?
  inputBinding:
    prefix: --precision
- id: in_samples
...
- id: in_region
  doc: "Restrict to the region chrom:start-end. Requires file\nto bgzipped and tabix\
    \ indexed."
  type: File?
  inputBinding:
    prefix: --region
...
- id: in_h_wep
  ...
  inputBinding:
    prefix: --hwep
- id: in_het
  doc: "Output the heterozygosity of each locus. (default:\nFalse)"
  type: boolean?
  inputBinding:
    prefix: --het
- id: in_entropy
  doc: 'Output the entropy of each locus. (default: False)'
  type: boolean?
  inputBinding:
    prefix: --entropy
- id: in_mean
  doc: "Output mean of the allele frequencies. (default:\nFalse)"
  type: boolean?
  inputBinding:
    prefix: --mean
- id: in_mode
  doc: "Output mode of the allele frequencies. (default:\nFalse)"
  type: boolean?
  inputBinding:
    prefix: --mode
- id: in_var
  doc: "Output variance of the allele frequencies. (default:\nFalse)"
  type: boolean?
  inputBinding:
    prefix: --var
- id: in_num_called
