...
task RunDiscoSnpsh {
  ...
  parameter_meta {
    ...
    graph: "Reuse a previously created graph (.h5 file)"
    ...
    deletion_max_size: "discoSnp++ will search for deletions of size from 0 to D included. -D 0 means no deletion detected. Default=100."
