...
task Kissnp2 {
  ...
  parameter_meta {
    ...
    dont_output_first_coverage: "(0 arg) :    Don't output the first coverage threshold. Use this option when the reference file is used for finding the variants"
    ...
    max_truncated_path_length_difference: "(1 arg) :    Longest accepted difference length between two paths of a truncated bubble  [default '0']"
  }
  output {
