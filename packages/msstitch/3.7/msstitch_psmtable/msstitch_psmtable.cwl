...
- id: in_output_file
  ...
  inputBinding:
    prefix: -o
- id: in_old_psms
  doc: "PSM table file containing previously analysed PSMs to\nappend new PSM table\
    \ to."
  type: File?
  inputBinding:
    prefix: --oldpsms
...
- id: in_isobaric
  ...
  inputBinding:
    prefix: --isobaric
- id: in_min_precursor_purity
  doc: "Minimum purity of precursor required to output\nisobaric quantification data,\
    \ MS2 scans with purity\nbelow this value will be assigned NA in isobaric\nchannels"
  type: long?
  inputBinding:
