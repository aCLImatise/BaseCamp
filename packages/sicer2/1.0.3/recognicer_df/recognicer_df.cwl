...
- id: in_treatment_file
  doc: "Names of the sample file you wish to run RECOGNICER\non. This can either be\
    \ the relative or the absolute\npath of the file. Must be in BED or BAM format."
  type: File[]
  inputBinding:
    prefix: --treatment_file
- id: in_control_file
  doc: "[CONTROL_FILE [CONTROL_FILE ...]], -c [CONTROL_FILE [CONTROL_FILE ...]]\n\
    Name of the control library in BED or BAM format. This\ncan either be the relative\
...
- id: in_false_discovery_rate_df
  doc: "Cutoff for identification of significant changes been\nwild-type library and\
    \ knockout library. Only provide a\nvalue when comparing two libraries."
  type: string?
  inputBinding:
