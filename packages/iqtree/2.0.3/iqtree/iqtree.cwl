...
- id: in_seqtype
  ...
  inputBinding:
    prefix: --seqtype
- id: in_parsrand_starting_default
...
- id: in_epsilon
  ...
  inputBinding:
    prefix: --epsilon
- id: in_auto_coresthreads_autodetect
...
- id: in_all_nni
  ...
  inputBinding:
    prefix: --allnni
- id: in_multifurcating_constraint_file
