...
- id: in_extinction_probs_mode
  doc: "Set to '0' to use the critE EX mode to determine\nextinction probabilities\
    \ for each status (e.g. Mooers\net al, 2008 approach). Set to '1' to use empirical\
    \ EX\nmode, based on the recorded extinction in the IUCN\nhistory of the reference\
    \ group (e.g. Monroe et al,\n2019 approach). GL data can only be used in the critE\n\
    EX mode ('0')."
  type: long?
  inputBinding:
...
- id: in_species_specific_regression
  doc: "Enables species-specific regression fitting to model\nLC, NT, and VU extinction\
