...
task BlobtoolsPlot {
  ...
  command <<<
    blobtools plot \
      ...
      ~{if (file_label) then "--filelabel" else ""} \
  ...
  parameter_meta {
    ...
    file_label: "Label axis based on filenames"
    ...
    colours: "File containing colours for (taxonomic) groups. This allows having more than 9 colours."
