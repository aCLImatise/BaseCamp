...
- id: in_no_ff_pe
  ...
  inputBinding:
    prefix: -no_ffpe
- id: in_match_external_names
  doc: "If set, also samples for which the external name matches 'sample' are exported.\n\
    Default value: 'false'"
  type: boolean?
  inputBinding:
    prefix: -match_external_names
- id: in_with_merged
...
- id: in_species
  ...
  inputBinding:
    prefix: -species
- id: in_sender
  doc: "Sample sender filter.\nDefault value: ''"
  type: string?
  inputBinding:
    prefix: -sender
- id: in_study
  doc: "Processed sample study filter.\nDefault value: ''"
  type: string?
  inputBinding:
    prefix: -study
- id: in_project
...
- id: in_add_comments
  doc: "Adds sample and processed sample comments columns.\nDefault value: 'false'"
  type: boolean?
  inputBinding:
    prefix: -add_comments
- id: in_test
