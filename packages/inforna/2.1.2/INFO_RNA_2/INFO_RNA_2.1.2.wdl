...
task INFORNA212 {
  ...
  parameter_meta {
    ...
    use_fm_partition: "[mp]          Use minimum energy (-Fm) (default), partition function\\nfolding (-Fp) or both (-Fmp)."
    ...
    kind_of_counting: "Kind of counting the step during the local search. Here, only\\naccepted mutations are counted, while usually all tested\\nneighbors are counted."
    ...
    choice_kind_order: "choice      Kind of order the candidate neighbors during the local"
