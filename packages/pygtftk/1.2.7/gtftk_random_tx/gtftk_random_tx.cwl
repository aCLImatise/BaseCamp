...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_max_transcript
  doc: 'The maximum number of transcripts to select for each gene. (default: 1)'
  type: boolean?
  inputBinding:
    prefix: --max-transcript
- id: in_seed_value
  doc: 'Seed value for the random number generator. (default: None)'
  type: boolean?
  inputBinding:
    prefix: --seed-value
- id: in_verbosity
