...
- id: in_output_file
  ...
  inputBinding:
    prefix: --outputfile
- id: in_location
  doc: 'List of chromosomal locations (chr:start-end[,chr:start-end]). 0-based (default:
    None)'
  type: boolean?
  inputBinding:
    prefix: --location
- id: in_location_file
  doc: 'Bed file with chromosomal location. (default: None)'
  type: boolean?
  inputBinding:
...
- id: in_ft_type
  ...
  inputBinding:
    prefix: --ft-type
- id: in_invert_match
  doc: 'Not/invert match. Select transcript not overlapping. (default: False)'
  type: boolean?
  inputBinding:
    prefix: --invert-match
- id: in_verbosity
