...
- id: in_pan_genome
  ...
  inputBinding:
    prefix: --pangenome
- id: in_no_defrag
  doc: "DO NOT Use the defragmentation strategy to link\npotential fragments with\
    \ their original gene family.\n(default: False)"
  type: boolean?
  inputBinding:
    prefix: --no_defrag
...
- id: in_mode
  doc: "the cluster mode of MMseqs2. 0: Setcover, 1: single\nlinkage (or connected\
    \ component), 2: CD-HIT-like, 3:\nCD-HIT-like (lowmem) (default: 1)"
  type: string?
  inputBinding:
    prefix: --mode
- id: in_coverage
