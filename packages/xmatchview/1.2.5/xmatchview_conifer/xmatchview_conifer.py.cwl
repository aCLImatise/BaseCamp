...
- id: in_y
  ...
  inputBinding:
    prefix: -y
- id: in_mismatch_eg_allows
  doc: mismatch threshold (e.g. -m 10 allows representation of repeats having up to
    10% mismatch
  type: long?
  inputBinding:
    prefix: -m
...
- id: in_pixel_basepair_scale
  ...
  inputBinding:
    prefix: -c
- id: in_tree_trunk_characters
  doc: for the tree trunk (6 characters or less for best result)
  type: long?
  inputBinding:
    prefix: -l
