...
task RiboRun {
  ...
  command <<<
    ribo run \
      ...
      ~{if (outputdir__output) then "-o" else ""} \
      ...
      ~{if defined(_kmers_kmers) then ("-k " +  '"' + _kmers_kmers + '"') else ""} \
  ...
  parameter_meta {
    ...
    outputdir__output: "/output/dir/, --output /output/dir/\\noutput directory; default:\\n/2020-09-10T0043_riboSeed_pipeline_results/"
  ...
  output {
    ...
    Directory out_outputdir__output = "${in_outputdir__output}"
