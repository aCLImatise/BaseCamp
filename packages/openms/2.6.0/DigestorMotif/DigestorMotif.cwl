...
- id: in_enzyme
  doc: "The enzyme used for peptide digestion. (default: 'Trypsin' valid: 'Arg-C',\
    \ 'Trypsin', 'Lys-C/P', 'PepsinA', 'no cleavage', 'unspecific cleavage', 'Formic_acid',\
    \ 'Chymotrypsin', 'Chymotrypsin/P', 'CNBr', 'Asp-N_ambic', 'TrypChymo', 'Trypsin/P',\
    \ 'V8-DE', 'V8-E', 'Asp-N', 'Asp-N/B', 'Glu-C+P', 'PepsinA + P', 'leukocyte elastase',\
    ...
    \ 'cyanogen-bromide', 'Clostripain/P', 'elastase-trypsin-chymotrypsin', 'Arg-C/P',\
    \ 'Lys-C', 'Lys-N')"
  type: long?
  inputBinding:
    prefix: -enzyme
