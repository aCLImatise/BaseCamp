...
task MascotAdapter {
  ...
  parameter_meta {
    in: "*                      Input file in mzData format.\\nNote: In mode 'mascot_out' a Mascot results file (.mascotXML) is read (valid formats: 'mzData', 'mascotXML')"
    out: "*                     Output file in idXML format.\\nNote: In mode 'mascot_in' Mascot generic format is written. (valid formats: 'idXML', 'mgf')"
    out_type: "Output file type (for TOPPAS) (valid: 'idXML', 'mgf')"
    ...
    pep_homol: "Peptide homology threshold (default: '1.0')"
    pep_ident: "Peptide ident threshold (default: '1.0')"
    pep_rank: "Peptide rank (default: '1')"
    prot_score: "Protein score (default: '1.0')"
    pep_score: "Peptide score (default: '1.0')"
    pep_exp_z: "Peptide expected charge (default: '1')"
    show_unassigned: "Show_unassigned (default: '1')"
    first_dim_rt: "Additional information which is added to every peptide identification as metavalue if set > 0 (default: '0.0')"
