...
task Digestor {
  ...
  parameter_meta {
    ...
    enzyme: "The type of digestion enzyme (default: 'Trypsin' valid: 'Asp-N', 'Arg-C', 'Arg-C/P', 'Lys-C', 'Lys-N', 'no cleavage', 'unspecific cleavage', 'Formic_acid', 'Chymotrypsin/P', 'CNBr', 'Asp-N_ambic', 'Chymotrypsin', 'Lys-C/P', 'PepsinA', 'V8-DE', 'V8-E', 'Asp-N/B', 'Glu-C+P', 'PepsinA + P', 'leukocyte elastase', 'proline endopeptidase', 'glutamyl endopeptidase', 'Alpha-lytic protease', '2-iodobenzoate', 'iodosobenzoate', 'staphylococcal protease/D', 'proline-endopeptidase/HKR', 'cyanogen-bromide', 'Clostripain/P', 'elastase-trypsin-chymotrypsin', 'Trypsin', 'TrypChymo', 'Trypsin/P')"
