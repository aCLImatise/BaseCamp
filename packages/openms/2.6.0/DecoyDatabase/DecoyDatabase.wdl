...
task DecoyDatabase {
  ...
  parameter_meta {
    ...
    enzyme: "Enzyme used for the digestion of the sample. Only applicable if parameter 'type' is 'protein'. (default: 'Trypsin' valid: 'Arg-C', 'Lys-C/P', 'PepsinA', 'no cleavage', 'CNBr', 'Formic_acid', 'Chymotrypsin', 'Chymotrypsin/P', 'Asp-N/B', 'Asp-N_ambic', 'TrypChymo', 'Trypsin/P', 'V8-DE', 'Arg-C/P', 'Asp-N', 'Glu-C+P', 'PepsinA + P', 'V8-E', 'leukocyte elastase', 'proline endopeptidase', 'glutamyl endopeptidase', 'Alpha-lytic protease', '2-iodobenzoate', 'iodosobenzoate', 'staphylococcal protease/D', 'proline-endopeptidase/HKR', 'cyanogen-bromide', 'Clostripain/P', 'elastase-trypsin-chymotrypsin', 'Trypsin', 'unspecific cleavage', 'Lys-C', 'Lys-N')"
