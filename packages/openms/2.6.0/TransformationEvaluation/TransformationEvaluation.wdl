...
task TransformationEvaluation {
  ...
  parameter_meta {
    ...
    min: "Minimum value to transform (default: '0.0')"
    max: "Maximum value to transform (if at or below 'min', select a suitable maximum based on the transformation description) (default: '0.0')"
    step: "Step size between 'min' and 'max' (default: '1.0' min: '1.0e-03')"
