...
task Makdbs {
  input {
    ...
    Boolean? d_name
    Boolean? s_srcdir
    Boolean? directory_where_destination
  ...
  command <<<
    makdbs \
      ...
      ~{if (directory_where_destination) then "-pdstdir" else ""} \
