...
task AffiliationOTUpy {
  ...
  parameter_meta {
    ...
    reference: "Preformated reference file (format: blast-indexed\\nFASTA)."
    input_biom: "BIOM file (format: BIOM)."
    input_fast_a: "FASTA file of OTU's seed (format: FASTA)."
    output_biom: "BIOM file with added affiliation annotations from\\nblast/needleall and/or RDPtools. [Default:\\naffiliation_abundance.biom]"
