...
task Mtglinkpy {
  ...
  parameter_meta {
    gfa: "Input GFA file (GFA 2.0) (format: xxx.gfa)"
    ...
    kmer_sizes_used: "[KMER ...]         k-mer size(s) used for gap-filling [default: [51, 41,\\n31, 21]]"
    force: "To force search on all '-k' values provided"
    minimal_abundance_threshold: "[ABUNDANCE_THRESHOLD ...]\\nMinimal abundance threshold for solid k-mers [default:\\n[3, 2]]"
