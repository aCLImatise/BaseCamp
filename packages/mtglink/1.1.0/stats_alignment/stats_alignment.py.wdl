...
task StatsAlignmentpy {
  ...
  parameter_meta {
    ...
    reference: "File containing either the reference sequence or the flanking contigs sequences of the gap (format: 'xxx.fasta')"
    ext: "Extension size of the gap, on both sides; determine start/end of gapfilling"
