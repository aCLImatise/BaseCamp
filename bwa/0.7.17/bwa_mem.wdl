...
task BwaMem {
  ...
  command <<<
    bwa mem \
      ...
      ~{true="-5" false="" split_alignment_take} \
  ...
  parameter_meta {
    ...
    read_type_changes: "read type. Setting -x changes multiple parameters unless overridden [null] pacbio: -k17 -W40 -r10 -A1 -B1 -O1 -E1 -L0  (PacBio reads to ref) ont2d: -k14 -W20 -r10 -A1 -B1 -O1 -E1 -L0  (Oxford Nanopore 2D-reads to ref) intractg: -B9 -O16 -L5  (intra-species contigs to ref)"
    ...
    split_alignment_take: "for split alignment, take the alignment with the smallest coordinate as primary"
