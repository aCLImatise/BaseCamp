...
task NanoStat {
  ...
  parameter_meta {
    ...
    read_type: "Which read type to extract information about from summary. Options are 1D, 2D, 1D2"
    fast_q: "Data is in one or more (compressed) fastq file(s)."
    fast_a: "Data is in one or more (compressed) fasta file(s)."
    summary: "Data is in one or more (compressed) summary file(s)generated by albacore or guppy."
