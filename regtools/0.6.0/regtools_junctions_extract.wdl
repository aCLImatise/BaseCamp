...
task RegtoolsJunctionsExtract {
  input {
    ...
    String? region_identify_junctions
  ...
  command <<<
    regtools junctions extract \
      ...
      ~{if defined(region_identify_junctions) then ("-r " +  '"' + region_identify_junctions + '"') else ""} \
  ...
  parameter_meta {
    ...
    region_identify_junctions: "The region to identify junctions  in \"chr:start-end\" format. Entire BAM by default."
