...
task Cstranslate {
  ...
  parameter_meta {
    ...
    match_assign: "[0:100]     Make all FASTA columns with less than X% gaps match columns (def: make columns with residue in first sequence match columns)"
