...
task Clinod {
  input {
    ...
    Directory? optional_defaults_exist
  ...
  command <<<
    clinod \
      ...
      ~{if defined(optional_defaults_exist) then ("-d " +  '"' + optional_defaults_exist + '"') else ""} \
