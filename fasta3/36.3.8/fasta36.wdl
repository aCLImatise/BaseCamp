...
task Fasta36 {
  input {
    ...
    Boolean? show_complete_sequences
    Boolean? smithwaterman_final_dna
    ...
    Boolean? alignment_context_length
  ...
  command <<<
    fasta36 \
      ...
      ~{true="-a" false="" show_complete_sequences} \
      ~{true="-A" false="" smithwaterman_final_dna} \
      ...
      ~{true="-W" false="" alignment_context_length} \
  ...
  parameter_meta {
    ...
    show_complete_sequences: "show complete Query/Sbjct sequences in alignment"
    smithwaterman_final_dna: "Smith-Waterman for final DNA alignment, band alignment for protein default is band-alignment for DNA, Smith-Waterman for protein"
    ...
    alignment_context_length: ":  alignment context length (surrounding unaligned sequence)"
