...
task TomboPlotMaxDifference {
  ...
  parameter_meta {
    ...
    pdf_filename: "PDF filename to store plot(s). Default: tombo_results.max_difference.pdf"
    sequences_filename: "File for sequences from selected regions. Sequences will be stored in FASTA format. Default: None."
