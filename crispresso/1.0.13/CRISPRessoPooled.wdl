...
task CRISPRessoPooled {
  ...
  parameter_meta {
    ...
    max_paired_end_reads_overlap: "parameter for the flash merging step, this parameter is the maximum overlap length expected in approximately 90% of read pairs. Please see the flash manual for more information. (default: 100)"
