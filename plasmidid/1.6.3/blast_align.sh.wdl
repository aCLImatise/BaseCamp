...
task BlastAlignsh {
  input {
    ...
    Directory? directory_default_directory
  ...
  command <<<
    blast_align_sh \
      ...
      ~{if defined(directory_default_directory) then ("-o " +  '"' + directory_default_directory + '"') else ""} \
  ...
  parameter_meta {
    ...
    directory_default_directory: "directory, default same directory as query"
