...
- id: bam_files
  ...
  inputBinding:
    prefix: --bamfiles
- id: plot_file
  doc: ', -plot , -o  File name of the output figure. The file ending will be used
    to determine the image format. The available options are typically: "png", "eps",
    "pdf" and "svg", e.g. : fingerprint.png. (default: None)'
  type: boolean
  inputBinding:
    prefix: --plotFile
- id: out_raw_counts
  doc: 'Output file name to save the read counts per bin. (default: None)'
  type: boolean
  inputBinding:
    prefix: --outRawCounts
- id: extend_reads
