...
task PlotFingerprint {
  ...
  command <<<
    plotFingerprint \
      ...
      ~{true="--plotFile" false="" plot_file} \
      ~{true="--outRawCounts" false="" out_raw_counts} \
  ...
  >>>
  parameter_meta {
    bam_files: "files [bam files ...], -b bam files [bam files ...] List of indexed BAM files (default: None)"
    plot_file: ", -plot , -o  File name of the output figure. The file ending will be used to determine the image format. The available options are typically: \"png\", \"eps\", \"pdf\" and \"svg\", e.g. : fingerprint.png. (default: None)"
    out_raw_counts: "Output file name to save the read counts per bin. (default: None)"
