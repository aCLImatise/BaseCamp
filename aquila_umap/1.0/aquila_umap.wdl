...
task AquilaUmap {
  ...
  >>>
  parameter_meta {
    fa_folder: "Required parameter; The folder path where fasta files are saved eg: /path/to/fasta/"
    fa_name: "Required parameter; The file name of fasta file eg: sample.fa"
    out_dir: "Required parameter; The output path eg: /path/to/result/"
    ...
    mapq_th_res: "The MAPQ threshold to filter bowtie2 map result, default = 20"
    chr_thread: "number of threads for processing chromosome, default = 2"
